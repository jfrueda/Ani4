...
$extPermArch = pathinfo($pathImagen, PATHINFO_EXTENSION);
...
$verImg = (
  (
    ...
    $radicadoFilter->isDependenciaInFilter($numrad, $dependencia)
  ) &&
  in_array(
    strtolower($extPermArch),
    [
      'doc', 'xls', 'ppt', 'tif', 'jpg', 'gif', 'pdf', 'txt', 'zip', 'rtf',
      'dia', 'zargo', 'csv', 'odt', 'ods', 'xml', 'png', 'docx', 'avi',
      'mpg', 'tar', 'xlsx', 'rar', '7z', 'pptx', 'msg', 'mp3', 'mp4',
      'xlsm', 'eml', 'xlsb', 'svg'
    ]
  )
) ? 'SI' : $verImg;
