<?php
//Programa que radica un paquete de anexos de numeraci�n y fechado
...
$i = 0; 
$j = 0;
//almacena el n�mero de archivos que va siendo procesado
$numArchs=0; 
$no_digitos = 6;
...
//Arma el link hacia el lugar donde se encuentran los archivos f�sicos que hacen parte del paquete
...
while ($i < $num) {	
	...
	$desc_anexos="Documento que hace parte de un paquete de numeraci�n y fechado";
	...
	$i++; 
	//Recupera la informaci�n de los datos del radicado base, para combinar la plantilla
