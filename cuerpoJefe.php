...
// Obtener datos del jefe usando la clase JefeArea
$rs_jefe = JefeArea::getRecordSetJefe($db, $dependencia);
$datosJefe = JefeArea::getDatosJefe($db, $dependencia);

// Guardar los datos del jefe para usar en las consultas múltiples
$jefe_usua_codi = $datosJefe['usua_codi'];
$jefe_usua_doc = $datosJefe['usua_doc'];

// Usar el documento del jefe para las consultas múltiples, no del tramitador
$usua_doc = $jefe_usua_doc;

// Permitir que el tramitador vea todos los radicados de la dependencia del jefe
$whereUsuario = " and b.radi_usua_actu='" . $jefe_usua_codi . "' ";
        ...
        <div id="content">
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-orfeo text-white">
                    <h4 class="mb-0">
                        <i class="fa fa-inbox"></i> Bandeja <span>JEFE DEPENDENCIA</span>
                    </h4>
                </div>
            </div>

            <!-- widget grid -->
            <section id="widget-grid" class="card-body">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                <div class="widget-body-toolbar card shadow-sm p-4 mb-4 border rounded-3">
                                    ...
                                    <div class="row g-3" style="margin-bottom: 2.3rem;">
                                        <!-- PAGINA -->
                                        <div class="col-6 col-md-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text bg-light fw-bold">
                                                    <span id="total_bandeja"></span> páginas
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="table-responsive shadow-sm rounded-4 overflow-hidden">
                                    <table
                                        id="dt_basic"
                                        class="table table-bordered table-hover table-striped mb-0 align-middle"
                                        width="100%">
                                        <tbody>
                                            <?php
                                            include "$ruta_raiz/include/query/queryCuerpoJefe.php";
                                            ...
                                            while (!$rs->EOF) {
                                                ...
                                                $linkVerRadicado = "./verradicado.php?verrad=$numeroRadicado&depe_actu=$dependencia";
                                            ...
                                            ?>
                                                <tr <?= $anexEstadoEstilo ?> class="<?= $leido ?> ">
                                                  ...
                                                  for ($i=0;$i<$rsEntradaConteo->fields['TOTAL'];$i++){
                                                    ...
                                                    <td align="center" style='display: none'> <a <?= $ColorAlerta ?> title="<?= $MensajeAlerta ?>">
                                                            <div <?= $TipoAlerta ?>></div>
                                                        </a>
                                                    ...
                                                    <td>
                                                        <div><small><a title="click para ver radicado <?= $numeroRadicado ?>" <?= $anexEstadoEstiloLink ?> href="<?= $linkVerRadicado ?>" target="mainFrame"><?= $fechaRadicado ?></a></small></div>
                                                    </td>
                                                    <td width="250px">
                                                        <div><span><small><?= $asuntoRadicado ?></small></span> </div>
                                                    </td>
                                                    <td>
                                                        <div> <small><?= $remitenteRadicado ?></small> </div>
                                                    </td>
                                                    <td>
