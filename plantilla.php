...
if ($plantilla_dep  && $ins_plantilla) {
...
<?php
if ($plantillaper1) {
	$plantillaper = $verrad . "_" . $plantillaper1;
}
?>
...
<table border=0 cellspace=2 cellpad=2 WIDTH=98%>
	<tr>
		...
		<td></td>
		<td width='5' colspan='3' class=e_cajas>
	...
	<tr>
		<td colspan=15>
			<?
			if ($plantillaper != 0 || $plantilla != 0 || $enviar || $enviar_new || $crea_plantilla) {
