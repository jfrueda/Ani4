...
<body>
    ...
    <div class="tab-content borderNav" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" maxlength="20" class="form-control form-control-sm" id="inResolucionInicial" name="inResolucionInicial">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" id="seRazonSocial" name="seRazonSocial" maxlength="99">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            <label for="taComentarioProy" class="col-sm-4 col-form-label form-control-sm">Comentario</label>
                            <div class="col-sm-8">
                                <textarea maxlength="199" class="form-control" id="taComentarioProy" name="taComentarioProy" rows="3"></textarea>
                            </div> 
                        </div>                            
            ...
            <div class="scrollX fixTableHead" style="height:450px;" id="dvTableHorizontal" >
        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            ...
            <div class="scrollX fixTableHead" style="height:450px;" id="dvTableDevolucion" >
            <h3>Solicitudes por enviar.</h3>
            <table id="tbDevolucion" class="table table-striped table-bordered table-sm align-middle"  cellspacing="0"
                ...
                <thead>
                    ...
                    <th scope="col">Comentario enviado</th>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" maxlength="20" class="form-control form-control-sm" id="inResolucionInicial2" name="inResolucionInicial">
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="seRazonSocial2" name="seRazonSocial2" maxlength="99">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                         ...
                                         <div class="row">
                                                <label for="taComentarioProy2" class="col-sm-4 col-form-label form-control-sm">Comentario</label>
                                                <div class="col-sm-8">
                                                     <textarea maxlength="199" class="form-control" id="taComentarioProy2" name="taComentarioProy2" rows="3"></textarea>
                                                </div> 
                                        </div>                                    
        ...
        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
            ...
            <div class="scrollX scrollX fixTableHead" style="height:450px;" id="dvTableConstanciaGen" >
            <h3>Constancias finalizadas.</h3>
