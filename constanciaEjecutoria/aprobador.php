    ...
    <div class="container-fluid">
        <div class="card shadow">
            <div class="card-header bg-orfeo text-white">
                <h3 class="mb-0">Rol Aprobador</h3>
            </div>
            <div class="card-body">
    ...
    <script type="text/javascript">
                    ...
                    success: function(result) {
                        if (result == "200") {
                            ...
                            $.ajax({
                                ...
                                data: {
                                    inFuncion: '18',
                                    idSolicitud: $('#idSolicitudEdit').val()
                                },
                                success: function(result) {
                                    if (result == "200") {
        ...
        $("#btDevolver").click(function() {
            ...
            if ($('#taComentarioDev').val() == "") {
                ...
                $.ajax({
                    ...
                    data: {
                        inFuncion: '28',
                        arraySolicitud: arraySolicitudGen,
                        comentario: $('#taComentarioDev').val()
                    },
                    success: function(result) {
                ...
                if (confirm('Esta seguro de realizar la anulación  ?')) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            inFuncion: '40',
                            idSolicitud: idSolicitud,
                            observacion: $('#taAnulacionDev').val()
                        },
                        success: function(result) {
            ...
            if ($('#seRolEnvio').val() == 0) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        arraySolicitud: arraySolicitudGen,
                        rol: $('#seRolEnvio').val(),
                        comentario: $('#taComentarioRol').val()
                    },
                    success: function(result) {
        ...
        function descargarConstanciaGeneralRevisor() {
            ...
            $.ajax({
                ...
                data: {
                    inFuncion: '35',
                    inFechaInicio: $("#inFechaInicio").val(),
                    inFechaFinal: $("#inFechaFinal").val(),
                    seDependencia: $("#seDependencia").val(),
                    seGrupo: $("#seGrupo").val()
                },
                success: function(result) {
                    ocultarLoading();
