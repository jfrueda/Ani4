...
<body>
    ...
    <h3 class="mt-2">Rol Aprobador</h3>
    <div class="alert alert-warning" role="alert" id="dvGeneral" style="display: none"></div>
    <form id="fmBusqueda">
        <div class="input-group input-group-sm mb-3">
             <input  id="inFuncion" name="inFuncion" type="hidden" value="23"> 
             <input  id="estadoDife" name="estadoDife" type="hidden" value="20"> 
            ...
            <select class="form-select form-select-sm" id="sePrinc" name="sePrinc">
            ...
            <i class="bi-cloud-download-fill" id="icDescarga" style="display: none; font-size: 1.5rem; color: cornflowerblue; cursor: pointer;"></i>
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Constancias General</a>
    </li>    
    </ul>
    <div class="tab-content borderNav" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            <!-- TAB SOLICITUDES -->
            &nbsp;&nbsp;           
            <i class="bi-send-fill" id="cbEnvioGeneral" style="font-size: 1.5rem; color: cornflowerblue; cursor: pointer;"></i>&nbsp;&nbsp;
            ...
            <i class="bi-check-circle-fill" id="cbAprobacionGeneral" style="font-size: 1.5rem; color: cornflowerblue; cursor: pointer;"></i>  
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

            <div class="scrollX fixTableHead" style="height:450px;"  >
                <table id="tbSolicitud" class="table table-striped table-bordered table-sm align-middle"  cellspacing="0"
                    ...
                    <thead>
                        ...
                        <th scope="col">Comentario Proyector</th>
            ...
            <div class="scrollX fixTableHead" style="height:450px;" >
                <table id="tbConstancia" class="table table-striped table-bordered table-sm align-middle"  cellspacing="0"
                    ...
                    <thead>
                        ...
                        <th scope="col">Fecha ejecutoria</th>
                        <th scope="col">Comentario</th>
                        <th scope="col">Fecha de respuesta área notificaciones</th>
                        <th scope="col">Nombre Aprobador</th>
                        <th scope="col">Observacion</th>
                        <th scope="col">Número de constancia</th>
                        <th scope="col">Constancia</th>
                        <th scope="col">Comentario proyector</th>
                        <th scope="col">Fecha anulación</th>
                        <th scope="col">Nombre Anulador</th>
                        <th scope="col">Observaciones anulación</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <form id="fmGeneral2">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" maxlength="20" class="form-control form-control-sm" id="inResolucionInicial2" name="inResolucionInicial" readonly>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" id="seRazonSocial2" name="seRazonSocial" maxlength="99">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <select class="form-select form-select-sm" id="seTipoNotifiacion2" name="seTipoNotifiacion">
                                ...
                                <option value="Notificación por aviso">Notificación por aviso</option>
                                <option value="Notificación por edicto">Notificación por edicto</option>
                                <option value="Notificación en audiencia o estrado">Notificación en audiencia o estrado</option>
                            </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                            <label for="inObservacion" class="col-sm-4 col-form-label form-control-sm">Observación</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control form-control-sm" id="inObservacion" name="inObservacion" maxlength="280">
                            </div>
                        </div>
    ...
    <div class="modal" tabindex="-1" id="mEnvio">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Envío constancia ejecutória</h5>
                    <button id="bmEnvioClose" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">

                        <div id="dvEnvioIndo"></div>
                            <label for="seRolEnvio" class="col-sm-4 col-form-label">Enviar a:*</label>
                            <select class="form-select form-select-sm" id="seRolEnvio" name="seRolEnvio">
                                <option value="0" selected>Seleccione una opción</option>
                                <option value="4">Firmante</option>
                            </select>    
                            
                        <label for="taComentarioRol" class="form-label">Comentario:</label>
                        <textarea class="form-control" id="taComentarioRol" rows="3"></textarea>                            

                </div>
                <div class="modal-footer">
                    <button id="bmEnvioClose2" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
    ...
    <div class="modal" tabindex="-1" id="mAnulacion">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Anulación Constancia Ejecutoria</h5>
                    <button id="bmAnulacionClose" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        <input  id="inAnulacion" name="inAnulacion" type="hidden" value="-1"> 
                        <div class="mb-3">
                            <label for="taAnulacionDev" class="form-label">Observación:</label>
                            <textarea class="form-control" id="taAnulacionDev" rows="3"></textarea>
                        </div>

                </div>
                <div class="modal-footer">
                    <button id="bmAnulacionClose2" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" id="btAnular">Anular</button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $( "#pills-home-tab" ).click(function() { 
        ...
        limpiarDivInfo();
        ocultarLoading();
        $("#sePrinc").css("display", "block"); 
    });

   /* $( "#pills-profile-tab" ).click(function() { 
        mostrarLoading();
        tab = 2;
        cargarDependenciaFiltro(6);
        cargarGrupoFiltro(6);
        $("#inFuncion").val(20);
        limpiarDivInfo();
        ocultarLoading();
    ...
    $( "#pills-contact-tab" ).click(function() { 
        mostrarLoading();
        tab = 3;
        cargarDependenciaFiltro(-1);
        cargarGrupoFiltro(-1);   
        $("#inFuncion").val(21);
        limpiarDivInfo();
        $("#icDescarga").css("display", "none"); 
        ocultarLoading();   
        $("#sePrinc").css("display", "none"); 
    });     
    ...
    $( "#btBuscar" ).click(function() { 
        ...
        if(tab == 2)
            cargarDevolucion();
        if(tab == 3)
            cargarConstanciaGeneral();
    });   

    function cargarConstanciaGeneral(){
        limpiarDivInfo();
        ...
        $.ajax({url: "constanciaController.php", 
						...
						success: function(result){
                            ...
                            if(data.length == 0){
                                $("#tbConstancia").css("display", "none"); 
                                $("#icDescarga").css("display", "none"); 
                                divInfo("No hay solicitudes para el criterio de búsqueda.");  
                            } else {
                                $("#tbConstancia").css("display", "block"); 
                                $("#icDescarga").css("display", "block"); 
                                for(let i=0; i<data.length; i++) {
                                    ...
                                    if(data[i][31] != "") {
                                        infoRow += '<td><i id="cbDes2' + idRow + '"  class="bi-file-earmark-pdf-fill cbDescarga2" style="font-size: 1.5rem; color: FF0000; cursor: pointer;"></i>';
                                        infoRow += '<i id="cbHisAux' + idRow + '" class="bi-clock-history cbHistorialAux" style="font-size: 1.5rem; color: cornflowerblue; cursor: pointer;"></i>';

                                        if(data[i][7] === "Finalizado") {
                                            infoRow += '<i id="cbAnuAux' + idRow + '" class="bi bi-bookmark-x-fill cbAnularAux" style="font-size: 1.5rem; color: cornflowerblue; cursor: pointer;"></i>';
                                        }
                                        infoRow += '</td>';
                                    } else {
                                        infoRow += '<td><i id="cbHisAux' + idRow + '" class="bi-clock-history cbHistorialAux" style="font-size: 1.5rem; color: cornflowerblue; cursor: pointer;"></i></td>';
                                    }
                                    infoRow += '<td>' + data[i][32] +  '</td>';
                                    infoRow += '<td>' + data[i][33] +  '</td>';
                                    infoRow += '<td>' + data[i][34] +  '</td>';
                                    infoRow += '<td>' + data[i][35] +  '</td>';
                                    infoRow += '</tr>';    
    ...
    $(document).on('click', '.cbHistorialAux', function() {
        $("#tbHistorio").find("tr:gt(0)").remove();
        let idSolicitud = this.id.replace("cbHisAux", "");
        mostrarLoading();
        $.ajax({url: "constanciaController.php", 
					    type: "POST",
    ...
    $(document).on('click', '.cbAnularAux', function() {
        $('#taAnulacionDev').val('');
        let idSolicitud = this.id.replace("cbAnuAux", "");
        $("#inAnulacion").val(idSolicitud);
        $('#mAnulacion').modal('show');
                            ...
                            if(data.length == 0){
                                ...
                                for(let i=0; i<data.length; i++) {
                                    ...
                                    if(data[i][24] == '') 
                                        ...
                                        infoRow = '<tr class="table-warning">';
                                    let idRow;
                                    for(let j=0; j<data[i].length; j++) {
                                            if(j == 28)
                                                break;
                                    ...
                                    infoRow += '<td>' + data[i][31] + '</td>';
                                    infoRow += '<td>';
                                    if(data[i][30] == "f")
                                        infoRow += '<i id="cbApro' + idRow + '" name="cbApro' + idRow + '" class="bi-check-circle-fill cbAprobar" style="font-size: 1.5rem; color: 808080; cursor: pointer;"></i>';
                                    else
                                        infoRow += '<i class="bi-check-circle-fill" style="font-size: 1.5rem; color: 00FF00;"></i>';
                                    infoRow += '</td>';
                                    infoRow += '<td>';
                                    ...
                                    if(data[i][30] == "f") {
                                        infoRow += '<i id="cbEnv' + idRow + '" name="cb' + idRow + '" class="bi-send-fill" style="font-size: 1.5rem; color: 808080;"></i>';
                                    } else {
                                        infoRow += '<i id="cbEnv' + idRow + '" name="cb' + idRow + '" class="bi-send-fill cbEnvio" style="font-size: 1.5rem; color: cornflowerblue; cursor: pointer;"></i>';
                                    }
    ...
    function cargarDevolucion(){
        ...
        $.ajax({url: "constanciaController.php", 
						...
						success: function(result){
                            ...
                            data = jQuery.parseJSON(result);
                            if(data.length == 0){
                                $("#tbDevolucion").css("display", "none"); 
                                divInfo("No hay solicitudes para el criterio de búsqueda.");  
                            } else {
                                $("#tbDevolucion").css("display", "block"); 
                                for(let i=0; i<data.length; i++) {
                                    let infoRow = '<tr>';
                                    let idRow;
                                    for(let j=0; j<data[i].length; j++) {
    ...
    $( "#bmEnvioClose" ).click(function() {
        $('#mEnvio').modal('hide');
    }); 

    $( "#bmEnvioClose2" ).click(function() {
        $('#mEnvio').modal('hide');
    });  
    ...
    function validarFormulario2(){
       ...
       if($("#inFechaUltimoActo2").val() == "") {
               $("#dvForm2").append("Fecha notificación ultimo acto es requerida");
               $("#dvForm2").css("display", "block");
               return false;
       }
   ...
   $( "#cbSolicitudGen" ).click(function() {
    ...
    $( "#cbGeneracionGeneral" ).click(function() {
        ...
        if(cantidadSeleccionada == 0){
            ...
            if(cantidadSeleccionada > 15) {
                divInfo("Excede la cantidad máxima de 15.");
            } else {
    ...
    function generacionGeneral(arraySolicitud){
        ...
        $.ajax({url: "constanciaController.php", 
						...
						success: function(result){
                            if(result == 'f') {
                                divInfo("No se pueden procesar con la generación ya que no pertenecen al mismo ID.");
                            } else if(result == 'f2') {
    ...
    $( "#btDevolver" ).click(function() {
        ...
        if($('#taComentarioDev').val() == ""){
            ...
            $.ajax({url: "constanciaController.php", 
					    type: "POST",
						data: {inFuncion : '28', arraySolicitud : arraySolicitudGen, comentario : $('#taComentarioDev').val()},
						success: function(result){
    ...
    $( "#btAnular" ).click(function() {
        limpiarDivInfo();
        if($('#taAnulacionDev').val() == ""){
            alert("Observación es requerida.");
        } else if($('#taAnulacionDev').val().length > 199) {
            alert("Observación no debe tener mas de 200 caracteres.");
        } else{

            if (confirm('Esta seguro de realizar la anulación  ?')) {
                mostrarLoading();
                const idSolicitud = $("#inAnulacion").val();
                $.ajax({url: "constanciaController.php", 
                            type: "POST",
                            data: {inFuncion : '40', idSolicitud : idSolicitud, observacion : $('#taAnulacionDev').val()},
                            success: function(result){
                                alert("Anulación realizada correctamente");
                                cargarConstanciaGeneral();
                                $('#mAnulacion').modal('hide');
                                ocultarLoading();
                            },
                            error: function(XMLHttpRequest, textStatus, errorThrown) {
                                alert("Ocurrió un error, comuníquese con el administrador del sistema.");
    ...
    $( "#cbEnvioGeneral" ).click(function() {
        ...
        if(cantidadSeleccionada == 0){
            ...
            envairSolicitud(arraySolicitud);
        }
    });

    $(document).on('click', '.cbEnvio', function() {
        let idSolicitud = this.id.replace("cbEnv", "");
        let arraySolicitud = [];
        arraySolicitud.push(idSolicitud);
        envairSolicitud(arraySolicitud);
    });

    function envairSolicitud(arraySolicitud){
        arraySolicitudGen = arraySolicitud;
        limpiarDivInfo();
        $.ajax({url: "constanciaController.php", 
					    type: "POST",
						data: {inFuncion : '25', arraySolicitud : arraySolicitud},
						success: function(result){
                            if(result == 'f') {
                                divInfo("No se pueden procesar el envio(s) ya que las solicitudes no pertenecen al mismo ID.");
                            } else if(result == 'f2'){
                                divInfo("No se pueden procesar el envio(s) ya que algunas solicitudes no tienen la Fecha notificación último acto y/o Fecha ejecutoria.");
                            } else if(result == 'f3'){
                                divInfo("No se pueden procesar el envio(s) ya que algunas solicitudes no estan aprobadas aún.");
                            } else if(result == 'f4'){
                                divInfo("No se pueden procesar el envio(s) ya que algunas solicitudes no tienen el PDF generado.");
                            } else {
                                let parts = result.split('-');
                                //$('#taComentarioDev').val('');
                                $("#seRolEnvio").val('0');
                                $("#dvEnvioIndo").empty(); 
                                $("#dvEnvioIndo").append('ID: ' + parts[0] + '</br>');
                                $("#dvEnvioIndo").append('Dependencia: ' + parts[1] + '</br>');
                                $("#dvEnvioIndo").append('Usuario: ' + parts[2] + '</br>');
                                $("#taComentarioRol").val('');
                                $('#mEnvio').modal('show');
                            }
				  		},
    ...
    $( "#btEnviar" ).click(function() {
        ...
        if($('#taComentarioRol').val() != '' && $('#taComentarioRol').val().length > 199){
            alert("Comentario no debe tener mas de 200 caracteres.");
            return false;
        }

        if($('#seRolEnvio').val() == 0){
            alert("Debe seleccionar un rol para el envio.");
        } else{
            $.ajax({url: "constanciaController.php", 
					    type: "POST",
						data: {inFuncion : '17', arraySolicitud : arraySolicitudGen, rol : $('#seRolEnvio').val(), comentario : $('#taComentarioRol').val()},
						success: function(result){
                            alert("Envio(s) realizado correctamente");
                            cargarSolicitud();
                            $('#mEnvio').modal('hide');
				  		},
				  		error: function(XMLHttpRequest, textStatus, errorThrown) {
    ...
    $(document).on('click', '.cbAprobar', function() {
        let idSolicitud = this.id.replace("cbApro", "");
        if (confirm('Esta seguro de realizar la aprobación de la constancia ejecutoria  ?')) {
            let arraySolicitud = [];
            arraySolicitud.push(idSolicitud);
            aprobarSolicitud(arraySolicitud);
        }
    });


    $( "#cbAprobacionGeneral" ).click(function() {
        limpiarDivInfo();
        let cantidadSeleccionada = 0;
        let arraySolicitud = [];
        $("input:checkbox[name=cbSolicitud]:checked").each(function(){
    ...
    function aprobarSolicitud(arraySolicitud){
        mostrarLoading();
        limpiarDivInfo();
        $.ajax({url: "constanciaController.php", 
					    type: "POST",
						data: {inFuncion : '24', arraySolicitud : arraySolicitud},
						success: function(result){
                            if(result == "f2"){
                                divInfo("No se pueden procesar la aprobación(es) ya que una o varias solicitudes no tienen la Fecha notificación último acto y/o Fecha ejecutoria.");
                                ocultarLoading();
                            } else if(result == "f") {
                                divInfo("No se pueden procesar la aprobación(es) ya que no pertenecen al mismo ID.");
                                ocultarLoading();                    
                            } else {
                                alert("Aprobación realizada con exito.");
                                ocultarLoading();
                                cargarSolicitud();
                            }
				  		},
    ...
    $( "#icDescarga" ).click(function() {
        if(tab == 1)
            descargarSolicitudAprobador();
        if(tab == 3)
            descargarConstanciaGeneralRevisor();            
    }); 

    function descargarConstanciaGeneralRevisor(){
        limpiarDivInfo();
        if($("#inFechaInicio").val() != "" && $("#inFechaFinal").val() !="") {
            let parts = $("#inFechaInicio").val().split('-');
            let dtFechaInicio = new Date(parts[0], parts[1] - 1, parts[2]);
        ...
        $.ajax({url: "constanciaController.php", 
					    type: "POST",
						data: {inFuncion : '35', inFechaInicio : $("#inFechaInicio").val(), inFechaFinal : $("#inFechaFinal").val(), seDependencia : $("#seDependencia").val(), seGrupo : $("#seGrupo").val()},
						success: function(result){
                            ocultarLoading();
                            if(result == "200") {
                                window.location = '../bodega/tmp/workDir/revisorGeneral.xlsx';
                            } else {
                                alert("Ocurrió un error, comuníquese con el administrador del sistema.");
                            }                            
				  		},
    ...
    function descargarSolicitudAprobador(){
        limpiarDivInfo();
        if($("#inFechaInicio").val() != "" && $("#inFechaFinal").val() !="") {
            let parts = $("#inFechaInicio").val().split('-');
            let dtFechaInicio = new Date(parts[0], parts[1] - 1, parts[2]);
        ...
        $.ajax({url: "constanciaController.php", 
					    type: "POST",
						data: {inFuncion : '36', inFechaInicio : $("#inFechaInicio").val(), inFechaFinal : $("#inFechaFinal").val(), seDependencia : $("#seDependencia").val(), seGrupo : $("#seGrupo").val(), sePrinc : $("#sePrinc").val()},
						success: function(result){
                            ocultarLoading();
                            if(result == "200") {
                                console.log(result);
                                window.location = '../bodega/tmp/workDir/aprobadorSolicitudes.xlsx';
                            } else {
                                alert("Ocurrió un error, comuníquese con el administrador del sistema.");
                            }                            
				  		},
    ...
    $( "#bmAnulacionClose" ).click(function() {
        $('#mAnulacion').modal('hide');
    }); 

    $( "#bmAnulacionClose2" ).click(function() {
        $('#mAnulacion').modal('hide');
    });        
