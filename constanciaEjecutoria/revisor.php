                ...
                <div class="tab-content borderNav" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        ...
                        <div class="scrollX fixTableHead" style="height:450px;">
                            <table id="tbSolicitud" class="table table-striped table-bordered table-sm align-middle" cellspacing="0" width="100%" style="display: none">
                                <thead>
                                    <tr class="align-middle">
                                        <th>
                                            <input class="form-check-input" type="checkbox" value="" id="cbSolicitudGen">
                                        </th>
                                        <th>Alerta</th>
