...
<body class=" yui-skin-sam">
      ...
      <!--{else}-->
        <tr height="40px">
          <td valign="top" >Radicados sin Trd:</td>
            <td>
              <textarea readonly="READONLY"  cols="65" name="radSinTrd" id="radSinTrd" wrap="soft"><!--{$radSinTrd}--></textarea>
            </td>
          </td>
        </tr>
      <!--{/if}-->
      ...
      <!--{else}-->
        <tr height="120px">
          <td valign="top" >Radicados con Trd:</td>
            <td>
              <textarea readonly="READONLY" cols="65" name="radConTrd" id="radConTrd" wrap="soft" ><!--{$radConTrd}--></textarea>
              Cambiar la trd de los que ya tiene una asignada
              <input type="checkbox" name="cambExiTrd" value="111" checked="checked">
            </td>
          </td>
        </tr>
      <!--{/if}-->
  ...
  <table id="respuestaTrdMass"  class="yui-hidden2"  width="100%" align="center" margin="4">
    ...
    <tr height="40px">
      ...
      <td>
        <textarea id="radicadosResulTex" readonly="READONLY"  wrap="soft" cols="15"></textarea>
      </td>
    </tr>
                    <tr height="40px">
                                <td colspan="2" valign="center" align="center">
