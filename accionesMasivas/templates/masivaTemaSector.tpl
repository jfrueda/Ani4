		...
		<table width="96%" align="center" margin="4">      
			...
			<tr height="40px">
				...
				<td valign="center" width="100%">
					<textarea id="radSinTemaSec" name="radSinTemaSec" readonly="READONLY"  ><!--{$radSinSectem}--></textarea>																					                    
				</td>
		    </tr>
			<!--{/if}-->
			...
			<tr height="40px">
				...
				<td>
					<textarea id="radContemaSec" name="radcontemaSec" readonly="READONLY"  ><!--{$radConSectem}--></textarea>
