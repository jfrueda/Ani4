		...
		<tr valign="bottom">
			...
			<td>
				<a href='SoporteChat.php?nuRad=<?= $idRadicado ?>' target="SoporteEnLinea">
					<img src='images/soporteEnLinea.gif'></a>
			</td>
		</tr>
	</table>
</center>
...
<table border=0 cellspace=2 cellpad=2 WIDTH=98% align="center" class="t_bordeGris" id=tb_general>
	<tr>
		<td align="right" bgcolor="#CCCCCC" height="25">
			<font face="Arial, Helvetica, sans-serif" class="etextomenu">TIPO
				DOCUMENTO </font>
		</td>
		<td class='timpar' colspan="6">
			<?
			if (Trim($val_tpdoc_grb) == "///") {
				$val_tpdoc_grb = "";
			}
			?>
			<?= $tpdoc_nombre ?>
	...
	<tr>
		<td align="right" bgcolor="#CCCCCC" height="25">
			<font face="Arial, Helvetica, sans-serif" class="etextomenu">FECHA
				DE RADICADO</font>
		</td>
		<td class='timpar' width="25%" height="25">
			<?= $radi_fech_radi ?>
		</td>
		<td bgcolor="#CCCCCC" width="25%" align="right" height="25">
			<font face="Arial, Helvetica, sans-serif" class="etextomenu">ASUNTO
			</font>
		</td>
	...
	<tr>
		<td align="right" bgcolor="#CCCCCC" height="25$dc      ">
			<font face="Arial, Helvetica, sans-serif" class="etextomenu">
				<?= $tip3Nombre[1][$ent] ?></font>
		</td>
		<td class='timpar' width="25%" height="25">
			<?= $nombret_us1 ?>
		</td>
		<td bgcolor="#CCCCCC" width="25%" align="right" height="25">
			<font face="Arial, Helvetica, sans-serif" class="etextomenu">DIRECCION
				CORRESPONDENCIA </font>
		</td>
	...
	<tr>
		<td height="25" bgcolor="#CCCCCC" align="right">
			<p>
				<font face="Arial, Helvetica, sans-serif" class="etextomenu">N&ordm;
					DE PAGINAS</font>
			</p>
		</td>
		<td class='timpar' width="25%" height="25">
		...
		<td bgcolor="#CCCCCC" width="25%" height="25" align="right">
			<font face="Arial, Helvetica, sans-serif" class="etextomenu">DESCRIPCION
				ANEXOS </font>
		</td>
	...
	<tr>
		<td bgcolor="#CCCCCC" --++ width="25%" align="right" height="25">
			<font face="Arial, Helvetica, sans-serif" class="etextomenu">REF/OFICIO/CUENTA
				INTERNA </font>
		</td>
		...
		<td align="right" --++ bgcolor="#CCCCCC" height="25" class="etextomenu">ESTADO
			ACTUAL <font face="Arial, Helvetica, sans-serif" class="etextomenu">&nbsp;</font>
		</td>
	...
	?>
		<table cellspacing=2 cellpadding=2 width="97%" class="t_bordeGris" align="center">
			<tr class='etextomenu' align="center">
				<td width=10% class="grisCCCCCC" height="24">
					<font face="Arial, Helvetica, sans-serif">
						RADICADO </font>
				</td>
				<td width=15% class="grisCCCCCC" height="24">
					<font face="Arial, Helvetica, sans-serif">
						FECHA </font>
				</td>
				<td width=15% height="24" class="grisCCCCCC">
					<font face="Arial, Helvetica, sans-serif">
						Asunto</font>
				</td>
			</tr>
		...
		?>
			...
			<table cellspacing=2 cellpadding=2 width="97%" class="t_bordeGris" align="center">
				<tr class='etextomenu' align="center">
					...
					<td width=5% height="24" class="grisCCCCCC">
						<font face="Arial, Helvetica, sans-serif">
							No. PLANILLA</font>
					</td>
					<td width=15% height="24" class="grisCCCCCC">
