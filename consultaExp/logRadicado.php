...
<head>
	<TITLE>Consulta Web - ORFEO - Sistema de Gestion Documental</TITLE>
	<script>
		function loginTrue() {
	...
	<center>
		<TABLE>
			...
			if ($numeroRadicado) {
				...
				if ($numeroRadicado == $idWeb && substr($numeroRadicado, -1) == '2') {
					$ValidacionWeb = "Si";
					$idRadicado = $idWeb;
				} else {
					$ValidacionWeb = "No";
						...
						<TD>
							<table width="200" border="0" align="center">
								<tr>
									<TD colspan="2">
										<center>
											<font color=white face="arial" size=2><b>Numero de Radicado</b></font>
										</center>
									</TD>
								</tr>
								<tr>
