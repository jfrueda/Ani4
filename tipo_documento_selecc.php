...
<head>
	...
	<script>
		...
		/**
		 * Implementa la acci�n de anexar un nuevo archivo
		 * Decide si la opci�n a anexar coresponde a un documento sencillo o a 
		...
		function nuevoArchivo() {
			...
			//Si la opci�n seleccionada contiene 'P', se trata de un paquete, de lo contrario es un documento sencillo
