...
$depeRecepcion   = $_GET['depeRecepcion'];
$usuRecepcion   = $_GET['usuRecepcion'];
$usua_doc_radica   = $_GET['usuDocRadica'];
...
<script type="text/javascript">
	...
	function ejecutarProceso() {
        ...
        var usua_doc_radica = <?php echo $usua_doc_radica; ?>;	
		var depeRecepcion = <?php echo $depeRecepcion; ?>;	
		var usuRecepcion = <?php echo $usuRecepcion; ?>;	
		$.ajax({url: "masiva.php", 
						    type: "POST",
							data: { depeRadica : depeRadica, usuRadica : usuRadica, depeEnvio : depeEnvio, usuEnvio: usuEnvio, usua_doc_radica: usua_doc_radica, depeRecepcion: depeRecepcion, usuRecepcion: usuRecepcion},
