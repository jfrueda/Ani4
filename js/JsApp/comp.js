...
function verRad(radicado, tipo, key=''){
    if(tipo=='radie')
        url='../busqueda/superargo1.php?nume_radi='+radicado;
    else
        url='../verradicado.php?verrad='+radicado+(key != '' ? '&key='+key : '');
