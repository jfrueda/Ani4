...
function filed(nurad="no llego rad",uid="no llego uid"){
	loadURL("email-opened-live.php?uid="+uid+"&nurad="+nurad, $('#inbox-content > .table-wrap'));
}
...
<body>
	...
	<table width="100%" cellspacing="7" border="0" cellpadding="0" class="border" >
		<tr>
			<td width=60%>&nbsp;</td>
			<td>
				<span style="font-size: 64;font-family: 'Free 3 of 9'">*<?=$nurad?>*</span><br>
