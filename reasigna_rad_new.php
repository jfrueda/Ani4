...
if (
	isset($_POST['usuario'], $_POST['dependencia'], $_POST['radicado'], $_POST['modificar']) &
			...
			<table width="80%" class='borde_tab' cellspacing='5'>
				<tr class='titulos2'>
					...
					<td width="55%" class=listado2>
						<input type="" name="radicado" id="radicado" value=<? if (isset($_POST['radicado'])) {
																				echo $_POST['radicado'];
																			} ?>>
					</td>
				</tr>
				...
				<? if (
					...
					<tr>
						<td colspan="2" align="center">
							...
							<? if (isset($flag_modificado) &&  $flag_modificado) {
								echo "<br/> <font color=red>El radicado " . $_POST['Radicado'] . " fue actualizado correctamete.</font></br>";
							} ?>
						</td>
					</tr>
				<? } ?>
