...
.swal2-confirm.custom-consultar:hover {
    background-color: #5a6268; /* Color del botón al pasar el ratón */
}
#circle {
    position: absolute;
    top: 50%;
...
<!--------------------------------------->
    <div class="container mt-5 p-5" id="frm">
      <div class="card shadow-sm">
        <div class="card-body p-5">
          <h4 class="card-title text-center mb-4" style="font-family: 'Times New Roman', serif;"><b>CARGUE DE ACUSES A LOS RADICADOS</b></h4>
          <form action="#" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" id="sendData" class="btn btn-success w-100 mt-3">Enviar</button>
          </form>
        </div>
      </div>
    </div>
