...
<head>
	<title>.: Modulo Movil :.</title>
</head>
<link rel="stylesheet" href="movil/estilos/orfeomovil.css">
</head>
...
<body>
	<table border=0 align='center' cellpadding="0" cellspacing="0" width="100%">
		<form action='verradicado_movil.php?<?= session_name() ?>=<?= trim(session_id()) ?>&verrad=<?= $verrad ?>&datoVer=<?= $datoVer ?>&chk1=<?= $verrad . "&carpeta=$carpeta&nomcarpeta=$nomcarpeta" ?>' method='GET' name='form2'>
			<?
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#006699">
				...
				<tr>
					<td width="25%" align="center" height="25" class="titulos2">DIRECCI&Oacute;N CORRESPONDENCIA</td>
					<td class='titulos3' width="25%"><?= $direccion_us1 ?></td>
				</tr>
				<tr>
					<td width="25%" align="center" height="25" class="titulos2">MUN/DPTO</td>
					<td class='titulos3' width="25%"><?= $dpto_nombre_us1 . "/" . $muni_nombre_us1 ?></td>
				</tr>
				<tr>
					<td height="25" align="center" class="titulos2">
						<p>N&ordm; DE PAGINAS</p>
					</td>
				...
				<tr>
					<td align="left" height="25" align="center" class="titulos2">DOCUMENTO<br>Anexo/Asociado</td>
