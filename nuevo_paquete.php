...
//Genera el objeto que procesa los datos del remitnete para un paquete de numeraci�n y fechado
...
//Arma el query que obtine los datos del paquete de numeraci�n y fechado
...
<body bgcolor="#FFFFFF" text="#000000">
	<script language="JavaScript">
		...
		function validar() {
			...
			//indica algun inconveniente "existeDocumento*" no tenga alg�n comentario de objeci�n
			...
			//indica algun inconveniente "completitudDestinatario*" no tenga alg�n comentario de objeci�n
			...
			//Verifica que los argumentos esten completos, a trav�s del campo "listaArgumentos", que contiene
			//la lista de codigos de argumento del paquete de datos
			desde = 0;
			argumentos = document.formPaqueteDocumentos.listaArgumentos.value;
			//Verifica que no exista problema alguno con los argumentos, es decir que las listas de selecci�n que
	...
	<form name="formPaqueteDocumentos" action="nuevo_paquete_registro.php" method=post>
		...
		?>
			...
			<table width="75%" style="border-collapse: collapse; border: groove;">
				...
				<r>
					<?
					// Si es el documento principal pintal el �ltimo n�mero generado y los argumentos
					...
					?>
						<tr>
							<td class='etextomenu'>
								<p>(Ultimo numero de documento Generado: <b>
										<font color="#008040"><?= $numeroActualSecuencia ?></font>
									</b>)</p>
							</td>
						</tr>
