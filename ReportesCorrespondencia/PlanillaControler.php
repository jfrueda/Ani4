...
require_once ($ruta_raiz."/ReportesCorrespondencia/PlanillaModel.php");
...
class PlanillaControler{
  ...
  private $dependencia;
    ...
    $this->tpl = new HTML_Template_IT($ruta_raiz."/ReportesCorrespondencia/");
	...
	public function crearReporte($tipoReporte){
		...
		//echo "entidad_largo: ".$entidad_largo;
		...
		,"DIRECCION"=>"Direccion","NOMBRE ORIGEN"=>"Nombre Origen","DIRECCION"=>"Direccion","NOMBRE REMITENTE"=>"Remitente","DEPENDENCIA DESTINO"=>"Dependencia Destino","POSTFIRMA"=>"Postfirma ","FIRMA"=>"Firma "));
		$arrayDatos=$this->arrayPrincipal+$this->arraySecundario;
