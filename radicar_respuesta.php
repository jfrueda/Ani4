<?php
  ...
  #require_once($ruta_raiz."/tcpdf/tcpdf.php");
  require_once($ruta_raiz."/tcpdf/tcpdf_barcodes_2d.php");
 ...
 # exit;
  ...
  $SetSubject     = 'SuperArgo';
  $SetKeywords    = 'SuperArgo, respuesta, salida, generar';
...
$respuesta = str_replace('DIG_NATARIO', $dignatario, $respuesta);
$respuesta = str_replace('REF_ERENCIA', $referencia, $respuesta);
