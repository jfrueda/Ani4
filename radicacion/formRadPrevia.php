   ...
   <fieldset>
    <div class="row">
      <section class="col col-4">
        ...
        <label class="input"></i>
          <input data-toggle="tooltip" title="Escriba para buscar por Referencia (Cuenta Interna, Numero de Oficio)"  name="buscar_por_cuentai" type="text" class="ecajasfecha" id="cuentai" size="100" value="<?=$buscar_por_cuentai ?>">
        </label>
      </section>
      <section class="col col-4">
