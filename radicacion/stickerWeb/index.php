...
$remitente = $rs->fields["SGD_DIR_NOMBRE"] ? $rs->fields["SGD_DIR_NOMBRE"] . ' ' . $rs->fields["SGD_DIR_APELLIDO"] : $rs->fields["SGD_DIR_NOMREMDES"];
...
$informados = implode(',', array_map(function ($depe) {
	return $depe['DEPE_NOMB'];
}, $res_informados));
