    ...
    ?>
      <div class="card shadow-sm border-0">
        <div class="card-header bg-orfeo text-white">
          <h5 class="mb-0">CREACIÓN DE CARPETAS</h5>
        </div>
        ...
        <div class="card-body">
          <div class="row g-4">
            ...
            <div class="col-12 col-md-6">
              <label for="nombcarp" class="form-label fw-semibold">Nombre de carpeta</label>
              <input name="nombcarp"
                id="nombcarp"
                type="text"
                size="25"
            ...
            <!-- Descripcion -->
            <div class="col-12 col-md-6">
              <label for="desccarp" class="form-label fw-semibold">Descripción</label>
              <input name="desccarp"
                id="desccarp"
                type="text"
                size="25"
  ...
  <div class="card shadow-sm border-0 mb-4">
    ...
    <div class="card-body">
      <div class="alert alert-info text-center mb-0">
        La descripción de la carpeta le recordará el destino final de la misma.
        <br>
        Esto se puede ver pasando el mouse sobre cada una de las carpetas.
      </div>
    </div>
  </div>
</body>
