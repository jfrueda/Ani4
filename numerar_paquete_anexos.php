...
//Programa que numera un paquete de documentos de numeraci�n y fechado
//adem�s muestra el resultado de esta numeraci�n
...
if (strlen(trim($secuenciaDocto))<1){
	...
	if	(!$anex->guardarSecuencia()){
		...
		die ("<span class='etextomenu'>No se ha podido Grabar la informaci�n de numeraci�n");
