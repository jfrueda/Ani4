...
echo <<<EOF
    ...
    <title>..:: $entidad - OrfeoGpl Correlibre ::..</title>

    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" href="$ruta_raiz/img/favicon.png">
    <!-- Bootstrap core CSS -->
    ...
    <script type="text/javascript" src="$ruta_raiz/js/functionImage.js"></script>
    <!-- FIN archivo js para manejar los eventos -->
    ...
    <!-- Agrega la funion de cargar imagenes de los radicados y anexos.... -->
EOF;
