...
$ruta_raiz = "../..";
session_start();
if (!$dependencia || !$tpDepeRad || !$codusuario) {
...
<body>
	<table width="60%" border="0">
		<tr>
			<td colspan="2">
				<div align="center"><strong>Administraci&oacute;n de Perfiles </strong></div>
			</td>
		</tr>
		<?
		if ($editar) {
		?>
			<tr>
				<td colspan="2">
					<div align="center"><strong>Edici&oacute;n de Dependencias</strong></div>
				</td>
			</tr>
		<?
		} else {
		?>
			<tr>
				<td colspan="2">
					<div align="center"><strong>Creaci&oacute;n de Dependencias</strong> </div>
				</td>
			</tr>
		<?
		}
