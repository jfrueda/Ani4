...
/* $Id: Smarty_Compiler.class.php,v 1.1 2009/03/11 19:22:48 jrodriguez Exp $ */
...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        $compiled_content = preg_replace_callback("~(?<!')language\s*=\s*[\"\']?\s*php\s*[\"\']?~", "<?php echo 'language=php' ?>\n", $compiled_content);
