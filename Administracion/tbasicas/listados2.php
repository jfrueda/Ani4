...
*
*	Permite la visualizaci�n general de paises, departemntos, municipios, tarifas, etc.
*	Es una idea b�sica. A�n est� bajo desarrollo.
*/
...
switch ($_GET['var']) {
	...
	case 'pai': {
			...
			$tit_columnas = array('Continente', 'Id Pa�s', 'Nombre Pa�s');
	...
	case 'bge': {
			...
			$tit_columnas = array('Empresa', 'Sigla', 'Correo E', 'Tel�fonos', 'NIT', 'NIUR', 'Id Empresa');
