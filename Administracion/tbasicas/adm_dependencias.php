...
if ($db) {
	...
	if (isset($_POST['btn_accion'])) {
		...
		switch ($_POST['btn_accion']) {
			case 'Agregar': {
				...
				break;
			case 'Modificar': {	/* Las reglas del negocio para la inactivacion de una dependencia son:
	...
	$sql1 .= "FROM DEPENDENCIA where  (depe_codi< 1000 or depe_codi> 9999)  ";
...
<body>
					...
					<article class="col-12">
						<div class="card shadow-sm border-secondary">
							<div class="card-header bg-orfeo text-white d-flex justify-content-between align-items-center">
								<h5 class="mb-0">
									<i class="fa fa-sitemap me-2"></i>Administración de dependencias
									<br>
							...
							<div class="card-body bg-light">
								<div class="row align-items-center justify-content-center py-2">
									<div class="col-12 col-md-3 text-md-end">
										<label class="form-label fw-bold text-secondary mb-md-0">
									...
									<div class="col-12">
										<div class="tabber" id="tab1">
											<div class="tabbertab" title="Básicos">
												<div class="card shadow-sm border-secondary mt-3">
													<div class="card-body bg-light">
														<div class="row g-3 mb-4">
															<div class="col-md-3">
																<label for="txtIdDep" class="form-label fw-bold small text-uppercase text-secondary">Código</label>
																<input name="txtIdDep" id="txtIdDep" type="text" class="form-control" maxlength="<?= $digitosDependencia ?>" value="<?= $txtIdDep ?>" placeholder="Ej: 100">
															</div>
															<div class="col-md-3">
																<label for="txtSigla" class="form-label fw-bold small text-uppercase text-secondary">Sigla</label>
																<input name="txtSigla" id="txtSigla" type="text" class="form-control" maxlength="15" value="<?= $txtSigla ?>" placeholder="Ej: JUR">
															</div>
															<div class="col-md-6">
																<label for="Slc_destado" class="form-label fw-bold small text-uppercase text-secondary">Estado</label>
																<select name="Slc_destado" id="Slc_destado" class="form-select">
														...
														<div class="row g-3 mb-4">
															<div class="col-md-6">
																<label for="txtModelo" class="form-label fw-bold small text-uppercase text-secondary">Nombre de la Dependencia</label>
																<input name="txtModelo" id="txtModelo" type="text" class="form-control" maxlength="70" value="<?= $txtModelo ?>">
															</div>
															<div class="col-md-6">
																<label for="txtActoAdmon" class="form-label fw-bold small text-uppercase text-secondary">Acto Administrativo de Creación</label>
																<input name="txtActoAdmon" id="txtActoAdmon" type="text" class="form-control" maxlength="70" value="<?= $txtActoAdmon ?>">
															</div>
														</div>

														<div class="row mb-4">
															<div class="col-12">
																<label for="txtDir" class="form-label fw-bold small text-uppercase text-secondary">Dirección</label>
																<div class="input-group">
																	<span class="input-group-text"><i class="fa fa-map-marker text-muted"></i></span>
																	<input name="txtDir" id="txtDir" type="text" class="form-control" maxlength="70" value="<?= $txtDir ?>">
																</div>
															</div>
														</div>

														<div class="row g-2 mb-4 p-3 border rounded bg-white mx-0">
															<div class="col-12 mb-2">
																<label class="form-label fw-bold small text-uppercase text-info">
																	<i class="fa fa-globe me-1"></i>Ubicación Geográfica
																</label>
															</div>
															...
															<div class="col-6 col-md-3">
																<select name='muni_us1' id="muni_us1" class='form-select'>
																	<option value='0' selected>
														...
														<div class="row mb-4">
															<div class="col-12">
																<label class="form-label fw-bold small text-uppercase text-secondary d-block">¿Cierre automático de radicados?</label>
																<div class="btn-group" role="group">
																	<input type="radio" class="btn-check" name="cierre" id="cierreSi" value="1" <?= $cierres ?> autocomplete="off">
																	<label class="btn btn-outline-success" for="cierreSi">SI</label>

																	<input type="radio" class="btn-check" name="cierre" id="cierreNo" value="0" <?= $cierren ?> autocomplete="off">
																	<label class="btn btn-outline-danger" for="cierreNo">NO</label>
																</div>
															</div>
														</div>
														...
														<div class="row g-3">
															<div class="col-12 col-md-6">
																<label class="form-label fw-bold small text-uppercase text-secondary">Dependencia Principal</label>
																<?php
																echo $slc_dep2;
																?>
															</div>
															<div class="col-12 col-md-6">
																<label class="form-label fw-bold small text-uppercase text-secondary">Dependencia Adscrita</label>
																<?php
																echo $slc_dep3;
																?>
															</div>
															<div class="col-12 mt-4">
																<label class="form-label fw-bold small text-uppercase text-secondary">
																	Dependencias a las que será VISIBLE
																	<span class="badge bg-warning text-dark ms-2">CTRL + Click para selección múltiple</span>
																</label>
																<div class="border p-2 bg-white rounded">
																	...
																	?>
																	<div class="mt-2">
																		<input type="button" id="checkAll" class="btn btn-sm btn-dark" onclick="checkall()" value="Seleccionar todas">
																		<input type="button" id="unCheckAll" class="btn btn-sm btn-outline-dark" onclick="uncheckall()" value="Borrar todas">
																	</div>
																</div>
															</div>
														</div>
										...
										<table class="table table-bordered table-striped">
											<tr>
												<td width="10%">&nbsp;</td>
												<td width="20%" align="center"><input name="btn_accion" type="button" class="btn btn-primary" id="btn_accion" value="Listado" onClick="ver_listado();" accesskey="L" alt="Alt + L"></td>
												<td width="20%" align="center"><input name="btn_accion" type="submit" class="btn btn-success" id="btn_accion" value="Agregar" onClick="return ValidarInformacion(this.value);" accesskey="A"></td>
												<td width="20%" align="center"><input name="btn_accion" type="submit" class="btn btn-warning" id="btn_accion" value="Modificar" onClick="return ValidarInformacion(this.value);" accesskey="M"></td>
												<td width="20%" align="center"><input name="btn_accion" type="submit" class="btn btn-danger" id="btn_accion" value="Eliminar" onClick="document.form1.hdBandera.value='E'; return ValidarInformacion();" accesskey="E"></td>
												<td width="10%">&nbsp;</td>
											</tr>
										</table>
										<script type="text/javascript">
	...
	<script>
		document.addEventListener('DOMContentLoaded', function() {
			const slcId = document.getElementById('slc_id');
			const idcont1 = document.getElementById('idcont1');
			const Slc_dpadre = document.getElementById('Slc_dpadre');
			const Slc_dterr = document.getElementById('Slc_dterr');
			const slc_tr1 = document.getElementById('slc_tr1');
			const slc_tr2 = document.getElementById('slc_tr2');
			const slc_tr3 = document.getElementById('slc_tr3');
			const slc_tr4 = document.getElementById('slc_tr4');
			const slc_tr5 = document.getElementById('slc_tr5');
			const slc_tr6 = document.getElementById('slc_tr6');
			const slc_tr7 = document.getElementById('slc_tr7');

			if (slcId) {
				slcId.classList.remove('select');
				slcId.classList.add('form-select');
			}

			if (idcont1) {
				idcont1.classList.remove('select');
				idcont1.classList.add('form-select');
			}

			if (Slc_dpadre) {
				Slc_dpadre.classList.remove('select');
				Slc_dpadre.classList.add('form-select');
			}

			if (Slc_dterr) {
				Slc_dterr.classList.remove('select');
				Slc_dterr.classList.add('form-select');
			}

			if (slc_tr1) {
				slc_tr1.classList.remove('select');
				slc_tr1.classList.add('form-select');
			}

			if (slc_tr2) {
				slc_tr2.classList.remove('select');
				slc_tr2.classList.add('form-select');
			}

			if (slc_tr3) {
				slc_tr3.classList.remove('select');
				slc_tr3.classList.add('form-select');
			}

			if (slc_tr4) {
				slc_tr4.classList.remove('select');
				slc_tr4.classList.add('form-select');
			}

			if (slc_tr5) {
				slc_tr5.classList.remove('select');
				slc_tr5.classList.add('form-select');
			}

			if (slc_tr6) {
				slc_tr6.classList.remove('select');
				slc_tr6.classList.add('form-select');
			}

			if (slc_tr7) {
				slc_tr7.classList.remove('select');
				slc_tr7.classList.add('form-select');
			}
		});
	</script>
</body>
