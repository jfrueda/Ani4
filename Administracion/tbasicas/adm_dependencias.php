...
<script type="text/javascript">
    	...
    	function checkall(){
        	$('#Slc_dvis').each(function(){ console.log(this); $(this).find('option').prop('selected', true); })
        	$('#Slc_dvis').each(function(){ console.log(this); $(this).find('option').prop("selected","selected");$(this).trigger("change"); })
    	}
    	function uncheckall(){
	        $('#Slc_dvis').each(function(){ console.log(this); $(this).find('option').prop('selected', false); })
	         $('#Slc_dvis').each(function(){ console.log(this); $(this).find('option').removeAttr("selected");$(this).trigger("change"); })

	    }
	    function selectores(){
	    	  $('#Slc_dvis').each(function(){  $(this).select2(); })
	    }
</script>
              ...
              <div>
                ...
                <div class="widget-body no-padding">
                  ...
                  <div class="tabber" id="tab1">
                      ...
                      <tr>
                        <td align="left" class="titulos2"><b>&nbsp;Cierre automatico de radicados?</b></td>
                        <td colspan="5" class="listado2">
                        	SI <input type="radio" name="cierre" value="1" <?=$cierres?>>
                        	NO <input type="radio" name="cierre" value="0" <?=$cierren?>>
                        </td>
                      </tr>
