                ...
                <div class="widget-body no-padding">
                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td align="left" class="listado2">
                        <select name='codep_us1' id="codep_us1" class='select' onChange="borra_datos();cambia(this.form, 'muni_us1', 'codep_us1')">
                    ...
                    <tr>
                      ...
                      <td align="left" class="listado2">
                        <select name='muni_us1' id="muni_us1" class='select' onchange="borra_datos();Actual()">
                    ...
                    if ($error) {
                      ...
                      switch ($error) {
                        ...
                        case 2:
                          echo "Municipio creado satisfactoriamente!!";
                        ...
                        case 5:
                          echo "No se puede eliminar municipio, se encuentra ligado a direcciones.";
                          break;    //IMPOSIBILIDAD DE ELIMINAR PAIS, EST� LIGADO CON DIRECCIONES
                        case 6:
                          echo "No se puede Modificar el Codigo del Municipio.";
                          break;                          //IMPOSIBILIDAD DE MODIFICAR MPIO
                      }
                      echo '</td></tr>';
                    }
                    ?>
