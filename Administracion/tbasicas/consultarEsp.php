...
if ($usModo == 3) {
	$tituloCrear = "Consultar Empresas";
}
//$db->conn->debug=true;
$error = 0;
?>
										...
										?>
													<tr class="grisCCCCCC" align="center">
														<td width="11%" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['NIT_DE_LA_EMPRESA'] ?></font>
														</td>
														<td width="11%" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['NOMBRE_DE_LA_EMPRESA'] ?></font>
														</td>
														<td width="14%" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['NOMBRE_REP_LEGAL'] ?></font>
														</td>
														<td width="15%" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['CARGO_REP_LEGAL'] ?></font>
														</td>
														<td width="14%" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['DIRECCION'] ?></font>
														</td>
														<td width="9%" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['TELEFONO_1'] ?></font>
														</td>
														<td width="7%" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['EMAIL'] ?></font>
														</td>
														<td colspan="3" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['DPTO_NOMB'] ?></font>
														</td>
														<td colspan="3" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['MUNI_NOMB'] ?></font>
														</td>
														<td colspan="3" CLASS="titulos5">
															<font size="-3"><?= $rs->fields['NOMBRE_PAIS'] ?></font>
														</td>
													</tr>
												<?
													$rs->MoveNext();
