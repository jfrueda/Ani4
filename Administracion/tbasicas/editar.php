							...
							<div>
								...
								<div class="widget-body no-padding">
										...
										<tr bordercolor="#FFFFFF">
											<td colspan="2" class="titulos4">
												<center>
													...
													<p><B><span class=etexto> <?= $tituloCrear ?></span></B> </p>
												</center>
											</td>
										</tr>
									</table>
									...
									<table class=borde_tab width="100%" cellpadding="0" cellspacing="5">
										...
										?>
													<tr class="grisCCCCCC" align="center">
														<td width="11%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['IDENTIFICADOR_EMPRESA'] ?></font>
														</td>
														<td width="11%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['NIT_DE_LA_EMPRESA'] ?></font>
														</td>
														<td width="11%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['NOMBRE_DE_LA_EMPRESA'] ?></font>
														</td>
														<td width="14%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['NOMBRE_REP_LEGAL'] ?></font>
														</td>
														<td width="15%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['CARGO_REP_LEGAL'] ?></font>
														</td>
														<td width="14%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['DIRECCION'] ?></font>
														</td>
														<td width="9%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['TELEFONO_1'] ?></font>
														</td>
														<td width="9%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['TELEFONO_2'] ?></font>
														</td>
														<td width="7%" CLASS="titulos5">
															<font size="-3"><?= $rsBuscar->fields['EMAIL'] ?></font>
														</td>
