...
if ($db->conn) {
  ...
  if (isset($_POST['idcont']) && $_POST['idcont'] > 0) {
                    ...
                    if ($error) {
                      ...
                      switch ($error) {
                        ...
                        case 6:  //IMPOSIBILIDAD MODIFICAR PAIS,
                          echo "No se puede Modificar el Codigo del pa&iacute;s . O intenta crear un pais con un codigo que ya existe";
                          break;
                      }
                      echo '</td></tr>';
                    }
