...
if ($usModo == 1) {
	$tituloCrear = "Creacion Empresas";
}
//$db->conn->debug=true;
$error = 0;

if (isset($_POST['txt_esp'])) {
	...
	<script>
		function envio_datos() {
			...
			if (isWhitespace(document.forms[0].txt_dir.value)) {
				alert("El campo Direcci�n no ha sido diligenciado.");
							...
							<div>
								...
								<div class="widget-body no-padding">
									...
									?>
										...
										?>
											<script>
												resp = confirm("Esta Empresa ya Existe, no es Posible su Creaci�n , desea modificarla , recuerde volver a buscarla para la edicion");
												if (resp == true)
