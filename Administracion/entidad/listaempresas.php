...
session_start();
/**-------------------------------Lista Empresas -------------------------------*
 * @NOMBRE: CONSULTAR LA LISTA DE EMPRESAS EN LA TABLA BODEGA_EMPRESAS
 * @FECHA DE CREACI�N: 15-06-06
 * @AUTOR: SUPERSOLIDARIA
 * @DESCRIPCI�N: Se listan las empresas de la tabla BODEGA_EMPRESAS.
			...
			<tr>
				<td width='100%'>
					<table width="100%" align="center" cellspacing="0" cellpadding="0">
						...
						<?
						include_once "lista_bodega_empresas.php";
