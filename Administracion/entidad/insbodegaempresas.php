 ...
 * @FECHA DE CREACI�N: 14-06-06
 * @AUTOR: SUPERSOLIDARIA
 * @DESCRIPCI�N: Registra la empresas en la tabla BODEGA_EMPRESAS, con verificaci�n
 *				 previa de la existencia de la entidad en la Base de Datos.
 *------------------------------------------------------------------------------*/
/**
 * Paggina Cuerpo.php que muestra el contenido de las Carpetas
 * Creado en la SSPD en el a�o 2003
 * 
 * Se a�adio compatibilidad con variables globales en Off
...
<script>
  function validar() {
    ...
    var checkOK = "0123456789ABCDEFGHIJKLMN�OPQRSTUVWXYZabcdefghijklmn�opqrstuvwxyz-.& ";
    ...
    <form name="formulario" method="post" action="<?= $almacenar ?>">
      ...
      <table border=0 width=100% class="borde_tab" align="center" cellpadding="0" cellspacing="5">
        <tr class=listado2>
          ...
          <td class="titulos5" height="25" align="right">NUIR<font face="Arial, Helvetica, sans-serif" class="etextomenu">&nbsp;</font>
          </td>
          <td width="39%" height="25" bgcolor="#FFFFFF" class="listado5"><input type="text" name="nuir" class="tex_area" size=30></td>
        </tr>
        <tr class=e_tablas>
          <td width="17%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Nombre</font>
          </td>
          <td width="30%" bgcolor="#FFFFFF" height="25" class="listado5"><input type="text" name="nombre" class="tex_area" size=40 value='<?= $nombre ?>'>
            *
          </td>
          <td width="14%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Sigla
            </font>
          </td>
        ...
        <tr class=e_tablas>
          ...
          <td width="14%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Tel&eacute;fono 1 </font>
          </td>
        ...
        <tr class=e_tablas>
          <td width="17%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Tel&eacute;fono 2 </font>
          </td>
        ...
        <tr class=e_tablas>
          <td width="17%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Representante Legal</font>
          </td>
          <td bgcolor="#FFFFFF" height="25" class="listado5"><input type="text" name="replegal" class="tex_area" size=40></td>
          <td bgcolor="#FFFFFF" height="25" class="titulos5">
            <div align="right">
              <font face="Arial, Helvetica, sans-serif" class="etextomenu">Cargo</font>
            </div>
          </td>
        ...
        <tr class=e_tablas>
          <td width="17%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Departamento </font>
          </td>
          ...
          <td width="14%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Municipio </font>
          </td>
        ...
        <tr class=e_tablas>
          <td width="17%" class="titulos5" height="25" align="right">
            <font face="Arial, Helvetica, sans-serif" class="etextomenu">Delegatura</font>
          </td>
        ...
        <tr class=e_tablas>
          <td height="25" colspan="4" align="right" class="titulos5">
            <div align="center">
      ...
      if ($insertarEmpresa && $nombre != '' && $sigla != '' && $direccion != '' && $codep_us != 0 && $muni_us != 0) {
        ...
        $isqlB = "SELECT * FROM BODEGA_EMPRESAS WHERE NIT_DE_LA_EMPRESA = '$nit'";
        ...
        if ($nitempresa != '') {
          ...
          //Ejecuta la busqueda y obtiene el �ltimo Codigo de la Empresa.
