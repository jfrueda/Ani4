 ...
 * @FECHA DE CREACI�N: 24-04-08
 * @AUTOR: SUPERSOLIDARIA
 * @DESCRIPCI�N: Se listan las empresas de la tabla BODEGA_EMPRESAS PARA USUARIOS 
 CON PRIVILEGIOS .
 *------------------------------------------------------------------------------*/
$krdOld = $krd;
session_start();
...
<body bgcolor="#FFFFFF" topmargin="0" onLoad="window_onload();">
	...
	<FORM name=form_lista_empresas action='<?= $PHP_SELF ?>?<?= $encabezado ?>' method=post>
		<table width="100%" border="0" class=borde_tab>
			<tr>
				<td width="11%" bgcolor="377584" class="info">
			...
			<tr class="info">
				<td>
					<div align="center"><a href='javascript: history.back()'>Atras</a></div>
				</td>
				<?
				switch ($entidad) {
					case 'SES':
	...
	-->
						...
						$pager->colOptions = false; //Par�metro para colocar la columna con las opciones
