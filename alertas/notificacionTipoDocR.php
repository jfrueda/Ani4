...
<body bgcolor="#FFFFFF" topmargin="0" onLoad="window_onload();">
  ...
  $iSql = "
          select
          r.radi_nume_radi, r.radi_fech_radi, r.fech_vcmto, r.ra_asun ,  (EXTRACT('day' from (current_date - r.radi_fech_radi))-t.sgd_tpr_termino) as diasf ,t.sgd_tpr_termino, r.radi_usua_actu, r.radi_depe_actu
          from radicado r, sgd_tpr_tpdcumento t
          where
