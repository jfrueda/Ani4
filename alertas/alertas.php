                ...
                <div class="panel-body" style="overflow:auto; height:300px;">
                    <p>
                        ...
                        foreach ($arrAlerta2 as $key => $value) {
                            if (!$arrAlerta2[$key]["anexEstado"] || $arrAlerta2[$key]["anexEstado"] <= 1) {
                                $imgEstado = "./imagenes/docRecibido.gif";
                            }
                            if ($arrAlerta2[$key]["anexEstado"] == 2) {
                                $imgEstado = "./imagenes/docRadicado.gif";
                            }
                            if ($arrAlerta2[$key]["anexEstado"] == 3) {
                                $imgEstado = "./imagenes/docImpreso.gif";
                            }
                            if ($arrAlerta2[$key]["anexEstado"] == 4) {
                                $imgEstado = "./imagenes/docEnviado.gif";
                            }
                    ...
                    <p>
                        ...
                        if (is_array($arrAlerta1)) {
                            foreach ($arrAlerta1 as $key => $value) {
                                if (!$arrAlerta1[$key]["anexEstado"] || $arrAlerta1[$key]["anexEstado"] <= 1) {
                                    $imgEstado = "./imagenes/docRecibido.gif";
                                }
                                if ($arrAlerta1[$key]["anexEstado"] == 2) {
                                    $imgEstado = "./imagenes/docRadicado.gif";
                                }
                                if ($arrAlerta1[$key]["anexEstado"] == 3) {
                                    $imgEstado = "./imagenes/docImpreso.gif";
                                }
                                if ($arrAlerta1[$key]["anexEstado"] == 4) {
                                    $imgEstado = "./imagenes/docEnviado.gif";
                                }
                    ...
                    <p>
                        ...
                        if ($arrAlerta3) {
                            foreach ($arrAlerta3 as $key => $value) {
                                if (!$arrAlerta3[$key]["anexEstado"] || $arrAlerta3[$key]["anexEstado"] <= 1) {
                                    $imgEstado = "./imagenes/docRecibido.gif";
                                }
                                if ($arrAlerta3[$key]["anexEstado"] == 2) {
                                    $imgEstado = "./imagenes/docRadicado.gif";
                                }
                                if ($arrAlerta3[$key]["anexEstado"] == 3) {
                                    $imgEstado = "./imagenes/docImpreso.gif";
                                }
                                if ($arrAlerta3[$key]["anexEstado"] == 4) {
                                    $imgEstado = "./imagenes/docEnviado.gif";
                                }
