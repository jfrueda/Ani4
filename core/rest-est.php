...
//echo $dep_busq;
    ...
    case 'subSeries':
        //$db->conn->debug =true;
        $iSql = "SELECT distinct (s.sgd_sbrd_descrip||'-'||s.sgd_sbrd_codigo) as nomb, s.sgd_sbrd_codigo cod,s.id FROM sgd_sbrd_subserierd s JOIN sgd_mrd_matrird m ON m.depe_codi = '$dep_busq' and m.sgd_srd_codigo = '$serie' WHERE s.sgd_srd_codigo = m.sgd_srd_codigo and s.sgd_sbrd_codigo = m.sgd_sbrd_codigo and s.sgd_sbrd_estado  = '1' ";
