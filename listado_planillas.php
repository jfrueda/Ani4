...
<body>
	<TABLE class="t_bordeGris">
		<TR>
			<TD bgcolor="#CCCCCC">
				Del Usuario </TD>
			<TD> <select name=codus class=e_cajas>
					...
					do {
						$codigo = $row["USUA_CODI"];
						$usnombre = $row["USUA_NOMB"];
						$datoss = "";
						if ($codus == $codigo) {
							$datoss = " selected ";
						}
		...
		<Tr>
			<TD bgcolor="#CCCCCC">
				Tarea a Realizar </TD>
			<TD><select name=tarea class=e_cajas>
