            ...
            <form id="consultaweb" action= "<?=$_SERVER['PHP_SELF']?>" name="consultaweb" enctype="multipart/form-data" method="post" autocomplete="on">
                <div class="row justify-content-md-center">
					<div class="col-md-6" style="text-align: center">
						<p>A través de este servicio usted puede consultar el estado de su PQRD, si fue formulada a partir de diciembre de 2016.</p>
					</div>
				</div>
				<div class="row justify-content-md-center">
				...
				<div class="row justify-content-md-center">
					<div class="col-md-6">
						<div class="form-group">
                            ...
                            <i id="3" class="fa fa-question-circle-o" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="El radicado se encuentra en el documento que le llegó a su correo electrónico o fue entregado en el momento de la radicación. Ejemplo: PQRD-18-100001 o 4-2018-123456"></i>
