...
//cho "<hr> $valRadio <hr>";
    ...
    //if($tipo_radicado == 2  || $tipo_radicado == 6) {
        ...
        $commandFirmado='java -jar '.$ABSOL_PATH.'/include/jsignpdf/JSignPdf.jar '.$full_path.' -kst PKCS12 -ksf '.$P12_FILE.' -ksp '.$clave.' --font-size 7 -r \'Firmado al Radicar en CADET\' -V -llx 0 -lly 0 -urx 550 -ury 27 -d ' . $uploadDir;
