...
$ruta      = '/include';
while (!is_dir($ruta_raiz . $ruta)) {
    $ruta_raiz .= empty($ruta_raiz) ? "../" : "..";
}
...
if (!$usuaEmail && $_GET["usuaEmail"]) {
    $usuaEmail = $_GET["usuaEmail"];
}
...
$connection = "$protocolo_mail://$usuaEmail:$passwd_mail@$servidor_mail:$port_email/INBOX#novalidate-cert";
$msg  = new Mail_IMAPv2();
