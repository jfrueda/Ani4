...
if($tipo_sujeto == '1' || $tipo_sujeto == '2')
{
    $tipo_c = $tipo_sujeto == '1' ? 'Natural' : 'Natural - profesional independiente de salud (vigilado)';
    $nombre_sujeto = trim($nombre_sujeto_1.' '.$nombre_sujeto_2);
    $apellidos_sujeto = trim($apellidos_sujeto_1.' '.$apellidos_sujeto_2);
} else {
    $tipo_c = 'Jurídica '.$tipo_entidad_sujeto;
    $nombre_sujeto = trim($rs_convocante);
    $apellidos_sujeto = '';
}
...
$nombre_direccion = $nombre_sujeto;
$apellido_direccion = $apellidos_sujeto;
...
$comentario = "Sujeto procesal ".
            ...
            "\nNombre: ".$nombre_sujeto.' '.$apellidos_sujeto.
            "\nPaís: ".$pais_sujeto.
...
$asunto = 'Adjunto solicitud de conciliación: '.$tipo_documento[0].' '.$radicado;
