...
$email = $correo;
$depto = !empty($departamento_afectado) ? $departamento_afectado : '11';
$muni = !empty($ciudad_afectado) ? $ciudad_afectado : '1';
$pqrsFacebook = 0;
...
if($errorFormulario==0){
    ...
    $hist_doc_dest = $db->conn->getOne('SELECT usua_doc FROM usuario WHERE usua_codi = '.$_SESSION['usuaRecibeWeb'].' and depe_codi = '.$_SESSION["depeRadicaFormularioWeb"]);
    //Inserta historico
