...
if (!$result->success) {
    die('CAPTCHA verification failed.');  die();
}
				...
				<div class="row">
					<div class="col-sm">
                        ...
                        <?php if ($tipoSolicitud == 'Denuncia') { ?>
                            <a class="btn btn-default" href="https://pruebassuperargo.supersalud.gov.co/formularioWeb/denuncias.php">Volver</a>
                        <?php } else { ?>
                            <a class="btn btn-default" href="https://pruebassuperargo.supersalud.gov.co/formularioWeb/solicitudes.php">Volver</a>
                        <?php } ?>
					</div>
				</div>
