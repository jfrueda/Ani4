...
//temas
$sql_temas="select * from sgd_tma_temas order by sgd_tma_codigo";
...
$sql_tipo="select sgd_tpr_codigo,sgd_tpr_descrip from sgd_tpr_tpdcumento where sgd_tpr_web=1 order by sgd_tpr_codigo";
