...
qq.FineUploaderBasic = function (o) {
    ...
    this._options = {
        ...
        messages: {
            ...
            sizeError: "{file} es muy grande, el tamaño máximo de archivo es {sizeLimit}.",
            minSizeError: "{file} is too small, minimum file size is {minSizeLimit}.",
            emptyError: "{file} está vacio, por favor seleccoine otro archivo.",
            noFilesError: "No hay archivos para subir.",
            onLeave: "Los archivos están siendo subidos, si usted cierra estos serán cancelados."
        },
        retry: {
            enableAuto: false,
            maxAutoAttempts: 3,
...
qq.FineUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        text: {
            ...
            dragZone: 'Suelta archivos para Subir',
        ...
        fileTemplate: '<li>' +
            ...
            '<span class="qq-upload-file"><a href="#"/></span>' +
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _addToList: function (id, fileName) {
        ...
        jQuery(fileElement).html('<a href="../bodega/tmp/' + fileName + '" target="_blank">' + this._formatFileName(fileName) + '</a>');
