...
<? if ($inicaiRadicado < 3000) { ?>
    <table class="table-bordered table-striped table-condensed table-hover smart-form has-tickbox">
        <tr>
            <td>
                <small>
                    Y ESTA RELACIONADO CON EL(LOS) SIGUIENTE(S) DOCUMENTOS:
                </small>
            </td>
            <td align="center">
...
<table class="table table-striped table-bordered table-hover" border=0 width="100%">
    <tr class='titulos5'>
        <td class="titulos5">
...
?>
    ...
    <table border=0 width=92% class="table table-striped table-bordered table-hover dataTable no-footer smart-form" align="center">
        ...
        if (!$rs->EOF) {
            ...
            if ($dep == 410 or $dep == 420 or $dep == 430) {
                $dep = 401;
            }
            if ($dep == 212 || $dep == 213 || $dep == 214 || $dep == 215) {
                $dep = 211;
            }
            if ($esp > 0) {
