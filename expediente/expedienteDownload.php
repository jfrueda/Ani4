...
<body>
      ...
      <div class="row justify-content-center">
        <div class="col-12 ">
          <div class="card shadow-lg border-0">
            <div class="card-header bg-orfeo bg-gradient text-white py-3 text-center">
              <h5 class="mb-0 fw-bold">
                <i class="bi bi-cloud-arrow-down me-2"></i>Descarga de documentos de expediente
              </h5>
            </div>
            <div class="card-body p-4 bg-light">
              <div class="row g-3 mb-4">
                <div class="col-sm-6">
                  <label class="form-label small fw-bold text-muted uppercase">Usuario</label>
                  <div class="p-2 border rounded bg-white d-flex align-items-center">
                    <i class="fa fa-user-circle text-primary me-2"></i>
                    <span class="small">
                      <?= $_SESSION["usua_nomb"] ?> (<?= $_SESSION["krd"] ?>)
                    </span>
                  </div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label small fw-bold text-muted uppercase">Área</label>
                  <div class="p-2 border rounded bg-white d-flex align-items-center">
                    <i class="fa fa-building text-info me-2"></i>
                    <span class="small">
                      <?= $_SESSION["depe_nomb"] ?> (<?= $_SESSION["dependencia"] ?>)
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="mb-3">
                <label for="numExpediente" class="form-label fw-bold">Número Expediente a Descargar</label>
              ...
              <div class="mb-4">
                <label for="observa" class="form-label fw-bold">Observaciones</label>
                <textarea name="observa"
                  id="observa"
                  class="form-control"
                  rows="4"
                  placeholder="Motivo de la descarga o notas adicionales..."></textarea>
              </div>
            </div>
            <div class="card-footer bg-white border-top-0 py-3 text-center">
              <input type="submit" name="Enviar" class="btn btn-success btn-lg px-5 fw-bold shadow-sm rounded-pill" />
            </div>
          </div>
        </div>
      </div>
  ...
  ?>
    ...
    <table class="table table-bordered table-hover">
      <tr>
        <th>Documento</th>
        <th>Numero de Documento / Radicado </th>
  ...
  ?>
  <div class="m-2 d-flex margin-botton-table">
    <a href="expedienteDownloadPrint.php" target="expediente<?= $numExpediente ?>" class="btn btn-outline-dark shadow-sm d-flex align-items-center fw-bold">
      <i class="fa fa-print me-3 text-primary"></i>
      Hoja detalle impresión
    </a>
  </div>
</body>
