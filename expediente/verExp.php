...
d.depe_estado=1 AND d.depe_codi = '" . $dataExp['DEPE_CODI'] . "' order by depe_codi";
$rsD3 = $db->conn->Execute($queryDep3);
$optionDepResp = $rsD3->GetMenu2("dependenciaResp", $dependenciaExp, ":Seleccionar", false, "", "id='dependenciaResp' class='custom-select required text-uppercase' onchange='usuario5()'");

$permisos = $expClass->permisos($exp, $_SESSION['dependencia'], $_SESSION['codusuario'], $dataExp['USUA_DOC_RESPONSABLE']);
$expediente_vacio = $expClass->validarExpedienteVacio($exp);
//print_r($permisos);
$tpdocselect = '';
...
switch ($dataExp['SGD_SEXP_ESTADO']) {
    case 0:
        ...
        $mostrar = 'ok';
        $estadoTXT = 'Abierto';
        $btncerrar = "<button class='btn btn-sm btn-danger float-right' style='margin-left:5px; min-width:33px;' data-toggle='modal' data-toggle2='tooltip' data-target='#ModalCierreExp' data-placement='bottom' title='' onclick='validarEstadoRad()'  data-original-title='Cerrar Expediente'><i class='fa fa-times-circle' ></i></button>";
    ...
    <div class="card card-andje  ">
        <div class="card-header modal-header-andje  text-white <?= $stylebnaner ?> " style="background-color: #404040  ;">
            ...
            <?php if ($permisos['admExp'] == 1) { ?>
                ...
                data-original-title="Configurar"><i class="fa fa-download"></i></button>-->
                    ...
                    <button class="btn btn-sm btn-outline-warning float-right" style='margin-left:5px;' data-toggle="modal" data-target="#Modaladm" data-toggle2='tooltip' data-placement='bottom' title='Configurar'><i class="fa fa-cogs"></i></button>
            <?php }
            } ?>
            ...
            <button class="btn btn-sm btn-outline-info float-right" style="margin-left:5px; min-width:33px;" data-toggle="modal" data-target="#modalInfo" data-toggle2='tooltip' data-placement='bottom' title='Información'><i class="fa fa-info"></i></button>
        </div>
        ...
        <div class="card-body p-0">
            <div class="input-group">
                <div class="col-6 p-0 ">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-control "><span id="txt-Responsa" data-toggle="tooltip" data-placement="bottom" title="<?= $dataExp['RESPONSABLE'] ?>"><?= $dataExp['RESPONSABLE'] ?></span></div>
                        <div class="input-group-prepend">
                            <span class="input-group-text  text-uppercase font-weight-bold" style="width: 180px">Seguridad</span>
                        </div>
                        <div class="form-control ">
                            <span id="txt-seguridad" data-seg="<?= $dataExp['PERMISOS'] ?>">
                                <?php

                                switch ($dataExp['SEGURIDAD']) {
                                    case '0':
                                        echo "Pública";
                                        break;
                                    case '1':
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-control "><span id="txt-anex" data-toggle="tooltip" data-placement="bottom" title="<?= $trd ?>"><?= $trd ?></span></div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-control"><span
                                id="txt-seguridad" data-seg="<?= $dataExp['SGD_SEXP_ESTADO'] ?>"><?= $estadoTXT ?></span></div>
                    </div>
                ...
                <div class="card-header  " style="padding: 0.2rem 1.25rem 0.75rem;">
                    <?php if ($permisos['list'] == 1) { ?>
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item">
                                <a id="tab_basica" class="tab_expediente nav-link active show" data-toggle="tab" onclick="cargartabla('S');"
                                    href="#listado">Basica</a>
                            </li>
                            <li class="nav-item">
                                <a id="tab_anexos" class="tab_expediente nav-link" data-toggle="tab" onclick="cargartabla('A');" href="#listado">Anexos</a>
                            </li>
                            <li class="nav-item">
                                <a id="tab_radicado" class="tab_expediente nav-link" data-toggle="tab" onclick="cargartabla('R');" href="#listado">Radicado</a>
                            </li>
                            <li class="nav-item">
                                <a id="tab_historico" class="tab_expediente nav-link" data-toggle="tab" onclick="cargartablaHisto();"
                                    href="#Historico">Historico</a>
                            </li>
                            <li class="nav-item">
                                <a id="tab_excluidos" class="tab_expediente nav-link " data-toggle="tab" onclick="cargartabla('E');" href="#listado">Excluidos</a>
                            </li>
                            <li class="">
                            </li>
                            <?php if ($permisos['segAdm'] == 1 && $mostrar == 'ok') { ?>
                                <li class="nav-item">
                                    <a id="tab_seguridad" class="tab_expediente nav-link" data-toggle="tab" onclick="SeguridadList();" href="#Seguridad">Permisos</a>
                                </li>
                            <?php } ?>
                            <li class="nav-item">
                                <?php if (($dataExp['SGD_SEXP_ESTADO'] != '1' || $dataExp['USUA_DOC_RESPONSABLE'] != $usua_doc || $dataExp['INDICE_ELECTRONICO'])): ?>
                                    <button type="button" class="btn btn-xs btn-primary" style="margin-left: 10px; margin-top:10px;" disabled>Generar indice electrónico</button>
                                <?php else: ?>
                                    <button class="btn  btn-xs btn-primary" style="margin-left: 10px; margin-top:10px;" data-toggle="modal" data-target="#modal_indice_electronico">
                                        <i class="fa fa-file-archive-o"></i> <span class="hidden-md">Generar indice electrónico</span>
                                    </button>
                                    <!--<a class="btn btn-xs btn-primary" style="margin-left: 10px; margin-top:10px;" href="exp-indice.php?exp=<?= $exp ?>"></a>-->
                                <?php endif; ?>
                            </li>
                            <li>
                                <a class="btn btn-xs btn-primary" style="margin-left: 10px; margin-top:10px;" href="exp-indice-xml.php?exp=<?= $exp ?>"><i class="fa fa-file-o" aria-hidden="true"></i> xml</a>
                            </li>
                            <?php if ($dataExp['INDICE_ELECTRONICO']): ?>
                                <li>
                            ...
                            <li class="nav-item">
                                <?php if (intval($dataExp['SGD_SEXP_ESTADO']) != 0 && $dataExp['SGD_SEXP_ESTADO'] != null): ?>
                                    <button type="button" class="btn btn-xs btn-primary" style="margin-left: 10px; margin-top:10px;" disabled>Incluir en otro expediente</button>
                                <?php else: ?>
                                    <button class="btn  btn-xs btn-primary" style="margin-left: 10px; margin-top:10px;" data-toggle="modal" data-target="#cambioExpediente" id="btn-cambioExpediente">
                                        <i class="fa fa-file-archive-o"></i> <span class="hidden-md">Incluir en otro expediente</span>
                                    </button>
                                    <?php if (($_SESSION['ADM_EXP'] >= 1 && $_SESSION['usua_doc'] == $dataExp['USUA_DOC_RESPONSABLE']) || ($_SESSION['RESTAURAR_SEGURIDAD_EXPEDIENTE'] >= 1)): ?>
                                        <button class="btn  btn-xs btn-primary" style="margin-left: 10px; margin-top:10px;" data-toggle="modal" data-target="#restaurarSeguridad" id="btn-restaurarSeguridad">
                                            <i class="fa fa-file-archive-o"></i> <span class="hidden-md">Restaurar nivel de seguridad y permisos</span>
                                        </button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </li>
            ...
            <div class="card-body p-0">
                <div class="card-body " style="padding: 0px">
                    <div class="tab-content">
                        ...
                        <div id="listado" class="container tab-pane active" style="padding: 0px ;   max-width: 100%;">
                            ...
                            <table class="table table-striped table-responsive-sm table-sm " id="tb_listaexp" data-page="1" name="tb_listaexp" style="width: 100%; margin-top: 10px;" data-search="">
                        ...
                        <div id="Seguridad" class="container tab-pane fade" style="padding: 0px ;   max-width: 100%;">
                            <img src="../imagenes/loadingAnimation.gif" id="imageproceso" name="imageproceso"
                                style="display:none">
                            <div class="row">
                                <div class="input-group col-12" style="display: block">
                                    <div class="input-group float-right ">
                                        <div class="input-group-prepend">
                ...
                <!-- Información -->
                <div class="modal" id="modalInfo" data-expediente="<?php echo $exp; ?>" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Detalles del expediente <?php echo $exp; ?></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <table class="table table-bordered table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Anexos:</td>
                                            <td id="anexos_expediente"></td>
                                        </tr>
                                        <tr>
                                            <td>Radicados:</td>
                                            <td id="radicados_expediente"></td>
                                        </tr>
                                        <tr>
                                            <td>Borradores:</td>
                                            <td id="borradores_expediente"></td>
                                        </tr>
                                        <tr class="table-secondary">
                                            <td><strong>Total</strong></td>
                                            <td id="total_objetos"></td>
                                        </tr>
                                        <tr>
                                            <td>Tamaño anexos:</td>
                                            <td id="anexos_expediente_peso"></td>
                                        </tr>
                                        <tr>
                                            <td>Tamaño radicados:</td>
                                            <td id="radicados_expediente_peso"></td>
                                        </tr>
                                        <tr>
                                            <td>Tamaño borradores:</td>
                                            <td id="borradores_expediente_peso"></td>
                                        </tr>
                                        <tr class="table-secondary">
                                            <td><strong>Total</strong></td>
                                            <td id="total_peso"></td>
                    ...
                    <div class="modal-content modal-lg" style='    max-width: 90%;  max-height: 90%;margin: 0px auto;'>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    <select class='custom-select' id='tpDocAnex' name="tpDocAnex">
                                        <option value=0>No definido</option><?php echo $tpdocselect ?>
                                    </select>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                        ...
                        <div class="modal-footer">
                            <!--<button type="button" class="btn btn-sm btn-outline-warning" onclick="addAnexExp();" ><i class="fa fa-save"></i> Anexar</button>-->
                            <button id="boton_cargar_anexos_expediente" class="btn  btn-xs btn-warning float-right" onclick="uploadAnexos()"><i class="fa fa-floppy"></i> <span>Guardar</span></button>
            ...
            ?>
            <!-- Modal -->
            <div id="modal_indice_electronico" class="modal fade " role="dialog" style="padding-right: 17px; ">
                <div class="modal-dialog">
                    <!-- Modal content-->
                    <div class="modal-content ">
                        <div class="modal-header">
                            Generar indice electrónico expediente <?= $exp ?>
                        </div>
                        <div class="modal-body">
                            <p>
                                Al generar y firmar el índice electrónico usted confirma que los documentos que se encuentran en este expediente son correctos.<br>
                                ¿Quiere generar y firmar el índice electrónico?
                            </p>
                        </div>
                        <div class="modal-footer">
                    ...
                    <div class="modal-content modal-lg" style='    max-width: 90%;  max-height: 90%;margin: 0px auto;'>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group " id="tipoFisico">
                                ...
                                <select id="operFisicoMas" class="custom-select" name="operFisicoMas">
                                    <option value="VIRTUAL">VIRTUAL</option>
                                    <option value="FISICO">FISICO</option>
                                </select>
                            </div>
                            ...
                            <div class="input-group " id="tipoincexp">
                                ...
                                <div class="input-group-append">
                                    <button class="btn  btn-sm btn-outline-warning"><i class="fa fa-save"></i></button>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="cambioExpediente" tabindex="-1" role="dialog" aria-labelledby="cambioExpedienteLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="cambioExpedienteLabel">Incluir radicados en otro expediente</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="expediente" id="expediente_destino" class="form-control" placeholder="Ingrese el número de expediente destino">
                                    <div id="expediente_destino_estado">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="min-height:400px; max-height: 400px; overflow-y: scroll;">
                                    <p id="radicados_seleccionados">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" id="incluir" disabled>Incluir</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="restaurarSeguridad" tabindex="-1" role="dialog" aria-labelledby="restaurarSeguridadLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="restaurarSeguridadLabel">Restaurar nivel de seguridad</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="expediente">Expediente <?= $exp ?></label>
                                    <input type="hidden" name="restaurarSeguridad_expediente" id="restaurarSeguridad_expediente" value='<?= $exp ?>'>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12" style="">
                                    <select name="restaurarSeguridad_seguridad" id="restaurarSeguridad_seguridad" class='custom-select required text-uppercase'>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                            <button type="button" class="btn btn-primary" id="restaurar_seguridad">Restaurar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <script type="text/javascript" src="../js/JsApp/exp.js?v=<?= date('Ymd') ?>"></script>
            <script type="text/javascript" src="../js/JsApp/plugin_cambio_expediente_radicados.js?"></script>
            <script type="text/javascript" src="../js/JsApp/plugin_cambio_seguridad_expediente.js?"></script>
            <script>
                <?php if ($permisos['list'] == 1) { ?>
