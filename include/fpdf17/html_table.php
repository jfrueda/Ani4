...
function WriteHTML($html)
{
	...
	$html=str_replace("Ã³",'ó',$html); //replace carriage returns by spaces
	$html=str_replace("Ã­",'í',$html); //replace carriage returns by spaces
	$html=str_replace("Ã¡",'á',$html); //replace carriage returns by spaces
	$html=str_replace("Ã©",'é',$html); //replace carriage returns by spaces
	$html=str_replace("Ãº",'ú',$html); //replace carriage returns by spaces
	$html=str_replace("Ã±",'ñ',$html); //replace carriage returns by spaces
	$html=str_replace("Ã?",'Ñ',$html); //replace carriage returns by spaces
