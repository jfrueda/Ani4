...
try {
    ...
    foreach($emails as $key => $emailDestino) {
        // if($emailDestino) $mail->AddAddress(trim($emailDestino.".scmail.co"));
        if($emailDestino) $mail->AddAddress(trim($emailDestino.".rpost.biz"));
    ...
    $mail->Subject = "$entidad: $asuntoMail $radicadosSelText";
