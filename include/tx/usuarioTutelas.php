...
class Usuario {
    ...
    $prev_dir['MUNI_CODI'] = (['muni_tmp'] == 0 ? 0 : ['muni_tmp']);
    $prev_dir['DPTO_CODI'] = (['muni_tmp'] == 0 ? 0 : ['DPTO_CODI']);
...
/*
	...
	if(sizeof($record)<=3){
        ...
        $insertSQL = $this->db->insert("SGD_DIR_DRECCIONES",$record);
        ...
        foreach ($this->result as $k => $result){
            ...
            $html .= ' <td colspan="2">
                            <label name="inp_'.$idtx.'_nomb" class="input">
                                ' . $auxLabelNombre .'
                                <input type="text" data-rel="solo-text" id="id_nombre_'.$incremental.'" name="'.$idtx.'_nombre" onpaste="limitPaste(this)" maxlength="149" value="'.$result["NOMBRE"].'">
                            </label>
                        </td>';
            ...
            $html .= '<td colspan="2">
                            ...
                            ' . $auxLabelApellido .'
                                <input type="text" data-rel="solo-text" id="id_apellido_'.$incremental.'" name="'.$idtx.'_apellido" onpaste="limitPaste(this)" maxlength="49" value="'.$result["APELLIDO"].'">
                            </label>
                        </td>';
            $html .= '</tr>';
            ...
            $html .= '<tr><td></td>';
                ...
                $html .= '<td>
                    <label name="inp_'.$idtx.'_tel" class="input">
                        Telefono
                        <input type="text" id="id_telefono_'.$incremental.'" name="'.$idtx.'_telefono" onpaste="limitPaste(this)" maxlength="49" value="'.$result["TELEF"].'">
                    </label>
                </td>';
                $html .= '<td>
