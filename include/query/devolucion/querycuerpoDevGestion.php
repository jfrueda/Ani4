<?
	...
	//
	default:
                 $sqlConcat = $db->conn->Concat("a.radi_nume_salida","'-'","a.sgd_dir_tipo","'+'","e.id");	
		$isql = 'select 
				...
				,dir.sgd_dir_nomremdes||'."'/'".'||dir.sgd_dir_nombre||'."'<br>'".'||dir.sgd_dir_direccion ||'."'<br>'".'||dir.sgd_dir_mail AS DESCRIPCION
		...
		where   c.sgd_trad_codigo = 1 and e.id_anexo = a.id AND e.estado IN (1, 2) AND a.ANEX_ESTADO>=2 '.
				$dependencia_busq2 .'
