  ...
  {	switch ($tmp_arr_id)
		{	case 0:
				{	$isql = 'select
							...
							,cast(RADI_NUME_RADI as varchar(20)) "CHK_CHKANULAR"
							from
								radicado b
		 					where
			...
			case 1:
				{	$radi_nume_radi = "cast(i.RADI_NUME_RADI as varchar(20))";
			...
			case 1:
				{	$radi_nume_radi = "to_char(i.RADI_NUME_RADI)";
					...
					$isql = 'select
								...
								,b.RADI_FECH_RADI	 as "HOR_RAD_FECH_RADI"
								,'.$sqlFecha.'		 as "DAT_Fecha Radicado"
								,cast(b.RADI_NUME_RADI as varchar(20)) as "HID_Numero Radicado"
								,i.info_codi		 as "HID_InfoCodi"
								,i.info_desc 		 as "Descripcion"
