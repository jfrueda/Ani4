...
/**
  ...
  */
#echo "->".$_SESSION['radicadosparaimprimir'];
switch($db->driver)
{
	case 'mssql':
		$isql = 'select 
 ...
 if ($_SESSION['radicadosparaimprimir']!=""){
$isql = $isql. "  AND a.radi_nume_salida IN ".$_SESSION['radicadosparaimprimir'];
unset ($_SESSION['radicadosparaimprimir']);} 

		$isql = $isql." ". $dependencia_busq2 .
				$where_tipRadi . 
				$where_fecha . '
				and a.radi_nume_salida=c.radi_nume_radi
				and a.anex_creador=b.usua_login
