...
switch($db->driver)
{
    ...
    default:
        ...
        if($busqRadicados!=''){
            $busqRadicados=str_replace(",","','",$busqRadicados);   
            $isql = "$isql ( cast(a.radi_nume_salida as text) in ('$busqRadicados') or  cast(a.anex_radi_nume as text) in ('$busqRadicados')  ) and";
            }
$orderTipo="asc";
$order=" 4,12,1";     
