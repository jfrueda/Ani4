<?
	...
	default:
		...
		$isql = "SELECT 
		 	...
		 	FROM ANEXOS a 
			 	JOIN sgd_rad_envios r ON r.id_anexo = a.id  
				JOIN RADICADO b ON a.radi_nume_salida=b.radi_nume_radi
				JOIN sgd_dir_drecciones dir ON dir.radi_nume_radi=a.anex_radi_nume and  dir.id = r.id_direccion
		 	WHERE a.radi_nume_salida=b.radi_nume_radi 
				and cast(a.RADI_NUME_SALIDA as varchar(20)) in(".$setFiltroSelect.")
				and (anex_estado=2 or anex_estado=3) and r.id in ($envio_id_list)";
		break;
	}
?>
