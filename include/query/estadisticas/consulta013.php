...
switch($db->driver)
{
	...
	$queryE = "SELECT $distinct  d.DEPE_NOMB NOMBRE_DEPENDENCIA, e.NUMERO_RADICADOS FROM 
				...
				(SELECT SE.SGD_EXP_NUMERO,substr(SE.SGD_EXP_NUMERO, 5, 3) DEPE_CODI_CREACION, COUNT(1) NUMERO_RADICADOS
...
$queryE="SELECT $agrupamiento,COUNT(1) EXPEDIENTES
      ...
      $queryEDetalle="SELECT SE.SGD_EXP_NUMERO,MINEXP.RADI_NUME_RADI,MINEXP.SGD_EXP_ESTADO,SE.SGD_SEXP_FECH,
       ...
       INNER JOIN RADICADO R ON R.RADI_NUME_RADI=MINEXP.RADI_NUME_RADI 
        ...
        INNER JOIN ( SELECT SGD_EXP_NUMERO,COUNT(1) NUME_RADICADOS FROM SGD_EXP_EXPEDIENTE {$subcons} 
