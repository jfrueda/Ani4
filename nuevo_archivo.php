        ...
        <div class="col-lg-12">
                  ...
                  <table width="100%" class="table table-bordered">
                    <tr>
                      <td id="celda_sololectura" valign="middle">
                        <input type="checkbox" class="select" name="sololect" <?php if ($sololect) {
                                                                                echo " checked ";
                                                                              }  ?> id="sololect" onClick="oculta_radicado();">
          ...
          $sel="";*/
                    ...
                    <tr>
                      ...
                      <td>
                        <div id="cierreno"> No <input type="radio" name="cierre" value="0" <?= $check_cierreno ?>></div>
                    ...
                    if ($codigo) { ?>
                      ...
                      if ($cc) {
                        if (($nombre_us1 || $prim_apel_us1 || $seg_apel_us2) &&  $direccion_us1 && $muni_us1 && $codep_us1) {
                          ...
                          if ($cc_documento_us1) {
                            $documento_us1 = $cc_documento_us1;
                            $cc = "";
                          }
                      ...
                      ?>
                        <tr>
                          <td align="center" colspan="1">
                            <small>
                              <input type="radio" name="radicado_rem" value=<?= $sgd_dir_tipo ?> id="rusuario" '<?php if ($radicado_rem == $sgd_dir_tipo) {
                                                                                                                  echo " checked ";
                                                                                                                } ?>'>
                            </small>
                          </td>
              ...
              <tr align="center">
                <td align="center" colspan="2">
                  ...
                  <p><small class="btn btn-<? if ($resp1 == "ERROR") {
                                              echo "danger";
                                            } else {
                                              echo "success";
                                            } ?>"><?= $mensaje ?></small></p>
...
<script type="text/javascript">
  $(document).ready(function() {
    $('body').on("click", '#cerraranexar', function() {
      window.opener.$.fn.cargarPagina("./lista_anexos.php", "tabs-c");
      window.close();
    });
