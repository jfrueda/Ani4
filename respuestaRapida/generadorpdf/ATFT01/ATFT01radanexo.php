      ...
      {          
          ...
          public function Header()
          {
            ...
            <tr>
                ...
                <p style="text-align:center"><strong><span style="font-size:11.0pt">AUDITOR&Iacute;AS</span></strong></p>
                </td>
                <td style="width:73.0pt">
                <p><strong><span style="font-size:10.0pt">&nbsp;C&Oacute;DIGO</span></strong></p>
                </td>
                <td style="width:66.5pt">
                <p><span style="font-size:10.0pt">&nbsp;ATFT01</span></p>
                </td>
            </tr>
            <tr>
                <td rowspan="2" style="width:216.95pt">
                <p style="text-align:center"><strong><span style="font-size:11.0pt">AUTO DE AUDITOR&Iacute;A</span></strong></p>
                </td>
                <td style="width:73.0pt">
                <p><strong><span style="font-size:10.0pt">&nbsp;VERSI&Oacute;N</span></strong></p>
                </td>
                <td style="width:66.5pt">
                <p><span style="font-size:10.0pt">&nbsp;03</span></p>
                </td>
            </tr>
            <tr>
                <td style="width:73.0pt">
                ...
                <td style="width:66.5pt">
                <p><span style="font-size:10.0pt">&nbsp;29/02/2024</span></p>
                </td>
            </tr>
        </tbody>         
            </table>';
              ...
              if($this->PageNo() == 1) {
                ...
                $this->Cell(0, 15, 'AUTO ' . $this->radicadoOrfeo ,0, false, 'C', 0, '', 0, false, 'M', 'M');
              }
