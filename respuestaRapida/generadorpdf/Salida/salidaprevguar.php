<?php
	 ...
	 include ('encabezadosalida.php');
      ...
      class MYPDF extends TCPDF {
        ...
        public function Header() {
          // Logo
          $this->Image('../bodega/sys_img/sns_header_2022.png',
                        15,
                        3,
                        180,
                        '',
    ...
    public function Footer() {
        ...
        $pagAct = trim($this->getAliasNumPage());
        $pagDe =  trim($this->getAliasNbPages());
        $this->SetTextColor(72, 72, 72); // Grey
        $this->SetFont('helvetica', 'B', 8);
        $this->Cell(0, 0, '                  Página ' . $pagAct . ' de ' . $pagDe, 0, false, 'C', 0, '', 0, false, 'T', 'M');
        $this->Ln(3);
    ...
    #$respuesta = $respuesta
     ...
     /* $style = array(
      ...
      $marginsAux = $pdf->getMargins();
	    ...
	    $pdf->writeHTML($encabezadoSalida, true, false, true, false, '');
