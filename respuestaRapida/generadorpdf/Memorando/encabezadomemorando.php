...
$encabezadoMemorando = '<div style="text-align:right">
<table align="right" border="1" cellspacing="0">
	<tbody>
		<tr>
			<td colspan="2" style="text-align:center"><span style="font-size:9px"><span style="font-family:Arial,Helvetica,sans-serif"><strong>SUPERINTENDENCIA NACIONAL DE SALUD</strong></span></span></td>
		</tr>
		<tr>
