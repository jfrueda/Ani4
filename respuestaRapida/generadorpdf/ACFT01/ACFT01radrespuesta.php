<?php
   class MYPDF extends TCPDF
      {          
          ...
          public function Header()
          {
            ...
            <tr>
                ...
                <td style="width:66.5pt">
                <p><span style="font-size:10.0pt">&nbsp;05/05/2023</span></p>
                </td>
            </tr>
        </tbody>         
            </table>';
            ...
            $this->Cell(0, 15, 'AUTO N° ' . $this->radicadoOrfeo . ' DE ' . $this->fechaOrfeo, 0, false, 'C', 0, '', 0, false, 'M', 'M');
          }
      ...
      $pdf = new MYPDF($numradNofi, $dia . '-' . $mes . '-' . $anho);
