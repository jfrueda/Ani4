  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Sistema de Gestión Documental UMNG</h5>
...
?>
    <div class="alert alert-warning" role="alert">
        <p>Uno o varios errores pudieron ocurrir en la radicación. Por favor revisar que radicado ente en formato PDF, la combinación de los campos sea el correcto y que cuente con la firma digital.</p>
    </div>
<?php
    }
?>
