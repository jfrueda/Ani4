...
<script type="text/javascript">
    function popUpBorrador(radAnterior, radNuevo, tipoRadicadp) {
        window.open('borradorPopUp.php?borrador=' + radAnterior + '&radicado=' + radNuevo + '&error=' + 0, 'Mensaje Borrador', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=750,height=460,left = 390,top = 50');
