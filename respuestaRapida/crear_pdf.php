...
if($idPlantilla == 0) {
  ...
  $archivo_grabar = __DIR__ . '/' . $archivo_grabar;
  ...
  if($idPlantilla == 100000){
    ...
    include ('./generadorpdf/ACFT01/ACFT01prevguar.php');
    ...
    include ('./generadorpdf/ATFT01/ATFT01prevguar.php');
  } elseif($idPlantilla == 100019) {
    include ('./generadorpdf/SEFT06/SEFT06prevguar.php');
  } else {
