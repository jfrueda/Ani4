            ...
            <form name="form1" id="form1"
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-4">
                        ...
                        <!--{/if}-->
                        <strong>¿Cierre automático del radicado de entrada?</strong><br> 

                        
                          <!--{if $cierrea == 0 }--> 
                            No <input type="radio" name="cierre" value="0" checked="checked">
                            Si  <input type="radio" name="cierre" value="1" disabled>
                          <!--{else}-->
                            No <input type="radio" name="cierre" value="0" disabled>
                            Si  <input type="radio" name="cierre" value="1" checked="checked">
                          <!--{/if}-->
