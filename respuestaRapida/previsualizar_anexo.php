...
$url_archivo_grabar = $archivo_grabar;

if ($write_result) {
    include './crear_pdf.php';
    echo "<html><head><style>body, html {width: 100%; height: 100%; margin: 0; padding: 0}</style></head><body><iframe src=\"$url_archivo_grabar\" style=\"height:calc(100% - 4px);width:calc(100% - 4px)\"></iframe></html></body>";    
} else {
