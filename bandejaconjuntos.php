...
if ($carpeta == 18) {
    $nomcarpeta = "Memorando múltiple destinatario";
}
...
<body>
    <div id="app">
        <Transition name="slide-fade">
            <form v-if="showForm" name="form1" id="form1" action="./tx/formEnvio.php?<?= $encabezado ?>" method="post">
                                        ...
                                        <div class="widget-body p-3">
                                            <div class="d-flex flex-wrap gap-3 align-items-center">
                                                ...
                                                <div style="min-width: 230px;">
                                                    <select id="AccionCaliope" name="AccionCaliope" class="form-select form-select-sm">
                                                        <option value="0" selected>Escoja una acción...</option>
                                                        <option value="18">Enviar ...</option>
                                                        <option value="101">Finalizar trámite ...</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table id="dt_basic" class="table table-striped table-hover align-middle">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr <?= $leido ?>>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" id="<?= $numeroRadicado ?>" onchange="clickTx();"
                                                                            name="checkValue[<?= $numeroRadicado ?>]" value="CHKANULAR" type="checkbox">
                                                                    </div>
                                                                </td>
                                                                ...
                                                                if (empty($radiPath)) {
                                                                    echo "
                                                                        <td><small class='fw-semibold'>$numeroRadicado</small></td>
                                                                    ";
                                                                } else {
                                                                    echo "
                                                                        <td>
                                                                ...
                                                                <td>
                                                                    <small>
                                                                        <a href="<?= $linkVerRadicado ?>" target="mainFrame"><?= $fechaRadicado ?></a>
                                                                    </small>
                                                                </td>
