...
<body onLoad='document.getElementById("cajarad").focus();' class="waitMe_body" style="margin-bottom: 30px;">
    ...
    ?>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <select class="form-select" name="s_desde_mes"><? for ($i = 1; $i <= 12; $i++) echo "<option " . ($i == $flds_desde_mes ? 'selected' : '') . ">$i</option>"; ?></select>
                                        <select class="form-select" name="s_desde_ano"><? for ($i = 2020; $i <= date('Y'); $i++) echo "<option " . ($i == $flds_desde_ano ? 'selected' : '') . ">$i</option>"; ?></select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <select class="form-select" name="s_hasta_mes"><? for ($i = 1; $i <= 12; $i++) echo "<option " . ($i == $flds_hasta_mes ? 'selected' : '') . ">$i</option>"; ?></select>
                                        <select class="form-select" name="s_hasta_ano"><? for ($i = 2020; $i <= date('Y'); $i++) echo "<option " . ($i == $flds_hasta_ano ? 'selected' : '') . ">$i</option>"; ?></select>
                                    </div>
                                </div>
        ...
        <div class="alert alert-warning" role="alert" id="dvWarning" style="display: none">
        </div>
    <?php
    ...
    function Ciudadano_show($nivelus, $tpRemDes, $whereFlds)
    {
        ...
        //-------------------------------
    ?>
        <div class="col-sm-12" id="dvResultados">
            <!-- row -->
            <div class="row">
                <!-- NEW WIDGET START -->
                <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <!-- Widget ID (each widget will need unique ID)-->
                    <div style="width: 100%; overflow-x: scroll;" class="jarviswidget " id="wid-id-1" data-widget-editbutton="false">
                        <!-- widget content -->
                        <header class="bg-orfeo text-white ">
                            <h2 class="pl-2"> <?= $sFormTitle ?></h2>
                        </header>
                        <div style="width: 100%; overflow-x: scroll;" class="widget-body">
                            <table class="table table-bordered table-striped table-compact table-hover table-sm" id='tb-resp'>
                                <thead>
                                    <tr>
                                        <th class=""></th>
                                        <?
                                        ...
                                        if ($indiVinculo != 2) { ?>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=1&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"> <i class="fa fa-sort float-right"></i>
                                                </a> Radicado
                                            </th>
                                            <th class="">
                                            ...
                                            <th class="">
                                                <a class="vinculos"
                                                    href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=2&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i>
                                                </a> Fecha Radicación
                                            </th>
                                            <th class="">
                                        ...
                                        <? } else { ?>
                                            ...
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=1&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"> <i class="fa fa-sort float-right"></i></a>Radicado vinculado al expediente
                                            </th>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=2&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Fecha Radicacion
                                            </th>
                                        <? } ?>
                                        <th class="">
                                            <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=3&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Asunto
                                        </th>
                                        <th class="">
                                            <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=4 &FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Referencia
                                        </th>
                                        <th class="">
                                            <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=4&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Tipo de Documento
                                        </th>
                                        <? if ($esNotificacionCircular) { ?>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=1&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Destinatarios
                                            </th>
                                        <? } else { ?>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=6&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Direccion
                                                contacto
                                            </th>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=7&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Telefono
                                                contacto
                                            </th>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=8&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Mail
                                                Contacto
                                            </th>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=23&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Dignatario
                                            </th>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=9&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Nombre
                                            </th>
                                            <th class="">
                                                <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=14&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Documento
                                            </th>
                                        <? } ?>
                                        <th class="">
                                            <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=15&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Usuario Actual
                                        </th>
                                        <th class="">
                                        ...
                                        <th class="">
                                            <a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=21&FormCIUDADANO_Sorted=<?= $form_sorting ?>&"><i class="fa fa-sort float-right"></i></a>Dias Restante
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    if ($ps_entrada != "9999") {
                                        ...
                                        if ($ps_entrada == "9998") {
                                            $sWhere = $sWhere . "((r.radi_nume_radi::text like " . tosql(
                                                "%4",
                                                "Text"
                                            ) . " or r.radi_nume_radi::text like " . tosql(
                                                "%5",
                                                "Text"
                                            ) . " or r.radi_nume_radi::text like " . tosql(
                                                "%6",
                                                ...
                                                "%7",
                                                "Text"
                                            ) . ") and r.radi_depe_radi != 900 and r.is_borrador is false)";
                                        } else {
                                    ...
                                    if (strlen($ps_RADI_NOMB) && !$esNotificacionCircular) //&& $ps_solo_nomb == "Any")
                                    {
                                        ...
                                        $sWhere .= " or " . $db->conn->Concat("r.RADI_DATO_002") . " iLIKE '%" . $ps_RADI_NOMB . "%' ";
                                        $sWhere .= " or " . $db->conn->Concat("r.RADI_CUENTAI") . " iLIKE '%" . $ps_RADI_NOMB . "%' ";
    ...
    <?php
        ...
        while ((!$rs->EOF && $rs) && $iCounter < $iRecordsPerPage) {
            ...
            //En caso que no se quieran mostrar los borradores eliminados se activa el siguiente codigo
            ...
            */
            ...
            /****************************************************************************************************************************/
            $arrdepend = [93003, 92000, 92001, 92002, 92003, 92004, 92005, 92006];
            $usuaCodi = $rs->fields['RADI_USUA_ACTU'];
            $radi_depe_actu = $rs->fields['RADI_DEPE_ACTU'];
            $sqlFiltHist = "SELECT DEPE_CODI_DEST, HIST_DOC_DEST, DEPE_CODI, USUA_DOC FROM hist_eventos he WHERE radi_nume_radi IN ($fldRADI_NUME_RADI) AND sgd_ttr_codigo not in (110)";
            $rsHist = $db->conn->execute($sqlFiltHist);
            ...
            foreach ($rsHist as $value) {
                ...
                $rsParentDepDest = $db->conn->Execute($sqlParentDep, [$value['DEPE_CODI_DEST']]);

                if ($rsParentDepDest && $rsParentDepDest->fields['DEPE_CODI_TERRITORIAL']) {
                    $arrFitDep[] = $rsParentDepDest->fields['DEPE_CODI_TERRITORIAL'];
                }
            }
            ...
            if ($valImg == "SI" && $noPermisoFlag == 1) {
                ...
                $linkInfGeneral = "<a class='btn btn-primary btn-xs' href='../verradicado.php?verrad=$fldRADI_NUME_RADI&nomcarpeta=Busquedas&depe_actu=$radi_depe_actu&usuacodi=$usuaCodi'>";
                $verImg = true;
            } else {
                ...
                if ($tieneAsignacion == true) {
                    ...
                    $linkInfGeneral = "<a class='btn btn-outline-warning btn-xs' href='../verradicado.php?verrad=$fldRADI_NUME_RADI&nomcarpeta=Busquedas&depe_actu=$radi_depe_actu&usuacodi=$usuaCodi title='Tiene activo permiso de visualizar radicado'>";
                    $verImg = true;
                } elseif ($radicadoFilter->isDependenciaInFilter($fldRADI_NUME_RADI, $dependencia)) {
                    // Usar la clase RadicadoFilter para verificar la dependencia
                    $linkInfGeneral = "<a class='btn btn-outline-success btn-xs' href='../verradicado.php?verrad=$fldRADI_NUME_RADI&nomcarpeta=Busquedas&depe_actu=$radi_depe_actu&usuacodi=$usuaCodi' title='Tiene activo permiso de visualizar radicado'>";
                    $verImg = true;
                } else {
                    $linkDocto = "<a class='btn btn-danger btn-xs' href='javascript:noPermiso()' > ";
                    $linkInfGeneral = "<a class='btn btn-danger btn-xs' href='javascript:noPermiso()' > ";
    ...
    ?>
        ...
        <? if (strlen($fldRADI_PATH)) { ?>
            ...
            <td class="leidos">
                <?= tohtml($fldRADI_BORRADOR_RADI) ?>
            </td>
            <td class="leidos">
                <?= tohtml($fldRADI_FECH_RADI) ?>
            </td>
            <td class="leidos">
                <?= $fldsSGD_EXP_SUBEXPEDIENTE ?>&nbsp; <?= $imgExp ?>
            </td>
            <td class="leidos">
                <? if ($noPermisoFlag == 1) { ?>
                    <?= $fldASUNTO ?> &nbsp;
...
<script>
    $(document).ready(function() {
        ...
        var checkExist = setInterval(function() {
            ...
            if (!waitMeContainer.length) {
                $('.busqueda').removeAttr('disabled').prop('disabled', false);
            }
        }, 100);
