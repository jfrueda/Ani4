...
?>
  <table class="FormTABLE">
    <form action="<?= $sFileName ?>" method="POST">
      ...
      <tr>
        <td class="FormHeaderTD" colspan="2">
      ...
      <? if ($sForm1Err) { ?>
        <tr>
          <td colspan="2" class="DataTD">
            <font class="DataFONT"><?= $sForm1Err ?></font>
          </td>
        </tr>
      <? } ?>
      ...
      ?>
        <tr>
          <td class="FieldCaptionTD">
            <font class="FieldCaptionFONT">Identificaci&oacute;n</font>
          </td>
          <td class="DataTD"><input type="text" name="Login" value="<?= tohtml(get_param("Login")) ?>" maxlength="50"></td>
        </tr>
        <tr>
          <td class="FieldCaptionTD">
            <font class="FieldCaptionFONT">Palabra Clave</font>
          </td>
          <td class="DataTD"><input type="password" name="Password" maxlength="50"></td>
        </tr>
        <tr>
          <td colspan="2">
            <input type="hidden" name="FormAction" value="login">
            <input type="submit" value="Conexi�n">
          </td>
        </tr>
      <?
      } else {
      ...
      ?>
        <tr>
          <td class="DataTD">
            <font class="DataFONT"> <?= $db->f("USUA_LOGIN") ?></font>
            <input type="hidden" name="FormAction" value="logout">
            <input type="submit" value="Desconexi�n">
          </td>
        </tr>
      <?
      }
      ?>
      <input type="hidden" name="ret_page" value="<?= $ret_page ?>"><input type="hidden" name="querystring" value="<?= $querystring ?>"></td>
      </tr>
    </form>
  </table>
<?
