    ...
    <tr>
      ...
      <td valign="top">
        <font class="FieldCaptionFONT">
          <a href="busquedaHist.php?<?= session_name() . "=" . session_id() . "&fechah=$fechah&krd=$krd" ?>">Busqueda por historico</a><br>
          <a href="busquedaUsuActu.php?<?= session_name() . "=" . session_id() . "&fechah=$fechah&krd=$krd" ?>">Reporte por Usuarios</a><br>
          <a href="../busqueda/busquedaExp.php?<?= $phpsession ?>&krd=<?= $krd ?>&<? echo "&fechah=$fechah&primera=1&ent=2"; ?>">Busqueda Expediente</a>
        </font>
      </td>
    </tr>
  </table>
...
function Search_show()
{
  ...
  if (
    strlen($flds_desde_dia) && strlen($flds_hasta_dia) &&
...
?>
  <form method="post" action="<?= $sActionFileName ?>?<?= session_name() . "=" . session_id() ?>&dependencia=<?= $dependencia ?>&krd=<?= $krd ?>" name="Search">
    ...
    <table class="FormTABLE">
      <tr>
        <td class="FormHeaderTD" colspan="13"><a name="Search">
            <font class="FormHeaderFONT"><?= $sFormTitle ?></font>
          </a></td>
      </tr>
      <tr>
              ...
              <td>
                <font class="FieldCaptionFONT">
                  <INPUT type="checkbox" NAME="s_empresaESP" value="ESP"
                    <? if ($flds_empresaESP == "ESP" || (!strlen($flds_ciudadano) && !strlen($flds_empresaESP) && !strlen($flds_oEmpresa) && !strlen($flds_FUNCIONARIO))) {
                      echo "CHECKED";
                    } ?>>Buscar en Empresas ESP
                </font>
              </td>
              <td>
                <font class="FieldCaptionFONT">
                  <INPUT type="checkbox" NAME="s_oEmpresa" value="OEM"
                    <? if ($flds_oEmpresa == "OEM" || (!strlen($flds_ciudadano) && !strlen($flds_empresaESP) && !strlen($flds_oEmpresa) && !strlen($flds_FUNCIONARIO))) {
                      echo "CHECKED";
                    } ?>>Buscar en otras empresas
                </font>
              </td>
              <td>
                <font class="FieldCaptionFONT">
                  <INPUT type="checkbox" NAME="s_FUNCIONARIO" value="FUN"
                    <? if ($flds_FUNCIONARIO == "FUN" || (!strlen($flds_ciudadano) && !strlen($flds_empresaESP) && !strlen($flds_oEmpresa) && !strlen($flds_FUNCIONARIO))) {
                      echo "CHECKED";
      ...
      <tr>
        <td class="FieldCaptionTD">
          <font class="FieldCaptionFONT">Buscar en Radicados de
          </font>
        </td>
        <td class="DataTD">
          <select class="DataFONT" name="s_entrada">
            <?
      ...
      <tr>
        <td class="FieldCaptionTD">
          <font class="FieldCaptionFONT">Desde Fecha (dd/mm/yyyy)</font>
        </td>
      ...
      <tr>
        <td class="FieldCaptionTD">
          <font class="FieldCaptionFONT">Hasta Fecha (dd/mm/yyyy)</font>
        </td>
      ...
      <tr>
        <td class="FieldCaptionTD">
          <font class="FieldCaptionFONT">Tipo de Documento</font>
        </td>
      ...
      <tr>
        <td class="FieldCaptionTD">
          <font class="FieldCaptionFONT">Dependencia Actual</font>
        </td>
      ...
      <tr>
        <td align="right" colspan="3"><input class="DataFONT" type="button" value="Limpiar" onclick="limpiar();"><input class="DataFONT" type="submit" value="Busqueda"></td>
      </tr>
    </table>
  </form>
...
// Display Grid Form
//-------------------------------
function Ciudadano_show($nivelus)
{
  //-------------------------------
  ...
  if (!$iSort) {
    ...
    if ($iSort == 23) $sOrder = " order by dir.sgd_dir_nombre" . $sDirection;
  }
...
?>
  ...
  <table width="2000" class="FormTABLE">
    <tr>
      <td class="FormHeaderTD" colspan="20"><a name="RADICADO">
          <font class="FormHeaderFONT"><?= $sFormTitle ?></font>
        </a></td>
    </tr>
    <tr>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=1&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Radicado</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=2&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Fecha Radicacion</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=3&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Asunto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=4&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tipo de Documento</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=5&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Numero de Hojas</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=6&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Direcci�n contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=7&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tel�ono contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=8&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Mail Contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=23&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dignatario</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=9&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Nombre Ciudadano</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=10&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Apellido 1</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=11&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Apellido 2</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=12&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Telefono Ciudadano</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=13&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Direccion Ciudadano</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=14&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Cedula Ciudadano</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=15&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=16&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dependencia Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=17&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Anterior</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=22&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Firmante</font>
        </a></td>
      ...
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=20&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Pais</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=21&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dias Restantes</font>
        </a></td>
    </tr>
    <?
    ...
    if ($ps_entrada != "9999") {
      ...
      $HasParam = true;
      $sWhere = $sWhere . "(r.radi_nume_radi like " . tosql("%" . $ps_entrada, "Text") . ")";
    }
    ...
    if (strlen($ps_RADI_NOMB) && $ps_solo_nomb == "All") {
      ...
      while ($tok) {
        ...
        $sWhere .= "UPPER(r.ra_asun||dir.sgd_dir_nombre||dir.sgd_dir_nombre||r.radi_cuentai) LIKE '%" . $tok . "%' ";
        $tok = strtok(" ");
        $yaentro = true;
      }
      $sWhere .= "))";
    ...
    ?>
      <tr>
        <td colspan="20" class="DataTD">
          <font class="DataFONT">No hay resultados</font>
        </td>
      </tr>
      <?
...
<?
  ...
  while ($next_record  && $iCounter < $iRecordsPerPage) {
    ...
    $fldDIGNATARIO = $db->f("SGD_DIR_NOMBRE");
    ...
    <td class="DataTD">
      <font class="DataFONT">
        <? if (strlen($fldRADI_PATH)) {
          $iii = $iii + 1; ?> <a href='../bodega<?= $fldRADI_PATH ?>' target='Imagen<?= $iii ?>'><? } ?>
          <font class="DataFONT"><?= $fldRADI_NUME_RADI ?></font>
          <? if (strlen($fldRADI_PATH)) { ?>
          </a><? } ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT"><a href="../verradicado.php?verrad=<?= $fldRADI_NUME_RADI . "&" . session_name() . "=" . session_id() . "&krd=$krd&carpeta=8&nomcarpeta=Busquedas&tipo_carp=0" ?>">
          <?= tohtml($fldRADI_FECH_RADI) ?>&nbsp;</a></font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldASUNTO) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldTIPO_DOC) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldNUME_HOJAS) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldDIRECCION_C) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldTELEFONO_C) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldMAIL_C) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldDIGNATARIO) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldNOMBRE) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldAPELLIDO1) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldAPELLIDO2) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldTELEFONO) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldDIRECCION) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldCEDULA) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldUSUA_ACTU) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldDEPE_ACTU) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldUSUA_ANTE) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldFirmante) ?>&nbsp;</font>
    </td>
    ...
    <font class="ColumnFONT">
      ...
      ?>
        ...
        ?>
          ...
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormCIUDADANO_Page=last#RADICADO">
            <font class="ColumnFONT">Ultimo</font>
          </a>
      <?
        }
...
function EmpresaESP_show($nivelus)
{
  ...
  if (!$iSort) {
    ...
    if ($iSort == 9) {
      $sOrder = " order by bod.NOMBRE_DE_LA_EMPRESA" . $sDirection;
    }
    if ($iSort == 10) {
      $sOrder = " order by bod.NOMBRE_REP_LEGAL" . $sDirection;
    }
    if ($iSort == 11) {
      $sOrder = " order by bod.NIT_DE_LA_EMPRESA" . $sDirection;
    }
    if ($iSort == 12) {
      $sOrder = " order by bod.SIGLA_DE_LA_EMPRESA" . $sDirection;
    }
    if ($iSort == 13) {
      $sOrder = " order by bod.DIRECCION" . $sDirection;
    }
    if ($iSort == 14) {
      $sOrder = " order by bod.TELEFONO_1" . $sDirection;
    }
    if ($iSort == 15) {
...
?>
  <table width="2000" class="FormTABLE">
    ...
    <tr>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=1&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Radicado</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=2&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Fecha Radicacion</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=3&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Asunto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=4&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tipo de Documento</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=5&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Numero de Hojas</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=6&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Direccion contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=7&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tel�ono contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=8&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Mail Contacto</font>
        </a></td>
      <!-- INICIO CAMPOS QUE CAMBIAN -->
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=9&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Nombre de la Empresa</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=10&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Representante Legal</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=11&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">NIT</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=12&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Sigla</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=13&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Direccion Empresa</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=14&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Telefono</font>
        </a></td>
      <!-- FIN CAMPOS QUE CAMBIAN -->
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=15&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=16&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dependencia Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=17&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Anterior</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=22&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Firmante</font>
      ...
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=20&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Pais</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormEMPRESAESP_Sorting=21&FormEMPRESAESP_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dias Restantes</font>
        </a></td>
    </tr>
    <?
...
*/
    ...
    if (strlen($ps_RADI_NOMB) && $ps_solo_nomb == "All") {
      ...
      while ($tok) {
        ...
        $sWhere .= "UPPER(b.nombre_de_la_empresa||b.nombre_rep_legal||b.nit_de_la_empresa||b.sigla_de_la_empresa||b.direccion||b.telefono_1) LIKE '%" . $tok . "%' ";
        $tok = strtok(" ");
        $yaentro = true;
      }
      $sWhere .= ")";
    ...
    $sSQL = "SELECT r.radi_nume_radi, r.radi_fech_radi, r.ra_asun,r.radi_pais, r.radi_nume_hoja, 
            ...
            u1.usua_login AS login_actu, u1.usua_nomb AS nomb_actu, d1.depe_nomb AS depe_actu,
            dir.sgd_dir_direccion, dir.sgd_dir_telefono, dir.sgd_dir_mail,dir.sgd_dir_nombre,
            bod.nombre_de_la_empresa,bod.nombre_rep_legal,bod.nit_de_la_empresa,bod.sigla_de_la_empresa,bod.direccion,bod.telefono_1
            FROM sgd_dir_drecciones dir, radicado r, sgd_tpr_tpdcumento td, usuario u1, dependencia d1,
            bodega_empresas bod
            WHERE dir.SGD_DIR_TIPO = 1 
            AND dir.radi_nume_radi=r.radi_nume_radi 
...
?>
  <tr>
    ...
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldNOMBRE_EMPRESA) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldREP_LEGAL) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldNIT_EMPRESA) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldSIGLA_EMPRESA) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldDIRECCION) ?>&nbsp;</font>
  ...
  <td colspan="20" class="ColumnTD">
    <font class="ColumnFONT">
      ...
      ?>
        ...
        <? } else {
        ?>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormEMPRESAESP_Page=1#RADICADO">
            <font class="ColumnFONT">Primero</font>
          </a>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormEMPRESAESP_Page=<?= $iPage - 1 ?>#RADICADO">
            <font class="ColumnFONT">Anterior</font>
          </a>
        <?
        }
        ...
        ?>
          ...
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormEMPRESAESP_Page=last#RADICADO">
            <font class="ColumnFONT">Ultimo</font>
          </a>
      <?
        }
...
function OtrasEmpresas_show($nivelus)
{
  ...
  $krd = get_param("krd");
  $form_params = trim(session_name()) . "=" . trim(session_id()) . "&krd=$krd&s_RADI_DEPE_ACTU=" . tourl(get_param("s_RADI_DEPE_ACTU")) . "&s_RADI_NOMB=" . tourl(get_param("s_RADI_NOMB")) . "&s_RADI_NUME_RADI=" . tourl(get_param("s_RADI_NUME_RADI")) . "&s_TDOC_CODI=" . tourl(get_param("s_TDOC_CODI")) . "&s_desde_dia=" . tourl(get_param("s_desde_dia")) . "&s_desde_mes=" . tourl(get_param("s_desde_mes")) . "&s_desde_ano=" . tourl(get_param("s_desde_ano")) . "&s_hasta_dia=" . tourl(get_param("s_hasta_dia")) . "&s_hasta_mes=" . tourl(get_param("s_hasta_mes")) . "&s_hasta_ano=" . tourl(get_param("s_hasta_ano")) . "&s_solo_nomb=" . tourl(get_param("s_solo_nomb")) . "&s_ciudadano=" . tourl(get_param("s_ciudadano")) . "&s_empresaESP=" . tourl(get_param("s_empresaESP")) . "&s_oEmpresa=" . tourl(get_param("s_oEmpresa")) . "&s_oEmpresa=" . tourl(get_param("s_oEmpresa")) . "&s_entrada=" . tourl(get_param("s_entrada")) . "&s_salida=" . tourl(get_param("s_salida")) . "&";
  if (!$iSort) {
    $form_sorting = "";
  } else {
    if ($iSort == $iSorted) {
...
?>
  <table width="2000" class="FormTABLE">
    ...
    <tr>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=1&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Radicado</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=2&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Fecha Radicacion</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=3&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Asunto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=4&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tipo de Documento</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=5&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Numero de Hojas</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=6&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Direccion contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=7&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tel�ono contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=8&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Mail Contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=9&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Nombre de la Empresa</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=10&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Representante Legal</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=11&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">NIT</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=12&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Sigla</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=13&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Direccion Empresa</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=14&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Telefono</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=15&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=16&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dependencia Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=17&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Anterior</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=22&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Firmante</font>
      ...
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=20&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Pais</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormOEMPRESAS_Sorting=21&FormOEMPRESAS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dias Restantes</font>
        </a></td>
    </tr>
    <?
  ...
  <td colspan="20" class="ColumnTD">
    <font class="ColumnFONT">
      ...
      ?>
        ...
        <? } else {
        ?>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormOEMPRESAS_Page=1#RADICADO">
            <font class="ColumnFONT">Primero</font>
          </a>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormOEMPRESAS_Page=<?= $iPage - 1 ?>#RADICADO">
            <font class="ColumnFONT">Anterior</font>
          </a>
        <?
        }
        ...
        ?>
          ...
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormOEMPRESAS_Page=last#RADICADO">
            <font class="ColumnFONT">Ultimo</font>
          </a>
      <?
        }
...
function FUNCIONARIO_show($nivelus)
{
  ...
  $sOrder = "";
  $sSQL = "";
  $sFormTitle = "Radicados encontrados por Funcionarios";
  $HasParam = false;
  $iRecordsPerPage = 25;
  $iCounter = 0;
  $iPage = 0;
  ...
  //-------------------------------
  $sOrder = " order by R.RADI_NUME_RADI ";
  $iSort = get_param("FormFUNCIONARIO_Sorting");
  $iSorted = get_param("FormFUNCIONARIO_Sorted");
  $krd = get_param("krd");
  $form_params = trim(session_name()) . "=" . trim(session_id()) . "&krd=$krd&s_RADI_DEPE_ACTU=" . tourl(get_param("s_RADI_DEPE_ACTU")) . "&s_RADI_NOMB=" . tourl(get_param("s_RADI_NOMB")) . "&s_RADI_NUME_RADI=" . tourl(get_param("s_RADI_NUME_RADI")) . "&s_TDOC_CODI=" . tourl(get_param("s_TDOC_CODI")) . "&s_desde_dia=" . tourl(get_param("s_desde_dia")) . "&s_desde_mes=" . tourl(get_param("s_desde_mes")) . "&s_desde_ano=" . tourl(get_param("s_desde_ano")) . "&s_hasta_dia=" . tourl(get_param("s_hasta_dia")) . "&s_hasta_mes=" . tourl(get_param("s_hasta_mes")) . "&s_hasta_ano=" . tourl(get_param("s_hasta_ano")) . "&s_solo_nomb=" . tourl(get_param("s_solo_nomb")) . "&s_ciudadano=" . tourl(get_param("s_ciudadano")) . "&s_empresaESP=" . tourl(get_param("s_empresaESP")) . "&s_oEmpresa=" . tourl(get_param("s_oEmpresa")) . "&s_FUNCIONARIO=" . tourl(get_param("s_oEmpresa")) . "&s_FUNCIONARIO=" . tourl(get_param("s_FUNCIONARIO")) . "&s_entrada=" . tourl(get_param("s_entrada")) . "&";
  if (!$iSort) {
    $form_sorting = "";
  } else {
    if ($iSort == $iSorted) {
      $form_sorting = "";
      $sDirection = " DESC ";
      $sSortParams = "FormFUNCIONARIO_Sorting=" . $iSort . "&FormFUNCIONARIO_Sorted=" . $iSort . "&";
    } else {
      $form_sorting = $iSort;
      $sDirection = "  ";
      $sSortParams = "FormFUNCIONARIO_Sorting=" . $iSort . "&FormFUNCIONARIO_Sorted=" . "&";
    }
    if ($iSort == 1) {
      $sOrder = " order by r.radi_nume_radi" . $sDirection;
    }
    ...
    if ($iSort == 9) {
      $sOrder = " order by o.usua_nomb" . $sDirection;
    }
    if ($iSort == 10) {
      $sOrder = " order by o.usua_email" . $sDirection;
    }
    if ($iSort == 11) {
      $sOrder = " order by o.usua_doc" . $sDirection;
    }
    if ($iSort == 12) {
      $sOrder = " order by o.usua_login" . $sDirection;
    }
    if ($iSort == 13) {
      $sOrder = " order by o.usua_piso" . $sDirection;
    }
    if ($iSort == 14) {
      $sOrder = " order by o.usu_telefono1" . $sDirection;
    }
    if ($iSort == 15) {
      $sOrder = " order by u1.usua_nomb" . $sDirection;
    }
...
?>
  <table width="2000" class="FormTABLE">
    ...
    <tr>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=1&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Radicado</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=2&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Fecha Radicacion</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=3&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Asunto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=4&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tipo de Documento</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=5&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Numero de Hojas</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=6&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Direccion contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=7&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Telefono contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=8&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Mail Contacto</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=9&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Nombre</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=10&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Email Interno</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=11&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Documento</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=12&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Login Interno</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=13&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Email Funcionario</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=14&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Telefono</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=15&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=16&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dependencia Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=17&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Anterior</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=22&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Firmante</font>
        </a></td>
      <!--td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=18&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&"><font class="ColumnFONT">Municipio</font></a></td>
	   <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=19&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&"><font class="ColumnFONT">Departamento</font></a></td-->
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=20&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Pais</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormFUNCIONARIO_Sorting=21&FormFUNCIONARIO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dias Restantes</font>
        </a></td>
    </tr>
    <?
    ...
    */
    ...
    if (strlen($ps_RADI_NOMB) && $ps_solo_nomb == "All") {
      ...
      $HasParam = true;
      $sWhere .= "dir.sgd_doc_fun IN (SELECT usua_doc FROM USUARIO d WHERE ";
      ...
      while ($tok) {
        ...
        $sWhere .= "UPPER(d.usua_nomb||d.usua_doc) LIKE '%" . $tok . "%' ";
        $tok = strtok(" ");
        $yaentro = true;
      }
      $sWhere .= ")";
    ...
    if (strlen($ps_RADI_NOMB) && $ps_solo_nomb == "Any") {
      ...
      $HasParam = true;
      $sWhere .= "dir.sgd_oem_codigo IN (SELECT sgd_oem_codigo FROM sgd_oem_FUNCIONARIO d WHERE ";
...
<?
  ...
  // Process page scroller
  //-------------------------------
  $iPage = get_param("FormFUNCIONARIO_Page");
  ...
  while ($next_record  && $iCounter < $iRecordsPerPage) {
    ...
    $fldTELEFONO_C = $db->f("SGD_DIR_TELEFONO");
    $fldMAIL_C = $db->f("SGD_DIR_MAIL");
    $fldNOMBRE_EMPRESA = $db->f("USUA_NOMB");
    $fldREP_LEGAL = $db->f("USUA_EMAIL");
    $fldNIT_EMPRESA = $db->f("USUA_DOC");
    $fldSIGLA_EMPRESA = $db->f("USUA_LOGIN");
    $fldDIRECCION = $db->f("USUA_PISO");
    $fldTELEFONO = $db->f("USU_TELEFONO1");
    $fldUSUA_ACTU = $db->f("NOMB_ACTU") . " - (" . $db->f("LOGIN_ACTU") . ")";
    $fldDEPE_ACTU = $db->f("DEPE_ACTU");
    $fldUSUA_ANTE = $db->f("RADI_USU_ANTE");
    //    $fldMUNI_NOMB = $db->f("MUNI_NOMB");
  ...
  <td colspan="20" class="ColumnTD">
    <font class="ColumnFONT">
      ...
      if ($bEof || $iPage != 1) {
        ...
        for ($iPageCount = $iPageCount + 1; $iPageCount <= $iPage - 1; $iPageCount++) {
          $sPages .=  "<a href=" . $sFileName . "?" . $form_params . $sSortParams . "FormFUNCIONARIO_Page=" . $iPageCount . "#RADICADO\"><font " . "class=\"ColumnFONT\"" . ">" . $iPageCount . "</font></a>&nbsp;";
          $iDisplayPages++;
        }
      ...
      ?>
        ...
        <? } else {
        ?>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormFUNCIONARIO_Page=1#RADICADO">
            <font class="ColumnFONT">Primero</font>
          </a>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormFUNCIONARIO_Page=<?= $iPage - 1 ?>#RADICADO">
            <font class="ColumnFONT">Anterior</font>
          </a>
        <?
        }
        ...
        ?>
          ...
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormFUNCIONARIO_Page=last#RADICADO">
            <font class="ColumnFONT">Ultimo</font>
          </a>
      <?
        }
