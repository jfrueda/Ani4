...
<?php Search_show() ?>
   ...
   <td valign="top"><font class="FieldCaptionFONT">
...
?>
  ...
  <tr>
   <td valign="top">
<? if($flds_empresaESP=="ESP") EmpresaESP_show($nivelus); ?>

   </td>
  </tr>
  <tr>
   <td valign="top">
<? if($flds_oEmpresa=="OEM") OtrasEmpresas_show($nivelus); ?>

   </td>
  </tr>
  <tr>
   <td valign="top">
<? if($flds_FUNCIONARIO=="FUN") FUNCIONARIO_show($nivelus); ?>
   </td>
  </tr>
...
<tr>
  ...
  <td><font class="FieldCaptionFONT">
	...
	<?if($flds_FUNCIONARIO=="FUN" || (!strlen($flds_ciudadano)&&!strlen($flds_empresaESP)&&!strlen($flds_oEmpresa)&&!strlen($flds_FUNCIONARIO)))
	  { echo ("CHECKED");} ?>>Buscar en Funcionarios</font></td>	  
  </tr></table></td>
...
?>
     ...
     <table width="2000" class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=2&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicacion</font></a></td>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=6&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Direcci�n contacto</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=7&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Tel�ono contacto</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=8&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Mail Contacto</font></a></td>
			 <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=23&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Dignatario</font></a></td>
...
?>
     <table width="2000" class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormEMPRESAESP_Sorting=2&FormEMPRESAESP_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicacion</font></a></td>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormEMPRESAESP_Sorting=7&FormEMPRESAESP_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Tel�ono contacto</font></a></td>
...
?>
     <table width="2000" class="FormTABLE">
      ...
      <tr>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormOEMPRESAS_Sorting=2&FormOEMPRESAS_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicacion</font></a></td>
       ...
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormOEMPRESAS_Sorting=7&FormOEMPRESAS_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Tel�ono contacto</font></a></td>
...
//-------------------------------
  ...
  else
  {
    ...
    if ($iSort == 7) $sOrder = " order by dir.sgd_dir_telefono" . $sDirection;
	if ($iSort == 8) $sOrder = " order by dir.sgd_dir_mail" . $sDirection;
	if ($iSort == 9) $sOrder = " order by o.usua_nomb" . $sDirection;
	if ($iSort == 10) $sOrder = " order by o.usua_email" . $sDirection;
	if ($iSort == 11) $sOrder = " order by o.usua_doc" . $sDirection;
	if ($iSort == 12) $sOrder = " order by o.usua_login" . $sDirection;
    if ($iSort == 13) $sOrder = " order by o.usua_piso" . $sDirection;
    if ($iSort == 14) $sOrder = " order by o.usu_telefono1" . $sDirection;
    if ($iSort == 15) $sOrder = " order by u1.usua_nomb" . $sDirection; 
    if ($iSort == 16) $sOrder = " order by d1.depe_nomb" . $sDirection;
    if ($iSort == 17) $sOrder = " order by r.radi_usu_ante" . $sDirection;
//    if ($iSort == 18) $sOrder = " order by muni.muni_nomb" . $sDirection;
...
?>
     <table width="2000" class="FormTABLE">
      ...
      <tr>
	   <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=1&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Radicado</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=2&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Fecha Radicacion</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=3&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Asunto</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=4&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Tipo de Documento</font></a></td>	   
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=5&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Numero de Hojas</font></a></td>	   
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=6&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Direccion contacto</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=7&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Telefono contacto</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=8&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Mail Contacto</font></a></td>
	   <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=9&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Nombre</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=10&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Email Interno</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=11&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Documento</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=12&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Login Interno</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=13&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Email Funcionario</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=14&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Telefono</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=15&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Usuario Actual</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=16&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Dependencia Actual</font></a></td>
       <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=17&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Usuario Anterior</font></a></td>
	   <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormCIUDADANO_Sorting=22&FormCIUDADANO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Firmante</font></a></td>
	   ...
	   <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=20&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Pais</font></a></td>
  	   <td class="ColumnTD"><a href="<?=$sFileName?>?<?=$form_params?>FormFUNCIONARIO_Sorting=21&FormFUNCIONARIO_Sorted=<?=$form_sorting?>&"><font class="ColumnFONT">Dias Restantes</font></a></td>
      </tr>
<?
...
?>
        <a href="<?=$sFileName?>?<?=$form_params?><?=$sSortParams?>FormFUNCIONARIO_Page=1#RADICADO"><font class="ColumnFONT">Primero</font></a>
        <a href="<?=$sFileName?>?<?=$form_params?><?=$sSortParams?>FormFUNCIONARIO_Page=<?=$iPage - 1?>#RADICADO"><font class="ColumnFONT">Anterior</font></a>
<?
    }
    echo "&nbsp;[&nbsp;" . $sPages . "]&nbsp;";
...
?>
        <a href="<?=$sFileName?>?<?=$form_params?><?=$sSortParams?>FormFUNCIONARIO_Page=<?=$iPage + 1?>#RADICADO"><font class="ColumnFONT">Siguiente</font></a>
        <a href="<?=$sFileName?>?<?=$form_params?><?=$sSortParams?>FormFUNCIONARIO_Page=last#RADICADO"><font class="ColumnFONT">Ultimo</font></a>
<?
    }
  }
