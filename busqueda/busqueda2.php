...
<body class="PageBODY">
  ...
  <table>
    <tr>
      ...
      <td valign="top">
        <font class="FieldCaptionFONT"><a href="busquedaHist.php?<?= session_name() . "=" . session_id() . "&fechah=$fechah&krd=$krd" ?>">B&uacute;squeda por hist&oacute;rico</a><br><a href="busquedaUsuActu.php?<?= session_name() . "=" . session_id() . "&fechah=$fechah&krd=$krd" ?>">Reporte por Usuarios</a></font>
      </td>
    </tr>
  </table>
  <table>
    <tr>
      <td valign="top">
        <? if (
          $flds_ciudadano == "CIU" ||
          (!strlen($flds_ciudadano) && !strlen($flds_empresaESP) && !strlen($flds_oEmpresa))
        ) Ciudadano_show(); ?>
      </td>
    </tr>
    <tr>
...
?>
  <form method="post" action="<?= $sActionFileName ?>?<?= session_name() . "=" . session_id() ?>&dependencia=<?= $dependencia ?>&krd=<?= $krd ?>" name="Search">
    ...
    <table class="FormTABLE">
      ...
      <tr>
        <td align="right" colspan="3"><input class="DataFONT" type="submit" value="B�squeda"></td>
      </tr>
    </table>
  </form>
<?
  ...
  <table width="2000" class="FormTABLE">
    ...
    <tr>
      ...
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=2&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Fecha Radicaci&oacute;n</font>
        </a></td>
      ...
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=7&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tel&eacute;fono contacto</font>
        </a></td>
    ...
    /* Se recibe la dependencia actual para b�squeda */
    ...
    /* Se recibe el n�mero del radicado para b�squeda */
    ...
    /* Se recibe el tipo de documento para la b�squeda */
  ...
  <td colspan="20" class="ColumnTD">
    <font class="ColumnFONT">
      ...
      if ($bEof || $iPage != 1) {
        ...
        $sPages = "";
        $iDisplayPages = 0;
        $iNumberOfPages = 30; /* El n�mero de p�ginas que aparecer�n en el navegador al pie de la p�gina */
