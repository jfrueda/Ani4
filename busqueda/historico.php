...
?>
  ...
  <table class="FormTABLE">
    <tr>
      <td class="FormHeaderTD" colspan="5"><a name="HIST_EVENTOS">
    ...
    ?>
    <tr>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormHIST_EVENTOS_Sorting=1&FormHIST_EVENTOS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Radicado</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormHIST_EVENTOS_Sorting=2&FormHIST_EVENTOS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Fecha</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormHIST_EVENTOS_Sorting=3&FormHIST_EVENTOS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Codigo Usuario</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormHIST_EVENTOS_Sorting=4&FormHIST_EVENTOS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Dependencia</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormHIST_EVENTOS_Sorting=5&FormHIST_EVENTOS_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Observaciones</font>
        </a></td>
    </tr>
    <?
    ...
    ?>
      <tr>
        <td colspan="5" class="DataTD">
          <font class="DataFONT">No hay Registros</font>
        </td>
      </tr>
  </table>
<?
  ...
  <td colspan="5" class="ColumnTD">
    <font class="ColumnFONT">
      ...
      ?>
        ...
        <? } else {
        ?>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormHIST_EVENTOS_Page=<?= $iPage - 1 ?>#HIST_EVENTOS">
            <font class="ColumnFONT">Anterior</font>
          </a>
        <?
        }
