...
<body class="PageBODY">
  ...
  ?>
    <form method="GET" action="<?= $sActionFileName ?>" name="Search">
      ...
      <table class="FormTABLE" width="722">
        <tr>
          <td class="FormHeaderTD" colspan="7"><a name="Search">
              <font class="FormHeaderFONT"><?= $sFormTitle ?>Busqueda</font>
            </a></td>
        </tr>
        <tr>
          <td class="FieldCaptionTD" width="154" align="right" height="25">
        ...
        <tr>
          <td class="FieldCaptionTD" width="154" align="right" height="25">
            <font class="FieldCaptionFONT">FECHA</font>
          </td>
          <td class="DataTD" width="594" height="25">
        ...
        <tr>
          <td class="FieldCaptionTD" width="154" align="right" height="25">
            <font class="FieldCaptionFONT">HORA
              INICIO</font>
          </td>
          <td class="DataTD" width="594" height="25">
  ...
  ?>
    ...
    <table class="FormTABLE" width="715">
      <tr>
        <td class="FormHeaderTD" colspan="5"><a name="RADICADO">
            <font class="FormHeaderFONT"><?= $sFormTitle ?></font>
          </a></td>
      </tr>

      <tr align="center">
        <td class="ColumnTD" height="25" width="85"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=1&FormRADICADO_Sorted=<?= $form_sorting ?>&">
            <font class="ColumnFONT">Radicado</font>
          </a></td>

        <td class="ColumnTD" height="25" width="331"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=2&FormRADICADO_Sorted=<?= $form_sorting ?>&">
            <font class="ColumnFONT">Asunto</font>
          </a></td>

        <td class="ColumnTD" width="110" height="25"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=3&FormRADICADO_Sorted=<?= $form_sorting ?>&">
            <font class="ColumnFONT">Fecha
              Radicaci&oacute;n</font>
          </a></td>

        <td class="ColumnTD" height="25" width="23"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=4&FormRADICADO_Sorted=<?= $form_sorting ?>&">
            <font class="ColumnFONT"># H</font>
          </a>oj</td>

        <td width="142" height="25" class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=5&FormRADICADO_Sorted=<?= $form_sorting ?>&">
            <font class="ColumnFONT">Anexos</font>
          </a></td>
      </tr>
      <?
      ...
      $sSQLCount = "Select count(1) as Total from radicado R " . $sWhere;
      $db->query($sSQLCount);
      ...
      ?>
        <tr>
          ...
          <td colspan="5" class="DataTD" height="25">
            <font class="DataFONT">No records</font>
          </td>
        </tr>
    </table>
  <?
  ...
  <tr>
    <td colspan="5" class="DataTD">
      <font class="DataFONT"><b>Total Registros: <?= $fldTotal ?></b></font>
    </td>
  </tr>
