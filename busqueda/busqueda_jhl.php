...
<body class="PageBODY">
  ...
  <table>
    <tr>
      ...
      <td valign="top">
        <font class="FieldCaptionFONT"><a href="busquedaHist.php?<?= session_name() . "=" . session_id() . "&fechah=$fechah" ?>">B�squeda por hist�rico</a><br><a href="busquedaUsuActu.php?<?= session_name() . "=" . session_id() . "&fechah=$fechah" ?>">Reporte por Usuarios</a></font>
      </td>
    </tr>
  </table>
  <table>
...
?>
  <form method="POST" action="<?= $sActionFileName ?>?<?= session_name() . "=" . session_id() ?>&dependencia=<?= $dependencia ?>" name="Search">
    ...
    <table class="FormTABLE">
      ...
      <tr>
        <td class="FieldCaptionTD">
          <font class="FieldCaptionFONT">Texto
            <INPUT type="radio" NAME="s_solo_nomb" value="Texto" <?php if ($flds_solo_nomb == "Texto") {
                                                                    echo "CHECKED";
                                                                  } ?>>
            Solo Nombre
            <INPUT type="radio" NAME="s_solo_nomb" value="Nombre" <?php if ($flds_solo_nomb == "Nombre") {
                                                                    echo "CHECKED";
                                                                  } ?>>
          </font>
        </td>
...
?>
  <table width="1500" class="FormTABLE">
    <tr>
      <td class="FormHeaderTD" colspan="10"><a name="RADICADO">
          <font class="FormHeaderFONT"><?= $sFormTitle ?></font>
        </a></td>
    </tr>
    <tr>
      <td class="ColumnTD">
        <font class="ColumnFONT">#</font>
      </td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=1&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Radicado</font>
        </a></td>
      <td width="55" class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=2&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Fecha Radicaci&oacute;n</font>
        </a></td>
      <td width="360" class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=3&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">ESP</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=6&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Nombre</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=6&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Identificacion</font>
        </a></td>
      <td width="150" class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=7&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Tipo Documento</font>
        </a></td>
      <td width="150" class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=4&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Usuario Actual</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=5&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Imagen</font>
        </a></td>
      <td width="100" class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=8&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Departamento</font>
        </a></td>
      <td width="100" class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=10&FormRADICADO_Sorted=<?= $form_sorting ?>&">
          <font class="ColumnFONT">Municipio</font>
        </a></td>
      <td class="ColumnTD"><a href="<?= $sFileName ?>?<?= $form_params ?>FormRADICADO_Sorting=9&FormRADICADO_Sorted=<?= $form_sorting ?>&">
    ...
    */
    // Contador
    /*$sSQLCount = "Select count(1) as Total from radicado R, USUARIO U, departamento D,TIPO_DOCUMENTO B, MUNICIPIO M  " . $sWhere;
    */
    $sSQLCount1 = "select 
	   			count(1) as TOTAL
				from radicado a,sgd_tpr_tpdcumento b,
...
?>
  <tr>
    <td class="DataTD">
      <font class="DataFONT"><?= ($iCounter + 1) + (($iPage - 1) * ($iRecordsPerPage)) ?>
    </td>
    <td class="DataTD">
      <font class="DataFONT"> <a href="<?= $fldRADI_NUME_RADI_URLLink ?>?s_RADI_NUME_RADI=<?= $fldRADI_NUME_RADI_s_RADI_NUME_RADI ?>&">
          <font class="DataFONT"><?= $fldRADI_NUME_RADI ?></font>
        </a>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldRADI_FECH_RADI) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldRADI_NOMB) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldRADI_USUA_NOMBRE) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldRADI_NUME_IDEN) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldRADI_TDOC_DESC) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?= tohtml($fldRADI_USUA_ACTU) ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?php echo $fldRADI_PATH; ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?PHP echo tohtml($fldDPTO_NOMB); ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?PHP echo tohtml($fldMUNI_NOMB); ?>&nbsp;</font>
    </td>
    <td class="DataTD">
      <font class="DataFONT">
        <?PHP if ($fldRADI_DEPE_ACTU != 999) {
  ...
  <td colspan="10" class="ColumnTD">
    <font class="ColumnFONT">
      ...
      ?>
        ...
        <? } else {
        ?>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormRADICADO_Page=1#RADICADO">
            <font class="ColumnFONT">Primero</font>
          </a>
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormRADICADO_Page=<?= $iPage - 1 ?>#RADICADO">
            <font class="ColumnFONT">Anterior</font>
          </a>
        <?
        }
        ...
        ?>
          ...
          <a href="<?= $sFileName ?>?<?= $form_params ?><?= $sSortParams ?>FormRADICADO_Page=last#RADICADO">
            <font class="ColumnFONT">Ultimo</font>
          </a>
      <?
        }
