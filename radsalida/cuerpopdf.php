...
<tr bgcolor="#cccccc" class="textoOpcion"> <?
   ...
   while(!$rs->EOF)
	...
	if($codigo_dev==99){$img_estado = "<img src=../imagenes/docDevuelto_tiempo.gif  border=0 alt='Fecha Devolucion :$fecha_dev' title='Fecha Devolucion :$fecha_dev'>";}
		$dep_radicado = substr($rs->fields["ANEX_RADI_NUME"],4,$digitosDependencia);
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" class="t_bordeGris">
  <tr align="center" bgcolor="#E6E6E6">
    <td height="60" ><font color="#FF0000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><span class="textoComentario">Nota. 
      Los valores que se muestran en el cálculo del "Tiempo Restante", con el 
      objeto de mantenernos informados para contestar dentro del término cada 
      uno de los documentos, están basados en días calendario y según tipo de 
      documento. Estos tiempos fueron establecidos por la Oficina de Planeación 
      (Ext.. 2169) a la cual hay que recurrir en caso de requerirse alguna modificación. 
      Podrá observar la relación correspondiente en el archivo</span><font color="#000033"> 
