...
?> 
<table width="100%" border=0 cellpadding=0 cellspacing=5 class='table table-bordered table-hover dataTable no-footer smart-form'> 
<tr>
    <td width='35%' >
    ...
    <td width='35%' >
     ...
     <form name='form1' action='<?=$pagina_sig?>?<?=session_name()."=".session_id()."&krd=$krd&fechah=$fechah&dep_sel=$dep_sel&estado_sal=$estado_sal&estado_sal_max=$estado_sal_max" ?>' method=post>
        <TABLE width="100%" class="table table-bordered table-hover dataTable" >
          ...
          <tr> 
            <td class="grisCCCCCC"> 
              <table border=0 width="100%" border=0 cellpadding=0 cellspacing=5 class='table table-bordered table-hover dataTable no-footer smart-form'>
