...
if ($generar_listado) {
  ...
  while (!$rsSipos->EOF) {
    ...
    $data[] = array(
      'NOMBRE DESTINATARIO' => $rsSipos->fields["SGD_RENV_NOMBRE"],
      'DIRECCION' => $rsSipos->fields['SGD_RENV_DIR'],
      'CIUDAD' => strtoupper($rsSipos->fields['SGD_RENV_MPIO']) . "-" . strtoupper($rsSipos->fields['SGD_RENV_DEPTO']),
      'Referencia' => $rsSipos->fields["RADI_NUME_SAL"],
      'PESO' => $rsSipos->fields['SGD_RENV_PESO']
    );
