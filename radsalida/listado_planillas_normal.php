<?
session_start();
if (!$no_planilla or intval($no_planilla) == 0) die ("<table width='100%'><tr><td ><center>Debe colocar un Numero de Planilla valido</center></td></tr></table>");
if($generar_listado)
{
	error_reporting(7);
	$ruta_raiz = "..";
...
<center><b>Se han Generado <?=$total_registros?> Registros en <?=$paginas?> Planillas. <br>
<!-- <a href='<?=$arpdf_tmp?>' target='<?=date("dmYh").time("his")?>'>Abrir Archivo</a></b></center> -->
</td>
</TR>
</TABLE>
</body>
