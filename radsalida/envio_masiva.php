...
include_once "$ruta_raiz/class_control/GrupoMasiva.php"; require_once("$ruta_raiz/include/combos.php");
...
<tr class=listado2>
	<td height="26" align="center" width="26%"> 
        ...
        <td height="26" align="center" width="35%"> 
          <select name=empresa_envio id=empresa_envio class=select  onChange="myFunction(this.value);" onClick=" if (this.value!='null'&& envio_peso.value.length>1) calcular_precio('empresa_envio','envio_peso','valor_gr');" >
...
<tbody> 
    ...
    <td class="#cccccc" width="29%">No. De Planilla - <?=$numplan?></td>
		<td class="#cccccc" width="71%"><input value="<?=$ultplan?>" id="planilla" name="planilla" type="text" class='tex_area'></td>
	</tr>
</tbody> 
</table>
<p align="center"> 
