...
$nregisEntidad = 500;
if(!$no_planilla or intval($no_planilla) == 0) die ("<table width='100%'><tr><td ><center>Debe colocar un Numero de Planilla v&aacute;lido</center></td></tr></table>");
if($generar_listado)
{
   	error_reporting(7);
	$ruta_raiz = "..";
...
Se han Generado <b><?=$total_registros?> </b>Registros en <?=$paginas?> Planillas. <br>
<?
