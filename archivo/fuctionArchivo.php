...
if ($_GET['action'] == 'muni') {
?>
	<select class='select' id="mun" name="codMuni2" onchange="edi()">
...
?>
	<select class='select' id="exp_edificio2" name="exp_edificio2" onchange="piso('piso')">
		<option>-- Seleccione --</option>
		<?
...
if ($_GET['action'] == 'piso') {
?>
	<select class='select' id="Piso" name="exp_piso2" onchange="wait('wait','Piso',1)">
		<option>-- Seleccione --</option>
		<?
	...
	?>
		...
		?>
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td width="25%" class='titulos2'><? echo $nombre[1]; ?></td>
					<td width="25%" class='titulos2'>
						<select class='select' id="<? echo $nombre[1]; ?>" name="<? echo $nombre[1]; ?>" onchange="wait('<? echo $nombre[1]; ?>Div','<? echo $nombre[1]; ?>','2',<? echo $_GET['con'] + 1; ?>)">
							<option>-- Seleccione --</option>
							<?
							echo      $nombre[0];
							?>
		...
		?> <table cellpadding="0" cellspacing="0" width="100%">
				<TR>
					<TD class='titulos2' width="50%"><? echo $nombre[1]; ?></TD>
					<TD width="50%">
						<select id="<? echo $nombre[1]; ?>" name="<? echo $nombre[1]; ?>" class='select' onchange="wait('waitDiv<? echo $_GET['con']; ?>','<? echo $nombre[1]; ?>',1,<? echo $_GET['con'] + 1; ?>)">
							<option>-- Seleccione --</option>
							<?
							echo      $nombre[0];
							?>
