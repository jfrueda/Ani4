...
function pintarEstadistica($fila, $indice, $numColumna)
{
	...
	switch ($numColumna) {
		...
		case 2:
			...
			$datosEnvioDetalle = "krd=" . $_GET['krd'] . "&amp;tipoReporte=1&amp;genDetalle=1&amp;usua_doc=" . urlencode($fila['HID_USUA_DOC']) . "&amp;dependencia_busq=" . $_POST['dep_sel'] . "&amp;fechaIni=" . $_POST['fechaIni'] . "&amp;fechaInif=" . $_POST['fechaInif'] . "&amp;tipoRadicado=" . $_POST['tipoRadicado'] . "&amp;tipoDocumento=" . $_POST['tipoDocumento'] . "&amp;codUs=" . $fila['HID_COD_USUARIO'] . "&amp;arch=" . $_POST['arch'];
