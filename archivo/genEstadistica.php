...
if ($tipoRadicado && ($tipoEstadistica == 1 or $tipoEstadistica == 6)) {
	$whereTipoRadicado = " AND r.RADI_NUME_RADI LIKE '%$tipoRadicado'";
}

if ($codus) {
	$whereTipoRadicado .= " AND b.USUA_CODI = $codus ";
} elseif (!$codus && $usua_perm_estadistica < 1) {
	$whereTipoRadicado .= " AND b.USUA_CODI = $codusuario ";
}
if ($tipoDocumento && ($tipoDocumento != '9999' && $tipoDocumento != '9998' && $tipoDocumento != '9997')) {
