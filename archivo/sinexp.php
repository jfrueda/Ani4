...
/** Modificado Supersolidaria 14-Dic-2006
  * Mantiene la serie seleccionada para la búsqueda.
  */
if( $_POST['codserie'] != "" )
{
...
/** Modificado Supersolidaria 14-Dic-2006
  * Mantiene la subserie seleccionada para la búsqueda.
  */
if( $_POST['tsub'] != "" )
{
...
/** Modificado Supersolidaria 14-Dic-2006
  * Mantiene el tipo documental seleccionado para la búsqueda.
  */
if( $_POST['tdoc'] != "" )
{
    $tdocSel = $_POST['tdoc'];
...
/** Modificado Supersolidaria 14-Dic-2006
  * Mantiene el tipo de radicado seleccionado para la búsqueda.
  */
if( $_POST['trad'] != "" )
{
    $tradSel = $_POST['trad'];
...
<table border=0 width="70%" class="table table-striped table-bordered table-hover dataTable no-footer smart-form">
<tr>
...
<td class='titulos5'>
     ...
     * Se incluyó el filtro de Tipo Documental.
     */
    -->
    <tr>
...
<?php
/* Modificado Supersolidaria 29-Nov-2006
 * El rango inicial de fechas se estableció en 1 mes.
 */
// Fecha inicial
...
/* Modificado Supersolidaria 29-Nov-2006
 * Modificación a la consulta de radicados sin expediente.
 */
