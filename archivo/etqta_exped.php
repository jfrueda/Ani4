...
<body bgcolor="#FFFFFF">
	...
	<form action="etqta_exped.php?<?= $params ?>" method="post" enctype="multipart/form-data" name="TipoDocu" id="TipoDocu">
		...
		<TABLE class="titulos4" align="center" width="75%">
			<tr align="left">
				<td width="33%" class="borde_tab" height="25" align="left">
					<input type="radio" name=par value="1" <? if ($par1) {
																echo "checked";
															} else {
																echo "";
															} ?>>ESP
				...
				<td width="33%" class="borde_tab" height="25" align="left">
					<input type="radio" name=par value="2" <? if ($par2) {
																echo "checked";
															} else {
																echo "";
															} ?>>Otras Empr/Asunto
				...
				<td width="33%" class="borde_tab" height="25" align="left">
					<input type="radio" name=par value="3" <? if ($par3) {
																echo "checked";
															} else {
																echo "";
															} ?>>Dependencia
				...
				<td width="33%" class="borde_tab" height="25" align="left">
					<input type="radio" name=par value="4" <? if ($par4) {
																echo "checked";
															} else {
																echo "";
															} ?>>Func/Contratista
		...
		<TABLE class="titulos4" align="center" width="75%">
			...
			<td width="33%" class="borde_tab" height="25" align="center">
				<input type="button" name="Button" value="MODIFICAR POR.." class="botones_largo" onClick="Start('buscarParametro_etqta.php?krd=<?= $krd ?>',1024,420);">
			</td>
			</td>
			<tr>
		...
		<table border=0 width=75% align="center" class="borde_tab">
			<tr align="center">
				<td width="33%" height="25" class="listado2" align="center">
					<center><input name="Limpiar" type="submit" class="botones" id="envia22" value="Limpiar"></center>
				</TD>
				<td width="33%" height="25" class="listado2" align="center">
					<center><input name="Actualizar" type="submit" class="botones" id="envia22" value="Actualizar"></center>
				</TD>
			</tr>
		</table>
