...
<tr><td width="20%" class='titulos2' align="left">PISO </td>
...
<td width="20%" class='titulos2'><input type=text name=buscar_caja value='<?=$buscar_caja?>' class="tex_area" size=3 maxlength="2"></td--></tr>
<td colspan="4" align="center"><input type=submit value=Buscar name=Buscar class="botones">&nbsp;</td>
<!--td colspan="2" align="left"><input name='Regresar' align="middle" type="button" class="botones" id="envia22" onClick="window.back();" value="Regresar" ></td-->
</table>
<br>
<?
if($Buscar){
...
?>
<table border=0 width="100%" cellpadding="1"  class="table table-bordered">
...
if($codserie!='0'){$srds="s.SGD_SRD_CODIGO = '$codserie'";$c="and";}
else {$srds="";$c="";}
if($codiSBRD!='0'){$sbrds="s.SGD_SBRD_CODIGO = '$codiSBRD'";$d="and";}
else {$sbrds="";$d="";}
if($codProc!='0'){$pross="s.SGD_PEXP_CODIGO = '$codProc'";$ef="and";}
else{$pross="";$ef="";}
if($buscar_piso!=""){$pis="e.SGD_EXP_ISLA = '$buscar_piso'";$f="and";}
else {$pis="";$f="";}
if($buscar_estan!=""){
if($item3=="ESTANTE ")$estan="e.SGD_EXP_ESTANTE = '$buscar_estan'";
elseif($item3=="CARRO ")$estan="e.SGD_EXP_CARRO = '$buscar_estan'";
elseif($item3=="ENTREPANO ")$estan="e.SGD_EXP_ENTREPA = '$buscar_estan'";
$h="and";}
else {$estan="";$h="";}
if($buscar_entre!=""){
if($item4=="ENTREPANO ")$entre="e.SGD_EXP_ENTREPA = '$buscar_entre'";
elseif($item4=="ESTANTE ")$entre="e.SGD_EXP_ESTANTE = '$buscar_entre'";
$v="and";}
else {$entre="";$v="";}
if($buscar_caja!=""){
if($item5=="ENTREPANO ")$caja="e.SGD_EXP_ENTREPA = '$buscar_caja'";
elseif($item5=="CAJA ")$caja="e.SGD_EXP_CAJA = '$buscar_caja'";
$t="and";}
else {$caja="";$s="";}
if($buscar_caja2!=""){
...
if ($sep=='1'){
	if($fechaInii==$fechaInif)$fecha="e.SGD_EXP_FECH_ARCH = to_date('$fechaInii','YYYY-mm-dd')";
	else{
...
if ($sel1=='1'){
	if($fechaFini==$fechaFinf)$fecha="e.SGD_EXP_FECHFIN = to_date('$fechaFini','YYYY-mm-dd')";
	else{
...
if($buscar_rete!=""){$foli="e.SGD_EXP_RETE = '$buscar_rete'";$k="and";}
else {$foli="";$k="";}
...
if($buscar_consecutivo!=""){$conse="e.SGD_EXP_CARPETA = '$buscar_consecutivo'";$n="and";}
else {$conse="";$n="";}
if($buscar_ufisica!=""){
if($item2=="AREA ")$archi="e.SGD_EXP_UFISICA = '$buscar_ufisica'";
if($item2=="ESTANTE ")$archi="e.SGD_EXP_ESTANTE = '$buscar_ufisica'";
elseif($item2=="CARRO")$archi="e.SGD_EXP_CARRO = '$buscar_ufisica'";
$o="and";}
else {$archi="";$o="";}
if($codMuni!='0'){
...
if ($fecha!="" or $fechafin!="")$orde=" order by e. sgd_exp_fech_arch";
else $orde=" order by e. sgd_exp_numero";
