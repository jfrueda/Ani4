...
<body bgcolor="#FFFFFF">
	...
	$item6=$tm[0];*/
			...
			<tr>
				...
				<td width="20%" class='titulos2'>
					<?
					$queryt = "select sgd_pexp_codigo||' - '||sgd_pexp_descrip,sgd_pexp_codigo from sgd_pexp_procexpedientes where sgd_srd_codigo like'" . $codserie . "' order by sgd_pexp_descrip";
			...
			<tr>
				...
				<td width="20%" class='titulos2'><input type=text name=demant value='<?= $demant ?>' class="tex_area"></td>
			</tr>
			<?
			if ($codserie == '2') {
				$tit = $titu2;
			...
			?>
			<tr>
				<td width="20%" class='titulos2' align="left">DOCUMENTO DE IDENTIDAD <?= $tit ?>
				</td>
			...
			<tr>
				<td width="20%" class='titulos2' align="left"> FECHA INICIAL <font color="red">(DD/MM/AAAA)</font> *
				</td>
				<td width="20%" class='titulos2'>
	...
	dateAvailable1.dateFormat="yyyy-MM-dd";
				...
				<td width="20%" class='titulos2' align="left"> FECHA FINAL <font color="red">(DD/MM/AAAA)</font> *
				<td width="20%" class='titulos2'>
	...
	dateAvailable2.dateFormat="yyyy-MM-dd";
				...
				<td width="20%" class='titulos2'>
					<select class="select" name="ano">
						...
						for ($i = 1975; $i <= $agnoactual; $i++) {
							if ($i == $ano) {
								$option = "<option SELECTED value=\"" . $ano . "\">" . $ano . "</option>";
							} elseif ($i == 1975) {
			...
			?>
			<tr>
				<td width="20%" class='titulos2' align="left" <?= $aut ?>>ZONA </td>
...
$edi1=$edi->fields['SGD_EIT_CODIGO'];
  ...
  print $rs1->GetMenu2('buscar_zona',$buscar_zona,true,false,"","onChange='submit()' class=select");*/
			...
			<tr>
				<td width="20%" class='titulos2' align="left"><?= $item3 ?> </td>
				<?
				if ($cara == "A") {
					$sec1 = "checked";
				} elseif ($cara == "B") {
				...
				<td width="20%" class='titulos2'><input type="radio" name="cara" value="A" <?= $sec1 ?> <?= $aut ?>>A &nbsp;
					...
					<input type="radio" name="cara" value="" <?= $sec3 ?> <?= $aut ?>>Ninguno &nbsp;
				</td>
				<?
				/*
  ...
  */ ?>
	...
	*/ ?>
			...
			<tr>
				<td width="20%" class='titulos2' align="left"><?= $item5 ?> </td>
  ...
  */
				...
				<td width="20%" class='titulos2'><input type=text name=caja value='<?= $caja ?>' class="tex_area" size=5 maxlength="4"> a la
					<input type=text name=caja2 value='<?= $caja2 ?>' class="tex_area" size=5 maxlength="4">
				</td>
				<?
				/*
  ...
  */ ?>
			...
			<tr>
				...
				<td width="20%" class='titulos2'>
					...
					<select class="select" name="unidocu">
						...
						<option value="CRPT" <?= $sele13 ?>>CRPT - Carpetas</option>
						<option value="LGJ" <?= $sele14 ?>>LGJ - Legajos</option>
						<option value="CPDR" <?= $sele15 ?>>CPDR - Libro Copiado</option>
						<option value="A-Z" <?= $sele16 ?>>A-Z - A-Z</option>
						<option value="CJ" <?= $sele17 ?>>CJ - Cajas</option>
						<option value="PQT" <?= $sele18 ?>>PQT - Paquete</option>
						<option value="AGL" <?= $sele19 ?>>AGL - Argollado</option>
					</select>
				</td>
			...
			<tr>
				...
				<td width="20%" class='titulos2'>
					<table border=0 width="90%" cellpadding="0">
						...
						?>
						<tr>
							<td width="30%" class='titulos2'> <input type="checkbox" name="inder1" value=1 <?= $sele1 ?>>Biologicos: Hongos</option>
							</td>
							<?
							if ($inder2 == 1) {
								$sele2 = "checked";
							...
							?>
							<td width="30%" class='titulos2'> <input type="checkbox" name="inder2" value=1 <?= $sele2 ?>>Biologicos: Roedores</option>
							</td>
							<?
							if ($inder3 == 1) {
								$sele3 = "checked";
							...
							?>
							<td width="30%" class='titulos2'> <input type="checkbox" name="inder3" value=1 <?= $sele3 ?>>Biologicos: Insectos</option>
							</td>
						</tr>
						<?
						if ($inder4 == 1) {
						...
						?>
						<tr>
							<td width="30%" class='titulos2'> <input type="checkbox" name="inder4" value=1 <?= $sele4 ?>>Decoloracion Soporte</option>
							</td>
							<?
							if ($inder5 == 1) {
								$sele5 = "checked";
							...
							?>
							<td width="30%" class='titulos2'> <input type="checkbox" name="inder5" value=1 <?= $sele5 ?>>Desgarros</option>
							</td>
						</tr>
					</table>
				</td>
				...
				<td width="20%" class='titulos2'>
					<table border=0 width="90%" cellpadding="0">
						...
						?>
						<tr>
							<td width="30%" class='titulos2'> <input type="checkbox" name="mata1" value=1 <?= $sele7 ?>>Metalico</option>
							</td>
							<?
							if ($mata2 == 1) {
								$sele8 = "checked";
							...
							?>
							<td width="30%" class='titulos2'> <input type="checkbox" name="mata2" value=1 <?= $sele8 ?>>Post-it</option>
							</td>
							<?
							if ($mata3 == 1) {
								$sele9 = "checked";
							...
							?>
							<td width="30%" class='titulos2'> <input type="checkbox" name="mata3" value=1 <?= $sele9 ?>>Planos</option>
							</td>
						</tr>
						<?
						if ($mata4 == 1) {
						...
						?>
						<tr>
							<td width="30%" class='titulos2'> <input type="checkbox" name="mata4" value=1 <?= $sele10 ?>>Fotografia</option>
							</td>
							<?
							if ($mata5 == 1) {
								$sele11 = "checked";
							...
							?>
							<td width="30%" class='titulos2'> <input type="checkbox" name="mata5" value=1 <?= $sele11 ?>>Soporte Optico</option>
							</td>
							<?
							if ($mata6 == 1) {
								$sele12 = "checked";
							...
							?>
							<td width="30%" class='titulos2'> <input type="checkbox" name="mata6" value=1 <?= $sele12 ?>>Soporte Magnetico</option>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				...
				?>
			<TR>
				<td class='titulos2' align="right">PRESTAMO</td>
				<?
					if ($prest == 1) {
						$de = "checked";
					} else {
			...
			if ($Ingresar || $Modificar) {
				$añoInicial = substr($fechaIni, 6, 4) . substr($fechaIni, 2, 4);
				$confi = explode($ano, $añoInicial);

				//echo "los valores son: añoInicial ".$añoInicial." año seleccionado ".$ano."  confi 1   --". $confi[1]."  confi 0   --". $confi[0];
				if ($orden == "" && $proc == 2) {
					$orden = '0';
				}
				if ($ano != "" && $depe != "" && $orden != "" && $deman != "" && $numCap != "" && $folios != "") {
					$zon = strtoupper($zona);
					...
					//if($folios=="")$folios=0;
					if ($mata1 == 1 && $mata2 == 1 && $mata3 == 1 && $mata4 == 1) {
						$mata = 42;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata3 == 1 && $mata5 == 1) {
						$mata = 43;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata3 == 1 && $mata6 == 1) {
						$mata = 44;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata4 == 1 && $mata5 == 1) {
						$mata = 45;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata4 == 1 && $mata6 == 1) {
						$mata = 46;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 47;
					} elseif ($mata1 == 1 && $mata3 == 1 && $mata4 == 1 && $mata5 == 1) {
						$mata = 48;
					} elseif ($mata1 == 1 && $mata3 == 1 && $mata4 == 1 && $mata6 == 1) {
						$mata = 49;
					} elseif ($mata1 == 1 && $mata3 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 50;
					} elseif ($mata1 == 1 && $mata4 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 51;
					} elseif ($mata2 == 1 && $mata3 == 1 && $mata4 == 1 && $mata5 == 1) {
						$mata = 52;
					} elseif ($mata2 == 1 && $mata3 == 1 && $mata4 == 1 && $mata6 == 1) {
						$mata = 53;
					} elseif ($mata2 == 1 && $mata3 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 54;
					} elseif ($mata3 == 1 && $mata4 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 55;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata3 == 1) {
						$mata = 22;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata4 == 1) {
						$mata = 23;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata5 == 1) {
						$mata = 24;
					} elseif ($mata1 == 1 && $mata2 == 1 && $mata6 == 1) {
						$mata = 25;
					} elseif ($mata1 == 1 && $mata3 == 1 && $mata4 == 1) {
						$mata = 26;
					} elseif ($mata1 == 1 && $mata3 == 1 && $mata5 == 1) {
						$mata = 27;
					} elseif ($mata1 == 1 && $mata3 == 1 && $mata6 == 1) {
						$mata = 28;
					} elseif ($mata1 == 1 && $mata4 == 1 && $mata5 == 1) {
						$mata = 29;
					} elseif ($mata1 == 1 && $mata4 == 1 && $mata6 == 1) {
						$mata = 30;
					} elseif ($mata1 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 31;
					} elseif ($mata2 == 1 && $mata3 == 1 && $mata4 == 1) {
						$mata = 32;
					} elseif ($mata2 == 1 && $mata3 == 1 && $mata5 == 1) {
						$mata = 33;
					} elseif ($mata2 == 1 && $mata3 == 1 && $mata6 == 1) {
						$mata = 34;
					} elseif ($mata2 == 1 && $mata4 == 1 && $mata5 == 1) {
						$mata = 35;
					} elseif ($mata2 == 1 && $mata4 == 1 && $mata6 == 1) {
						$mata = 36;
					} elseif ($mata2 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 37;
					} elseif ($mata3 == 1 && $mata4 == 1 && $mata5 == 1) {
						$mata = 38;
					} elseif ($mata3 == 1 && $mata4 == 1 && $mata6 == 1) {
						$mata = 39;
					} elseif ($mata3 == 1 && $mata5 == 1 && $mata6 == 1) {
						$mata = 40;
					} elseif ($mata6 == 1 && $mata4 == 1 && $mata5 == 1) {
						$mata = 41;
					} elseif ($mata1 == 1 && $mata2 == 1) {
						$mata = 7;
					} elseif ($mata1 == 1 && $mata3 == 1) {
						$mata = 8;
					} elseif ($mata1 == 1 && $mata4 == 1) {
						$mata = 9;
					} elseif ($mata1 == 1 && $mata5 == 1) {
						$mata = 10;
					} elseif ($mata1 == 1 && $mata6 == 1) {
						$mata = 11;
					} elseif ($mata2 == 1 && $mata3 == 1) {
						$mata = 12;
					} elseif ($mata2 == 1 && $mata4 == 1) {
						$mata = 13;
					} elseif ($mata2 == 1 && $mata5 == 1) {
						$mata = 14;
					} elseif ($mata2 == 1 && $mata6 == 1) {
						$mata = 15;
					} elseif ($mata3 == 1 && $mata4 == 1) {
						$mata = 16;
					} elseif ($mata3 == 1 && $mata5 == 1) {
						$mata = 17;
					} elseif ($mata3 == 1 && $mata6 == 1) {
						$mata = 18;
					} elseif ($mata4 == 1 && $mata5 == 1) {
						$mata = 19;
					} elseif ($mata4 == 1 && $mata6 == 1) {
						$mata = 20;
					} elseif ($mata5 == 1 && $mata6 == 1) {
						$mata = 21;
					} elseif ($mata1 == 1) {
						$mata = 1;
					} elseif ($mata2 == 1) {
					...
					if ($inder1 == 1 && $inder2 == 1 && $inder3 == 1 && $inder4 == 1 && $inder5 == 1) {
						$inder = 31;
					} elseif ($inder1 == 1 && $inder2 == 1 && $inder3 == 1 && $inder4 == 1) {
						$inder = 26;
					} elseif ($inder1 == 1 && $inder2 == 1 && $inder3 == 1 && $inder5 == 1) {
						$inder = 27;
					} elseif ($inder1 == 1 && $inder2 == 1 && $inder4 == 1 && $inder5 == 1) {
						$inder = 28;
					} elseif ($inder1 == 1 && $inder3 == 1 && $inder4 == 1 && $inder5 == 1) {
						$inder = 29;
					} elseif ($inder2 == 1 && $inder3 == 1 && $inder4 == 1 && $inder5 == 1) {
						$inder = 30;
					} elseif ($inder1 == 1 && $inder2 == 1 && $inder3 == 1) {
						$inder = 16;
					} elseif ($inder1 == 1 && $inder2 == 1 && $inder4 == 1) {
						$inder = 17;
					} elseif ($inder1 == 1 && $inder2 == 1 && $inder5 == 1) {
						$inder = 18;
					} elseif ($inder1 == 1 && $inder3 == 1 && $inder4 == 1) {
						$inder = 19;
					} elseif ($inder1 == 1 && $inder3 == 1 && $inder5 == 1) {
						$inder = 20;
					} elseif ($inder1 == 1 && $inder4 == 1 && $inder5 == 1) {
						$inder = 21;
					} elseif ($inder2 == 1 && $inder3 == 1 && $inder4 == 1) {
						$inder = 22;
					} elseif ($inder2 == 1 && $inder3 == 1 && $inder5 == 1) {
						$inder = 23;
					} elseif ($inder2 == 1 && $inder4 == 1 && $inder5 == 1) {
						$inder = 24;
					} elseif ($inder3 == 1 && $inder4 == 1 && $inder5 == 1) {
						$inder = 25;
					} elseif ($inder1 == 1 && $inder2 == 1) {
						$inder = 6;
					} elseif ($inder1 == 1 && $inder3 == 1) {
						$inder = 7;
					} elseif ($inder1 == 1 && $inder4 == 1) {
						$inder = 8;
					} elseif ($inder1 == 1 && $inder5 == 1) {
						$inder = 9;
					} elseif ($inder2 == 1 && $inder3 == 1) {
						$inder = 10;
					} elseif ($inder2 == 1 && $inder4 == 1) {
						$inder = 11;
					} elseif ($inder2 == 1 && $inder5 == 1) {
						$inder = 12;
					} elseif ($inder3 == 1 && $inder4 == 1) {
						$inder = 13;
					} elseif ($inder3 == 1 && $inder5 == 1) {
						$inder = 14;
					} elseif ($inder4 == 1 && $inder5 == 1) {
						$inder = 15;
					} elseif ($inder1 == 1) {
						$inder = 1;
					} elseif ($inder2 == 1) {
					...
					if ($Ingresar) {
						...
						//$db->conn->debug=true;
						if ($tip != "") {
							$query .= " and sgd_archivo_proc like '" . $tip . "'";
						}
			...
			<tr>
				<td align="center" colspan="4">
					<h1>EL NUMERO DE RADICADO ES <?= $rad ?></h1>
			</tr>
		<?
								//$edit=2;
								$depe2 = $depe;
		...
		?>
			...
			<tr>
				<td align="center" colspan="4">
					<h1>HUBO UN ERROR EN LA CARGA</h1>
			</tr>
		<?
							}
						}
		...
		$rad1=$ano2.$r2[1];
						...
						if ($rqr->fields['SGD_ARCHIVO_USUA'] == "") {
							$qte = " ,sgd_archivo_usua='$krd', depe_codi='$depeU'";
						} else {
							$qte = "";
						}
						include "$ruta_raiz/include/query/archivo/queryinsertar_central.php";
		...
		<tr>
			<td align="center" colspan="4">
				<h1 class="titulosError">EL REGISTRO FUE MODIFICADO</h1>
		</tr>
<?
...
?>
<script language="javascript">
	confirm('Debe seleccionar un a\u00F1o');
</script>
<?
				} elseif ($depe == "") {
?>
...
?>
	<script language="javascript">
		confirm('Debe ingresar la fecha de inicial con el a\u00F1o que selecciono');
	</script>
<?
				} elseif ($demant == "") {
?>
