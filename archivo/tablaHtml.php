...
<center>
	...
	<?
	if (
		$tipoEstadistica == 1 || $tipoEstadistica == 3 || $tipoEstadistica == 6 || $tipoEstadistica == 8 ||
		$tipoEstadistica == 12  || $tipoEstadistica == 13
	) {

		if ($genTodosDetalle == 1 || $genDetalle == 1) {
	?>
			<Br>
