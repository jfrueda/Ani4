...
/*  Fabian Mauricio Losada Florez      12-Noviembre-2006 						     */
/*************************************************************************************/
$krdOld = $krd;
$per = 1;
session_start();
...
<body bgcolor="#FFFFFF">
	...
	<form name=generar action="<?= $encabezadol ?>" method='post' action="generar.php?<?= session_name() ?>=<?= trim(session_id()) ?>krd=<?= $krd ?>">
		...
		<table border=0 width 100% cellpadding="1" class="borde_tab" align="left">
			...
			<tr>
				<TD class=titulos5>OFICINA PRODUCTORA </td>
				<td class=leidos2><b><span class=leidos2><? echo $depe_nom; ?></b></td>
			</tr>
			<tr>
				<TD class=titulos5>CODIGO DEPENDENCIA </td>
				<td class=leidos2><b><span class=leidos2><? echo $depe; ?></b></td>
		</table>
		<br><br><br>
		<table border=0 width 100% cellpadding="1" class="borde_tab" align="center">
			...
			<TD class=titulos5>OBSERVACIONES
				...
				?><tr><?
						...
						$rse = $db->query($sqme);
						if (!$rse->EOF) {
							$titulo = $rse->fields['SGD_SEXP_PAREXP1'];
						} else {
							$titulo = "";
						}
						...
						<td class=leidos2><b><span class=leidos2><? echo $expnum; ?></b>
							<b><span class=leidos2><? echo $titulo; ?></b>
						</td>
						<td class=leidos2>
							<b>
								<span class=leidos2>&nbsp;&nbsp;<? if ($unidad == 1) {
																	echo "X";
																} ?>
							</b>
							<b>
								<span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? if ($unidad == 2) {
																									echo "   X";
																								} ?>
							</b>
							<b>
								<span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? if ($unidad == 3) {
																												echo "       X";
																											} ?>
							</b>
							<b>
								<span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? if ($unidad == 4) {
																																echo "           X";
																															} ?>
							</b>
						</td>
						...
						<td class=leidos2><b><span class=leidos2>&nbsp;&nbsp;<? if ($rete == 1) {
																					echo "X";
																				} ?>
							</b>
							<b><span class=leidos2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<? if ($rete == 2) {
																							echo "    X";
																						} ?>
							</b>
						</td>
