...
<body>
    ...
    ?>
    <center>
        <table width="550" class='table table-striped table-bordered table-hover dataTable no-footer smart-form'>
            <tr>
                <td class='titulos4' align="center">Carpetas Con Radicados Virtuales</td>
            </tr>
        </table>
    </center>
    <form action="carpetasvirtuales.php?<?= $params ?>" method="post" enctype="multipart/form-data" name="formSeleccion" id="formSeleccion">
        <center>
            <table width="550" class='borde_tab'>
                ...
                <td height="26" class='titulos5'>Selecciona A�o De Carpeta Virtual</td>
    ...
    ?>
        ...
        $ind = "$ind %";
        echo "<p><span class=listado2>N�mero de Registros: " . $numreginf . "</span>";
    }
        ?>
