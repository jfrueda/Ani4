  ...
  <div id="content" style="opacity: 1;">
    <div class="row">
      ...
      <h1 class="page-title txt-color-blueDark">
        <i class="glyphicon glyphicon-inbox"></i> Bandeja <span><?=$nomcarpeta?></span> <span style="color:azure"> <?=$_SESSION['dependencia']?>  <?=$_SESSION["codusuario"]?></span></h1>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    function eliminarBorrador(numbor) {        
        if (confirm('Esta seguro que desea eliminar el borrador: ' + numbor)) {
            $.ajax({url: "eliminarBorrador.php", 
                    type: "POST",
                    data: { funcion : '1', numbor : numbor},
