...
session_start();
if ($_SESSION['krd'] != 'CARLOS.PERILLA' && $_SESSION['krd'] != 'HENRI.CAPMARTIN') {
    die();
}
$ruta_raiz = ".";
...
$sqlFecha = $db->conn->SQLDate($dateFormat ?? "Y-m-d H:i A", "b.RADI_FECH_RADI");
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark">
                    <i class="glyphicon glyphicon-inbox"></i> Bandeja <span><?= $nomcarpeta ?></span> <span style="color:azure"> <?= $_SESSION['dependencia'] ?> <?= $_SESSION["codusuario"] ?></span>
                </h1>
            </div>
        </div>
