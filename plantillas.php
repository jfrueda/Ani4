                          ...
                          <table class="table table-bordered table-striped">
                              ...
                              <tr class='titulos2'>
                                  <td align="center" height="12">
                                      <b> Campos que se pueden usar en una combinaci&oacute;n Masiva</b>
                                  </td>
                              </tr>
                              ...
                              <tr align="justify" class="etextomenu">
                                  <td  class='listado2'>
                                    <p> Listado de Fuentes de Código de barra que
                                        debe tener instalado en el PC o Dispositivo
                                        M&oacute;vil.
                                    </p>
                                    <ul>
                                        <li>
                                            Descargar las fuentes desde GNU/Linux,
                                            MAC, OSX o Windows  y abir directamente
                                            con el Administrador de Fuentes, Luego Dar
                                            la Opci&oacute;n Instalar.
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li><a href='include/fuentes/free3of9.ttf'>free3of9.ttf</a></li>
                                        <li><a href='include/fuentes/fre30f9x.ttf'>free3of9x.ttf</a></li>
                                    </ul>
                                    <p>
                                       Las fuentes incluidas corresponden a la siguiente licencia
                                       <a href='include/fuentes/free3of9.txt'>free3of9.txt </a>
                                    </p>
                                  </td>
                              </tr>
