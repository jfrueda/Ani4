...
<script type="text/javascript">
	...
	function ejecutarProceso() {
		...
		$.ajax({url: "masiva.php", 
						    type: "POST",
							data: { depeRadica : depeRadica, usuRadica : usuRadica, depeEnvio : depeEnvio, usuEnvio: usuEnvio, usua_doc_radica: usua_doc_radica},
							success: function(result){							    		
					    		...
					    		if(!result.includes('*FIN*')) {
					    			setTimeout(function(){ ejecutarProceso(); }, 3000);
					    		}
