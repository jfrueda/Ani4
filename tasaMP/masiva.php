...
function generarDocumento($t, $dia, $mes, $anho, $num, $pathAux, $complementDireccion) {
    ...
    $templateProcessor->setValue('RA_ASUN', 'Por la cual se libra mandamiento de pago.');
    ...
    $templateProcessor->setValue('USUA_PROYECTO', ' Francisco Alford Bojacá - Contratista Grupo de Cobro Persuasivo y Jurisdicción Coactiva');
...
foreach ($sheetData as $t) {
    ...
    if($t[0] != '') {
       ...
       $rad->raAsun        =    "Por el cual se Libra Mandamiento de Pago";
       $rad->guia = "";
       $rad->radi_dato_001 = "";
       $rad->radi_dato_002 = "";
       $rad->esta_fisico = 1;
