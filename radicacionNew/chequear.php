...
<form name="formulario" method="post" action='chequear.php?<?=session_name()."=".session_id()?>&krd=<?=$krd?>&dependencia=<?=$dependencia?>&krd=<?=$krd?>&faxPath=<?=$faxPath?>'>
  ...
  <input type=hidden name=mailAsunto value='<?=$mailAsunto?>'>
...
<form action='radicar.php?<?=session_name()."=".trim(session_id())?>&krd=<?=$krd?>&dependencia=<?=$dependencia?>&krd=<?=$krd?>&faxPath=<?=$faxPath?>' method="post" name="form1" class="style1">
<input type=hidden name=ent value='<?=$ent?>'>
<input type=hidden name=eMailMid value='<?=$eMailMid?>'>
<input type=hidden name=mailAsunto value='<?=$mailAsunto?>'>
<input type=hidden name=mailFrom value='<?=$mailFrom?>'>
