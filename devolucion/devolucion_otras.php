			...
			<td width=100%>
				...
				?>
					<table cellspacing="5" class="borde_tab" width="60%">
						<TR>
							<TD class=titulos4 colspan=3>ACCION REQUERIDA COMPLETADA</TD>
						<TR>
						<TR>
							<TD class=titulos2>ACCION REQUERIDA </TD>
							<TD class=listado2>
								<span class=leidos>
									<?
									if ($enviara == 21) {
						...
						<TR>
							...
							<td class="listado2" width="70%"><span class=leidos><?= $usua_nomb ?></span></TD>
						</TR>
						<tr>
							<TD width='30%' class="titulos5">DEPENDENCIA ORIGEN</td>
