          ...
          <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
            ...
            <div>
              ...
              <div class="widget-body">
                <?php
                if (!isset($depsel) || !$depsel) {
                  $depsel = $dependencia;
                }
                if (isset($aceptar) && $aceptar == "grabar") {
                  $isql = "update
                                usuario
                                set
                                usua_nuevo     = '1',
                ...
                ?>
                    ...
                    <form action="usuarionuevo.php" class="smart-form" method=post>
                      <CENTER>
                        ...
                        <tr>
                          <td class=listado2>
                            <center>
                              <h3>Esta Seguro de estos datos ?</h3><br />
                  ...
                  <?php
                    ...
                    <table class="table table-bordered table-striped">
                      <tr>
                        <td class="listado2">
                          <center>
                            <h3>Las contrase&ntilde;as no coinciden</h3>
