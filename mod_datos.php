...
#Recupero todos los datos del POST para Mostrarlos a tiempo
 ...
 if ($_POST) $notificar = $_POST['notificar'] ? 1 : 0;
...
?>
	...
	<?=file_exists($uriFile2)?'<span style="color: red">Ya existe una firma digital cargada en el sistema</span>':'';?>
     ...
     <!--Fin subir firma digital-->
        <td align="right"><label for="notificar">Enviar notificaciones</label></td>
        <td><input id="notificar" name="notificar" type="checkbox" <?=$notificar?'checked':''?>></td>
    </tr>
   </table>   
...
$usua_dia = $_POST["usua_dia"];
        ...
        if ($fechaNacimiento == '0-00-00') $fechaNacimiento = null;
