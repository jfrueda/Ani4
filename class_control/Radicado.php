	...
	function validarSeguridadExpediente($radicado, $expediente, $usuario)
	{
		...
		if ($seguridad_expediente == 'Público') {
			if ($seguridad_radicado == 'Público') {
				return true;
			} elseif ($seguridad_radicado == 'Reservado') {
			...
			} elseif ($seguridad_radicado == 'Clasificado') {
		...
		} elseif ($seguridad_expediente == 'Reservado') {
		...
		} elseif ($seguridad_expediente == 'Clasificado') {
