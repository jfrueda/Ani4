...
/**
 * Notificacion es la clase encargada de gestionar las operaciones y  los datos b�sicos referentes a un tipo de Notificacion
...
class Notificacion
{
	...
	/** 
	 * Retorna el valor string correspondiente al atributo descripci�n de la notificacion, debe invocarse antes notificacion_codigo()
	 * @return   string
	 */
	...
	/** 
	 * Carga los datos de la instacia con un c�digo de departamento suministrado
	 * @param	$codigo	int	es el c�digo del departamento
	 */
	function notificacion_codigo($codigo)
	{

		//si se ingres� un par�metro v�lido
		if (strlen($codigo > 0)) {
			//almacena el query
			$q = "select *  from sgd_not_notificacion where SGD_NOT_CODI =$codigo";
