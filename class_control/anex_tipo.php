 ...
 * los datos b�sicos referentes a un tipo de formato de documento a anexar 
 * a un radicado
...
class Anex_tipo
{
  ...
  /** 
   * Retorna el valor string correspondiente al atributo
   * descripci�n del formato del archivo a anexar
   * @return   string
   */
   ...
   * del tipo de formato del documento a anexar correspondiente al  c�digo del registro
   * que recibe como par�metros
   * @param $codigo     es el c�digo del registro
   */
