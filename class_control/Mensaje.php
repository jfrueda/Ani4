...
/**
 * Mensaje es la clase encargada de gestionar las operaciones y los datos b�sicos referentes a una Mensaje Orfeo
...
class  Mensaje
{
	...
	/** 
	 * Funci�n que crea el javascript que deplega los mensajes que tiene programados un usuario
	 * @param	$usrDoc	Documento del usuario
	 * @param	$Dependencia	$Dependencia a la que pertenece el usuario
	 * @return   String	Retorna el Javascript que desplegar� los mensajes
	 */
	...
	function acuseRecibo($usrDoc, $msgCodi, $existe, $tipMsg)
	{
		...
		//Acuse Autom�tico para mensajes tipo POPUP
		if ($tipMsg == 1) {
			...
			if (!$rs) {
				...
				die("<span class='etextomenu'>No se ha podido actualizar la informaci�n de notificaci�n");
			}
		}
