 ...
 * selecciona paqueted de numeraci�n y fechado
 * a un radicado
 * <p>
...
class RemitenteDocumento
{
   ...
   /**
    * Almacena la direcci�n remitente usuario
    * @var string
    * @access public
    */
   ...
   /**
    * Almacena la direcci�n de la ESP remitente 
    * @var string
    * @access public
    */
   ...
   /**
    * Almacena la direcci�n del remitente "otro"
    * @var string
    * @access public
    */
   ...
   /**
    * Almacena la direcci�n del predio
    * @var string
    * @access public
    */
