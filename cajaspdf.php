...
if ($enviar || $enviar_new) {
  ...
  $alltext_tmp = str_replace("*A�O*", $fano, $alltext_tmp);
...
if ($plantilla  && !$ins_plantilla && !$enviar && !$enviar_new) {
...
<?= $alltext   ?>
      ...
      <table border=0 align="center" class="t_bordegris">
        ...
        <tr>
          <?php
          $grabar_doc = 0;
          if ($plantillaper1 || $enviar || $enviar_new) {
            $grabar_doc = 1;
          ?>
          ...
          ?>
            <td valign="top" align="center">
              <font size="-1" face="Arial, Helvetica, sans-serif">
                <font size="-2">
                  <input type=SUBMIT NAME=ins_plantilla value='Insertar Como Plantilla' class='e_buttons'>
                  <font size="-2"><br>
                    <?
                    if ($codusuario == 1) {
                    ?>
