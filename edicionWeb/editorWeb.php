				...
				<form enctype="multipart/form-data" method="post" name="formulario" id="formulario" action='upload2.php?<?= $variables ?>'>
					...
					<div align="center">
						<table width="100%" align="center" border="1" cellpadding="0" cellspacing="5" class="borde_tab">
							<tr>
								<td align="center" class="titulos4" colspan="4">DESCRIPCI&Oacute;N DEL DOCUMENTO</td>
							</tr>
							<tr>
								...
								<td class="listado2">
									<input type="checkbox" class="select" name="sololect" <?php if ($tipo == 1) {
																								echo " checked ";
																							}  ?> id="sololect">
									Solo lectura
								</td>
								<td class="listado2">
									...
									$us_3 = "";
									$datoss = "";
									if ($nombret_us11 && $direccion_us11 && $dpto_nombre_us11 && $muni_nombre_us11) {
										$us_1 = "si";
										$usuar = 1;
										if ($remitente == 1) {
											$datoss1 = " checked ";
									...
									$datoss = "";
									if ($nombret_us2 && $direccion_us2 && $dpto_nombre_us2 && $muni_nombre_us2) {
										$us_2 = "si";
										$predi = 1;
										if ($remitente == 2) {
											$datoss2 = " checked  ";
									...
									$datoss = "";
									if ($nombret_us3 && $direccion_us3 && $dpto_nombre_us3 && $muni_nombre_us3) {
										$us_3 = "si";
										$empre = 1;
										if ($remitente == 3) {
											$datoss3 = " checked  ";
...
<?php
										if (!$radicado_salida && $ent == 1)	$radicado_salida = 1;
...
?>' onChange="doc_radicado()" id="radicado_salida"> Este documento ser&aacute; radicado
								...
								<td class="listado2">
									...
									foreach ($tpNumRad as $key => $valueTp) {
										...
										//Si se definira prioridad en algun tipo de radicacion
						...
						<b>EL RADICADO PADRE NO ESTA INCLUIDO  EN UN EXPEDIENTE.</b>
							...
							<tr>
								<td class="titulos2" colspan="4">Destinatario</td>
							</tr>
							<tr valign="top">
								<td valign="top" class="listado2">
								...
								<td valign="top" class="listado2">
									<input type="radio" name="radicado_rem" id="rempre" value=3 <?= $datoss3 ?> '<?php if ($radicado_rem == 3) {
																														echo " checked ";
																													}  ?> '>
									<?= $tip3Nombre[3][$ent] ?>
									<br>
								...
								<td valign="top" class="listado2">
									<input type="radio" name="radicado_rem" id="rpredi" value=2 <?= $datoss2 ?> '<?php if ($radicado_rem == 2) {
																														echo " checked ";
																													}  ?> '>
									<?= $tip3Nombre[2][$ent] ?><br>
								...
								<td valign="top" class="listado2">
									<input type="radio" name="radicado_rem" value=7 <?= $datoss4 ?> '<?php if ($radicado_rem == 7) {
																											echo " checked ";
																										}  ?> ' id="rotro">
									Otro
								</td>
							...
							<tr valign="top">
								<td class='titulos2' valign="top">Descripcion</td>
	 ...
	 */
										$db->conn->SetFetchMode(ADODB_FETCH_ASSOC);
										if ($cc) {
											if (($nombre_us1 || $prim_apel_us1 || $seg_apel_us2) &&  $direccion_us1 && $muni_us1 && $codep_us1) {
