  					...
  					if($chk1)
						{
							 ...
							 ora_exec($cursor);
							  ...
							  //Start::envio conjunto
							 if($enviara==18){
								 $isql_hl= "insert into TRAMITECONJUNTO(DEPE_CODI,INFO_FECH,USUA_CODI,RADI_NUME_RADI,INFO_DESC) values ($depsel, to_date ($formatfecha) ,$codus,$chk1,'$observa')";
								 ora_parse($cursor,$isql_hl);
								 ora_exec($cursor);
							 }
							 //End::envio conjunto
