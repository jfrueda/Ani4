...
class ADODB_Pager {
    ...
    $this->ADODB_Pager($db,$sql,$id = 'adodb', $showPageLinks = false, $ordenActual,$orderTipo="asc");
  }
	function ADODB_Pager(&$db,$sql,$id = 'adodb', $showPageLinks = false, $ordenActual,$orderTipo="asc")
	{
	...
	$rutaRaiz = $this->rutaRaiz;
		...
		echo "<a style='border:0px' href='$rutaRaiz/adodb/adodb-doc.inc.php?".session_name()."=".session_id()."' target='_blank'><img src='$rutaRaiz/adodb/compfile.png' width='40' heigth='40' border='0' ></a>";

		echo "<a href='$rutaRaiz/adodb/adodb-xls.inc.php?".session_name()."=".session_id()."' target='_blank'><img src='$rutaRaiz/adodb/spreadsheet.png' width='40' heigth='40' border='0'></a>";
		$s = ob_get_contents();
		ob_end_clean();
		return $s;
	}
