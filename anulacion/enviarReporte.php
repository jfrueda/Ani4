...
<body bgcolor="#FFFFFF" topmargin="0">
  ...
  if (!empty($radicadosSel[0])) {
    ...
    $rsHistAnulacion = $Historico->insertarHistorico(
      $radicados,
      $dependencia,
      $codusuario,
      'NULL',
    ...
    $rsHistArchivo = $Historico->insertarHistorico(
      $radicados,
      $dependencia,
      $codusuario,
      999,
  ...
  <table class='table table-bordered' width=80% cellpadding="0" cellspacing="5">
    <form action='enviardatos.php' method=post name=formulario>
      <tr>
        <td colspan="3">ACCION REQUERIDA COMPLETADA</td>
      </tr>
      <tr>
        <td>ACCION REQUERIDA :</td>
        <td><span>Solicitud de Anulacion de Radicados</span></td>
      </tr>
      <tr>
        <td>RADICADOS INVOLUCRADOS</td>
        <td><span>
            <?
          ...
          <?php echo $observaError; ?></td>
      </tr>
      <tr>
        <td>USUARIO DESTINO :</td>
        <td><span>Usuario Anulador</span></td>
      </tr>
      <tr>
        <td>FECHA Y HORA</span></td>
