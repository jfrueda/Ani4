...
/**
  *  ANULACION DE RADICADOS.  Funci�n es presentar a los usuarios segun sus permisos el listado de radicados para realizar solicitud de anulacion de los radicados.
	*  Este permiso depende del campo existente en la tabla usuario llamado sgd_panu_codi
	*
	*/
?>
<html>
<Head><TITLE>Anulaci�n de Radicados</TITLE>
 ...
 *  @$filtroSelect Si SetfiltoSelect contiene algunvalor la siguiente rutina realiza el arreglo de la condici�n para la consulta a la base de datos y lo almacena en whereFiltro.
