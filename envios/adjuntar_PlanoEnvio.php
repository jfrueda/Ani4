...
session_start();
    ...
    $arcCsv = $usua_doc."_".$fecha."_".$hora.".xls";
...
<html>
    ...
    if($_FILES['archivoPlantilla']['type'] != 'application/vnd.ms-excel' ){
        echo "el formato del archivos no es correcto. ";
    }else{
