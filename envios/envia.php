...
<?php
        ...
        $tx = new Tx($db);
          ...
          /*crea registro en el historico*/

          $sqlh="INSERT INTO hist_eventos
					(depe_codi, hist_fech, usua_codi, radi_nume_radi, hist_obse, usua_codi_dest, usua_doc, usua_doc_old, sgd_ttr_codigo, hist_usua_autor, hist_doc_dest, depe_codi_dest, usuario_id)
					VALUES($dependencia,now(),$codusuario,$verrad_sal, 'Registro de envio físico. $observaciones',$codusuario, '$usua_doc', NULL, 9, NULL, NULL,$dependencia, NULL)";
