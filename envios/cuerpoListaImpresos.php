                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            ...
                            <table class="table table-bordered table-striped">
                                <tr>
                                    <td colspan="2" class="titulos4"></td>
                                </tr>
                                <tr>
                                ...
                                <table class="table table-bordered table-striped">
                                    <tr tr align="right">
                                        <td width="1120" height="26" colspan="2" valign="top" class="titulos2">
                                            <INPUT TYPE=submit name=gen_lisDefi Value=' Confirmar ' class=botones
                                                   id=Confirmar onclick="Marcar();">
