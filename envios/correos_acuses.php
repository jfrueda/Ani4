...
$db->conn->SetFetchMode(ADODB_FETCH_ASSOC);
    ...
    $usMailSelect  = "requerimientossuperargo@supersalud.gov.co"; 
    $mail->IsSMTP(); // telling the class to use SMTP
    $mail->SetFrom("requerimientossuperargo@supersalud.gov.co","RADICADOS FINALIZADOS AUTOMATICAMENTE");
    $mail->Host       = "smtp.office365.com";
    $mail->Port       = "587";
    $mail->SMTPDebug  = "1";  // 1 = errors and messages // 2 = messages only 
    $mail->SMTPAuth   = "true";
    $mail->SMTPSecure = "tls";
    $mail->Username   = "requerimientossuperargo@supersalud.gov.co";   // SMTP account username
    $mail->Password   = "Super.2019*"; // SMTP account password
...
while(!$rsg->EOF)
{
		...
		$mail->Subject    = "RADICADOS FINALIZADOS AUTOMATICAMENTE - SUPERARGO";
