...
<header>
    <h2>
        GENERACION LISTADO DE ENTREGA<br>
    </h2>
</header>
...
<form name='forma'
      action='generaListaImpresos.php?<?= session_name() . "=" . session_id() . "&krd=$krd&hora_ini=$hora_ini&hora_fin=$hora_fin&minutos_ini=$minutos_ini&minutos_fin=$minutos_fin&tip_radi=$tip_radi&fecha_busq=$fecha_busq&fecha_busqH=$fecha_busqH&fecha_h=$fechah&dep_sel=$dep_sel&num=$num" ?>'
      method=post>
<?php
...
if ($radiNumero == '') {
    ...
    $encabezado = "
            ...
            <tr><td width=820 height=70><img src=$encaenti width=220 height=45></td></tr>
...
<?php
    ...
    echo "<hr><span class='alarmas'>Operacion CANCELADA</span></hr>";
}
?>
</div>
</div>
